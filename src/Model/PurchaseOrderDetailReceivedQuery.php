...
use Base\PurchaseOrderDetailReceivedQuery as BasePurchaseOrderDetailReceivedQuery;
 ...
 *
 */
class PurchaseOrderDetailReceivedQuery extends BasePurchaseOrderDetailReceivedQuery {
	use QueryTraits;
}
