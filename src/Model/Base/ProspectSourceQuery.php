 ...
 *
 * @method     ChildProspectSource|null findOne(?ConnectionInterface $con = null) Return the first ChildProspectSource matching the query
 ...
 *
 * @method     ChildProspectSource|null findOneByPrtbsorccode(string $PrtbSorcCode) Return the first ChildProspectSource filtered by the PrtbSorcCode column
 * @method     ChildProspectSource|null findOneByPrtbsorcdesc(string $PrtbSorcDesc) Return the first ChildProspectSource filtered by the PrtbSorcDesc column
 * @method     ChildProspectSource|null findOneByDateupdtd(string $DateUpdtd) Return the first ChildProspectSource filtered by the DateUpdtd column
 * @method     ChildProspectSource|null findOneByTimeupdtd(string $TimeUpdtd) Return the first ChildProspectSource filtered by the TimeUpdtd column
 * @method     ChildProspectSource|null findOneByDummy(string $dummy) Return the first ChildProspectSource filtered by the dummy column
 *
 ...
 *
 * @method     ChildProspectSource[]|Collection find(?ConnectionInterface $con = null) Return ChildProspectSource objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildProspectSource> find(?ConnectionInterface $con = null) Return ChildProspectSource objects based on current ModelCriteria
 *
 * @method     ChildProspectSource[]|Collection findByPrtbsorccode(string|array<string> $PrtbSorcCode) Return ChildProspectSource objects filtered by the PrtbSorcCode column
 * @psalm-method Collection&\Traversable<ChildProspectSource> findByPrtbsorccode(string|array<string> $PrtbSorcCode) Return ChildProspectSource objects filtered by the PrtbSorcCode column
 * @method     ChildProspectSource[]|Collection findByPrtbsorcdesc(string|array<string> $PrtbSorcDesc) Return ChildProspectSource objects filtered by the PrtbSorcDesc column
 * @psalm-method Collection&\Traversable<ChildProspectSource> findByPrtbsorcdesc(string|array<string> $PrtbSorcDesc) Return ChildProspectSource objects filtered by the PrtbSorcDesc column
 * @method     ChildProspectSource[]|Collection findByDateupdtd(string|array<string> $DateUpdtd) Return ChildProspectSource objects filtered by the DateUpdtd column
 * @psalm-method Collection&\Traversable<ChildProspectSource> findByDateupdtd(string|array<string> $DateUpdtd) Return ChildProspectSource objects filtered by the DateUpdtd column
 * @method     ChildProspectSource[]|Collection findByTimeupdtd(string|array<string> $TimeUpdtd) Return ChildProspectSource objects filtered by the TimeUpdtd column
 * @psalm-method Collection&\Traversable<ChildProspectSource> findByTimeupdtd(string|array<string> $TimeUpdtd) Return ChildProspectSource objects filtered by the TimeUpdtd column
 * @method     ChildProspectSource[]|Collection findByDummy(string|array<string> $dummy) Return ChildProspectSource objects filtered by the dummy column
 * @psalm-method Collection&\Traversable<ChildProspectSource> findByDummy(string|array<string> $dummy) Return ChildProspectSource objects filtered by the dummy column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildProspectSource> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class ProspectSourceQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(ProspectSourceTableMap::COL_PRTBSORCCODE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(ProspectSourceTableMap::COL_PRTBSORCCODE, $keys, Criteria::IN);
     ...
     * $query->filterByPrtbsorccode(['foo', 'bar']); // WHERE PrtbSorcCode IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $prtbsorccode The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByPrtbsorccode($prtbsorccode = null, ?string $comparison = null)
    {
        if (null === $comparison) {
        ...
        $this->addUsingAlias(ProspectSourceTableMap::COL_PRTBSORCCODE, $prtbsorccode, $comparison);
     ...
     * $query->filterByPrtbsorcdesc(['foo', 'bar']); // WHERE PrtbSorcDesc IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $prtbsorcdesc The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByPrtbsorcdesc($prtbsorcdesc = null, ?string $comparison = null)
    {
        if (null === $comparison) {
        ...
        $this->addUsingAlias(ProspectSourceTableMap::COL_PRTBSORCDESC, $prtbsorcdesc, $comparison);
    ...
    public function filterByDateupdtd($dateupdtd = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ProspectSourceTableMap::COL_DATEUPDTD, $dateupdtd, $comparison);
    ...
    public function filterByTimeupdtd($timeupdtd = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ProspectSourceTableMap::COL_TIMEUPDTD, $timeupdtd, $comparison);
    ...
    public function filterByDummy($dummy = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ProspectSourceTableMap::COL_DUMMY, $dummy, $comparison);
