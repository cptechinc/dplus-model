...
/**
 * Base class that represents a row from the 'ar_cust_price' table.
 *
 *
 *
...
abstract class ArPriceCode implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\ArPriceCodeTableMap';
    ...
    /**
     * The value for the artbpricdesc field.
     *
     * @var        string|null
     */
    protected $artbpricdesc;

    /**
     * The value for the artbpricusesurchg field.
     *
     * @var        string|null
     */
    protected $artbpricusesurchg;

    /**
     * The value for the artbpricsurchgpct field.
     *
     * @var        string|null
     */
    protected $artbpricsurchgpct;
    ...
    /**
     * Get the [artbpricdesc] column value.
     *
     * @return string|null
     */
    public function getArtbpricdesc()
    {
        return $this->artbpricdesc;
    }

    /**
     * Get the [artbpricusesurchg] column value.
     *
     * @return string|null
     */
    public function getArtbpricusesurchg()
    {
        return $this->artbpricusesurchg;
    }

    /**
     * Get the [artbpricsurchgpct] column value.
     *
     * @return string|null
     */
    public function getArtbpricsurchgpct()
    {
        return $this->artbpricsurchgpct;
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO ar_cust_price (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'ArtbPricCode':
                        ...
                        break;
                    case 'ArtbPricDesc':
                        $stmt->bindValue($identifier, $this->artbpricdesc, PDO::PARAM_STR);

                        break;
                    case 'ArtbPricUseSurchg':
                        $stmt->bindValue($identifier, $this->artbpricusesurchg, PDO::PARAM_STR);

                        break;
                    case 'ArtbPricSurchgPct':
                        $stmt->bindValue($identifier, $this->artbpricsurchgpct, PDO::PARAM_STR);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 1:
                return $this->getArtbpricdesc();

            case 2:
                return $this->getArtbpricusesurchg();

            case 3:
                return $this->getArtbpricsurchgpct();
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = []): array
    {
        ...
        $result = [
            ...
            $keys[2] => $this->getArtbpricusesurchg(),
            $keys[3] => $this->getArtbpricsurchgpct(),
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setArtbpricdesc($value);
                break;
            case 2:
                $this->setArtbpricusesurchg($value);
                break;
            case 3:
                $this->setArtbpricsurchgpct($value);
                break;
            case 4:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setArtbpricdesc($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setArtbpricusesurchg($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setArtbpricsurchgpct($arr[$keys[3]]);
        }
    ...
    {
        $validPk = null !== $this->getArtbpriccode();
    ...
    /**
     * Generic method to set the primary key (artbpriccode column).
     *
    ...
    {
        return null === $this->getArtbpriccode();
    }
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setArtbpricdesc($this->getArtbpricdesc());
        $copyObj->setArtbpricusesurchg($this->getArtbpricusesurchg());
        $copyObj->setArtbpricsurchgpct($this->getArtbpricsurchgpct());
    ...
    public function clear()
    {
        ...
        $this->artbpricdesc = null;
        $this->artbpricusesurchg = null;
        $this->artbpricsurchgpct = null;
        $this->dateupdtd = null;
        $this->timeupdtd = null;
        $this->dummy = null;
        $this->alreadyInSave = false;
