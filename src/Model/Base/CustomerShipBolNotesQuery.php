...
use \CustomerShipBolNotes as ChildCustomerShipBolNotes;
use \CustomerShipBolNotesQuery as ChildCustomerShipBolNotesQuery;
use \Exception;
use \PDO;
use Map\CustomerShipBolNotesTableMap;
 ...
 * @method     ChildCustomerShipBolNotesQuery orderByArcucustid($order = Criteria::ASC) Order by the ArcuCustId column
 * @method     ChildCustomerShipBolNotesQuery orderByArstshipid($order = Criteria::ASC) Order by the ArstShipId column
 * @method     ChildCustomerShipBolNotesQuery orderByQnseq($order = Criteria::ASC) Order by the QnSeq column
 * @method     ChildCustomerShipBolNotesQuery orderByQnnote($order = Criteria::ASC) Order by the QnNote column
 * @method     ChildCustomerShipBolNotesQuery orderByQnkey2($order = Criteria::ASC) Order by the QnKey2 column
 * @method     ChildCustomerShipBolNotesQuery orderByQnform($order = Criteria::ASC) Order by the QnForm column
 * @method     ChildCustomerShipBolNotesQuery orderByDateupdtd($order = Criteria::ASC) Order by the DateUpdtd column
 * @method     ChildCustomerShipBolNotesQuery orderByTimeupdtd($order = Criteria::ASC) Order by the TimeUpdtd column
 * @method     ChildCustomerShipBolNotesQuery orderByDummy($order = Criteria::ASC) Order by the dummy column
 *
 * @method     ChildCustomerShipBolNotesQuery groupByQntype() Group by the QnType column
 * @method     ChildCustomerShipBolNotesQuery groupByQntypedesc() Group by the QnTypeDesc column
 * @method     ChildCustomerShipBolNotesQuery groupByArcucustid() Group by the ArcuCustId column
 * @method     ChildCustomerShipBolNotesQuery groupByArstshipid() Group by the ArstShipId column
 * @method     ChildCustomerShipBolNotesQuery groupByQnseq() Group by the QnSeq column
 * @method     ChildCustomerShipBolNotesQuery groupByQnnote() Group by the QnNote column
 * @method     ChildCustomerShipBolNotesQuery groupByQnkey2() Group by the QnKey2 column
 * @method     ChildCustomerShipBolNotesQuery groupByQnform() Group by the QnForm column
 * @method     ChildCustomerShipBolNotesQuery groupByDateupdtd() Group by the DateUpdtd column
 * @method     ChildCustomerShipBolNotesQuery groupByTimeupdtd() Group by the TimeUpdtd column
 * @method     ChildCustomerShipBolNotesQuery groupByDummy() Group by the dummy column
 *
 * @method     ChildCustomerShipBolNotesQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method     ChildCustomerShipBolNotesQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method     ChildCustomerShipBolNotesQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildCustomerShipBolNotesQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 ...
 * @method     ChildCustomerShipBolNotes requireOneByArcucustid(string $ArcuCustId) Return the first ChildCustomerShipBolNotes filtered by the ArcuCustId column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCustomerShipBolNotes requireOneByArstshipid(string $ArstShipId) Return the first ChildCustomerShipBolNotes filtered by the ArstShipId column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCustomerShipBolNotes requireOneByQnseq(int $QnSeq) Return the first ChildCustomerShipBolNotes filtered by the QnSeq column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCustomerShipBolNotes requireOneByQnnote(string $QnNote) Return the first ChildCustomerShipBolNotes filtered by the QnNote column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCustomerShipBolNotes requireOneByQnkey2(string $QnKey2) Return the first ChildCustomerShipBolNotes filtered by the QnKey2 column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCustomerShipBolNotes requireOneByQnform(string $QnForm) Return the first ChildCustomerShipBolNotes filtered by the QnForm column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCustomerShipBolNotes requireOneByDateupdtd(string $DateUpdtd) Return the first ChildCustomerShipBolNotes filtered by the DateUpdtd column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
...
abstract class CustomerShipBolNotesQuery extends ModelCriteria
{
    ...
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        ...
        $query = new ChildCustomerShipBolNotesQuery();
        if (null !== $modelAlias) {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(CustomerShipBolNotesTableMap::DATABASE_NAME);
        }
        ...
        if ((null !== ($obj = CustomerShipBolNotesTableMap::getInstanceFromPool(serialize([(null === $key[0] || is_scalar($key[0]) || is_callable([$key[0], '__toString']) ? (string) $key[0] : $key[0]), (null === $key[1] || is_scalar($key[1]) || is_callable([$key[1], '__toString']) ? (string) $key[1] : $key[1]), (null === $key[2] || is_scalar($key[2]) || is_callable([$key[2], '__toString']) ? (string) $key[2] : $key[2]), (null === $key[3] || is_scalar($key[3]) || is_callable([$key[3], '__toString']) ? (string) $key[3] : $key[3])]))))) {
     ...
     *
     * @return ChildCustomerShipBolNotes A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        $sql = 'SELECT QnType, QnTypeDesc, ArcuCustId, ArstShipId, QnSeq, QnNote, QnKey2, QnForm, DateUpdtd, TimeUpdtd, dummy FROM notes_cust_ship_bol WHERE QnType = :p0 AND QnSeq = :p1 AND QnKey2 = :p2 AND QnForm = :p3';
        try {
    ...
    {
        $this->addUsingAlias(CustomerShipBolNotesTableMap::COL_QNTYPE, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(CustomerShipBolNotesTableMap::COL_QNSEQ, $key[1], Criteria::EQUAL);
        $this->addUsingAlias(CustomerShipBolNotesTableMap::COL_QNKEY2, $key[2], Criteria::EQUAL);
        $this->addUsingAlias(CustomerShipBolNotesTableMap::COL_QNFORM, $key[3], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            ...
            $cton1 = $this->getNewCriterion(CustomerShipBolNotesTableMap::COL_QNSEQ, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $cton2 = $this->getNewCriterion(CustomerShipBolNotesTableMap::COL_QNKEY2, $key[2], Criteria::EQUAL);
            $cton0->addAnd($cton2);
            $cton3 = $this->getNewCriterion(CustomerShipBolNotesTableMap::COL_QNFORM, $key[3], Criteria::EQUAL);
            $cton0->addAnd($cton3);
            $this->addOr($cton0);
        }
    ...
    public function filterByQnseq($qnseq = null, $comparison = null)
    {
        if (is_array($qnseq)) {
            $useMinMax = false;
            if (isset($qnseq['min'])) {
                $this->addUsingAlias(CustomerShipBolNotesTableMap::COL_QNSEQ, $qnseq['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($qnseq['max'])) {
                $this->addUsingAlias(CustomerShipBolNotesTableMap::COL_QNSEQ, $qnseq['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    {
        if ($customerShipBolNotes) {
            $this->addCond('pruneCond0', $this->getAliasedColName(CustomerShipBolNotesTableMap::COL_QNTYPE), $customerShipBolNotes->getQntype(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(CustomerShipBolNotesTableMap::COL_QNSEQ), $customerShipBolNotes->getQnseq(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond2', $this->getAliasedColName(CustomerShipBolNotesTableMap::COL_QNKEY2), $customerShipBolNotes->getQnkey2(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond3', $this->getAliasedColName(CustomerShipBolNotesTableMap::COL_QNFORM), $customerShipBolNotes->getQnform(), Criteria::NOT_EQUAL);
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            CustomerShipBolNotesTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(CustomerShipBolNotesTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            CustomerShipBolNotesTableMap::removeInstanceFromPool($criteria);
