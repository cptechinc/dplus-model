...
/**
 * Base class that represents a row from the 'ar_cont_mast' table.
 *
 *
 *
...
abstract class ArContact implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\ArContactTableMap';
    ...
    /**
     * The value for the arcpcontid field.
     *
     * Note: this column has a database default value of: ''
     * @var        string
     */
    protected $arcpcontid;

    /**
     * The value for the arcptitl field.
     *
     * @var        string|null
     */
    protected $arcptitl;
    ...
    /**
     * The value for the arcparcont field.
     *
     * @var        string|null
     */
    protected $arcparcont;

    /**
     * The value for the arcpduncont field.
     *
     * @var        string|null
     */
    protected $arcpduncont;

    /**
     * The value for the arcpbuycont field.
     *
     * @var        string|null
     */
    protected $arcpbuycont;

    /**
     * The value for the arcpacknow field.
     *
     * @var        string|null
     */
    protected $arcpacknow;

    /**
     * The value for the arcpcertcont field.
     *
     * @var        string|null
     */
    protected $arcpcertcont;
    ...
    /**
     * Get the [arcpcontid] column value.
     *
     * @return string
     */
    public function getArcpcontid()
    {
        return $this->arcpcontid;
    }

    /**
     * Get the [arcptitl] column value.
     *
     * @return string|null
     */
    public function getArcptitl()
    {
        return $this->arcptitl;
    }

    /**
     * Get the [arcparcont] column value.
     *
     * @return string|null
     */
    public function getArcparcont()
    {
        return $this->arcparcont;
    }

    /**
     * Get the [arcpduncont] column value.
     *
     * @return string|null
     */
    public function getArcpduncont()
    {
        return $this->arcpduncont;
    }

    /**
     * Get the [arcpbuycont] column value.
     *
     * @return string|null
     */
    public function getArcpbuycont()
    {
        return $this->arcpbuycont;
    }

    /**
     * Get the [arcpacknow] column value.
     *
     * @return string|null
     */
    public function getArcpacknow()
    {
        return $this->arcpacknow;
    }

    /**
     * Get the [arcpcertcont] column value.
     *
     * @return string|null
     */
    public function getArcpcertcont()
    {
        return $this->arcpcertcont;
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO ar_cont_mast (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'ArstShipId':
                        ...
                        break;
                    case 'ArcpContId':
                        $stmt->bindValue($identifier, $this->arcpcontid, PDO::PARAM_STR);

                        break;
                    case 'ArcpTitl':
                        $stmt->bindValue($identifier, $this->arcptitl, PDO::PARAM_STR);

                        break;
                    case 'ArcpArCont':
                        $stmt->bindValue($identifier, $this->arcparcont, PDO::PARAM_STR);

                        break;
                    case 'ArcpDunCont':
                        $stmt->bindValue($identifier, $this->arcpduncont, PDO::PARAM_STR);

                        break;
                    case 'ArcpBuyCont':
                        $stmt->bindValue($identifier, $this->arcpbuycont, PDO::PARAM_STR);

                        break;
                    case 'ArcpAcknow':
                        $stmt->bindValue($identifier, $this->arcpacknow, PDO::PARAM_STR);

                        break;
                    case 'ArcpCertCont':
                        $stmt->bindValue($identifier, $this->arcpcertcont, PDO::PARAM_STR);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 2:
                return $this->getArcpcontid();

            case 3:
                return $this->getArcptitl();

            case 4:
                return $this->getArcparcont();

            case 5:
                return $this->getArcpduncont();

            case 6:
                return $this->getArcpbuycont();

            case 7:
                return $this->getArcpacknow();

            case 8:
                return $this->getArcpcertcont();
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[2] => $this->getArcpcontid(),
            $keys[3] => $this->getArcptitl(),
            $keys[4] => $this->getArcparcont(),
            $keys[5] => $this->getArcpduncont(),
            $keys[6] => $this->getArcpbuycont(),
            $keys[7] => $this->getArcpacknow(),
            $keys[8] => $this->getArcpcertcont(),
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setArcpcontid($value);
                break;
            case 3:
                $this->setArcptitl($value);
                break;
            case 4:
                $this->setArcparcont($value);
                break;
            case 5:
                $this->setArcpduncont($value);
                break;
            case 6:
                $this->setArcpbuycont($value);
                break;
            case 7:
                $this->setArcpacknow($value);
                break;
            case 8:
                $this->setArcpcertcont($value);
                break;
            case 9:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setArcpcontid($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setArcptitl($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setArcparcont($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setArcpduncont($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setArcpbuycont($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setArcpacknow($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setArcpcertcont($arr[$keys[8]]);
        }
    ...
    {
        return (null === $this->getArcucustid()) && (null === $this->getArstshipid()) && (null === $this->getArcpcontid());
    }
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setArcpcontid($this->getArcpcontid());
        $copyObj->setArcptitl($this->getArcptitl());
        $copyObj->setArcparcont($this->getArcparcont());
        $copyObj->setArcpduncont($this->getArcpduncont());
        $copyObj->setArcpbuycont($this->getArcpbuycont());
        $copyObj->setArcpacknow($this->getArcpacknow());
        $copyObj->setArcpcertcont($this->getArcpcertcont());
    ...
    public function clear()
    {
        ...
        $this->arcptitl = null;
        $this->arcparcont = null;
        $this->arcpduncont = null;
        $this->arcpbuycont = null;
        $this->arcpacknow = null;
        $this->arcpcertcont = null;
        $this->dateupdtd = null;
        $this->timeupdtd = null;
        $this->dummy = null;
        $this->alreadyInSave = false;
