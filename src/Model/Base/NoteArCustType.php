...
/**
 * Base class that represents a row from the 'notes_cust_type' table.
 *
 *
 *
...
abstract class NoteArCustType implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\NoteArCustTypeTableMap';
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO notes_cust_type (%s) VALUES (%s)',
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setArtbtypecode($arr[$keys[2]]);
        }
