 ...
 */
abstract class TermsCode implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TermsCodeTableMap';
    ...
    /**
     * Initializes internal state of Base\TermsCode object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>TermsCode</code> instance.  If
     * <code>obj</code> is an instance of <code>TermsCode</code>, delegates to
     * <code>equals(TermsCode)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TermsCode The current object, for fluid interface
     */
     ...
     * @return $this|\TermsCode The current object (for fluent API support)
     */
    public function setArtmtermcd($v)
    {
        ...
        if ($this->artmtermcd !== $v) {
            $this->artmtermcd = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMTERMCD] = true;
        }
    ...
    public function setArtmtermdesc($v)
    {
        ...
        if ($this->artmtermdesc !== $v) {
            $this->artmtermdesc = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMTERMDESC] = true;
        }
    ...
    public function setArtmmethod($v)
    {
        ...
        if ($this->artmmethod !== $v) {
            $this->artmmethod = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMMETHOD] = true;
        }
    ...
    public function setArtmtype($v)
    {
        ...
        if ($this->artmtype !== $v) {
            $this->artmtype = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMTYPE] = true;
        }
    ...
    public function setArtmhold($v)
    {
        ...
        if ($this->artmhold !== $v) {
            $this->artmhold = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMHOLD] = true;
        }
    ...
    public function setArtmexpiredate($v)
    {
        ...
        if ($this->artmexpiredate !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEXPIREDATE] = true;
        }
    ...
    public function setArtmfrtallow($v)
    {
        ...
        if ($this->artmfrtallow !== $v) {
            $this->artmfrtallow = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMFRTALLOW] = true;
        }
    ...
    public function setArtmccprefix($v)
    {
        ...
        if ($this->artmccprefix !== $v) {
            $this->artmccprefix = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMCCPREFIX] = true;
        }
    ...
    public function setArtmsplit1($v)
    {
        ...
        if ($this->artmsplit1 !== $v) {
            $this->artmsplit1 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMSPLIT1] = true;
        }
    ...
    public function setArtmorderpct1($v)
    {
        ...
        if ($this->artmorderpct1 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMORDERPCT1] = true;
        }
    ...
    public function setArtmdiscpct1($v)
    {
        ...
        if ($this->artmdiscpct1 !== $v) {
            $this->artmdiscpct1 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCPCT1] = true;
        }
    ...
    public function setArtmdiscdays1($v)
    {
        ...
        if ($this->artmdiscdays1 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDAYS1] = true;
        }
    ...
    public function setArtmdiscday1($v)
    {
        ...
        if ($this->artmdiscday1 !== $v) {
            $this->artmdiscday1 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDAY1] = true;
        }
    ...
    public function setArtmdiscdate1($v)
    {
        ...
        if ($this->artmdiscdate1 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDATE1] = true;
        }
    ...
    public function setArtmduedays1($v)
    {
        ...
        if ($this->artmduedays1 !== $v) {
            $this->artmduedays1 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDAYS1] = true;
        }
    ...
    public function setArtmdueday1($v)
    {
        ...
        if ($this->artmdueday1 !== $v) {
            $this->artmdueday1 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDAY1] = true;
        }
    ...
    public function setArtmplusmonths1($v)
    {
        ...
        if ($this->artmplusmonths1 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMPLUSMONTHS1] = true;
        }
    ...
    public function setArtmduedate1($v)
    {
        ...
        if ($this->artmduedate1 !== $v) {
            $this->artmduedate1 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDATE1] = true;
        }
    ...
    public function setArtmplusyear1($v)
    {
        ...
        if ($this->artmplusyear1 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMPLUSYEAR1] = true;
        }
    ...
    public function setArtmsplit2($v)
    {
        ...
        if ($this->artmsplit2 !== $v) {
            $this->artmsplit2 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMSPLIT2] = true;
        }
    ...
    public function setArtmorderpct2($v)
    {
        ...
        if ($this->artmorderpct2 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMORDERPCT2] = true;
        }
    ...
    public function setArtmdiscpct2($v)
    {
        ...
        if ($this->artmdiscpct2 !== $v) {
            $this->artmdiscpct2 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCPCT2] = true;
        }
    ...
    public function setArtmdiscdays2($v)
    {
        ...
        if ($this->artmdiscdays2 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDAYS2] = true;
        }
    ...
    public function setArtmdiscday2($v)
    {
        ...
        if ($this->artmdiscday2 !== $v) {
            $this->artmdiscday2 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDAY2] = true;
        }
    ...
    public function setArtmdiscdate2($v)
    {
        ...
        if ($this->artmdiscdate2 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDATE2] = true;
        }
    ...
    public function setArtmduedays2($v)
    {
        ...
        if ($this->artmduedays2 !== $v) {
            $this->artmduedays2 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDAYS2] = true;
        }
    ...
    public function setArtmdueday2($v)
    {
        ...
        if ($this->artmdueday2 !== $v) {
            $this->artmdueday2 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDAY2] = true;
        }
    ...
    public function setArtmplusmonths2($v)
    {
        ...
        if ($this->artmplusmonths2 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMPLUSMONTHS2] = true;
        }
    ...
    public function setArtmduedate2($v)
    {
        ...
        if ($this->artmduedate2 !== $v) {
            $this->artmduedate2 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDATE2] = true;
        }
    ...
    public function setArtmplusyear2($v)
    {
        ...
        if ($this->artmplusyear2 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMPLUSYEAR2] = true;
        }
    ...
    public function setArtmsplit3($v)
    {
        ...
        if ($this->artmsplit3 !== $v) {
            $this->artmsplit3 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMSPLIT3] = true;
        }
    ...
    public function setArtmorderpct3($v)
    {
        ...
        if ($this->artmorderpct3 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMORDERPCT3] = true;
        }
    ...
    public function setArtmdiscpct3($v)
    {
        ...
        if ($this->artmdiscpct3 !== $v) {
            $this->artmdiscpct3 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCPCT3] = true;
        }
    ...
    public function setArtmdiscdays3($v)
    {
        ...
        if ($this->artmdiscdays3 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDAYS3] = true;
        }
    ...
    public function setArtmdiscday3($v)
    {
        ...
        if ($this->artmdiscday3 !== $v) {
            $this->artmdiscday3 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDAY3] = true;
        }
    ...
    public function setArtmdiscdate3($v)
    {
        ...
        if ($this->artmdiscdate3 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDATE3] = true;
        }
    ...
    public function setArtmduedays3($v)
    {
        ...
        if ($this->artmduedays3 !== $v) {
            $this->artmduedays3 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDAYS3] = true;
        }
    ...
    public function setArtmdueday3($v)
    {
        ...
        if ($this->artmdueday3 !== $v) {
            $this->artmdueday3 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDAY3] = true;
        }
    ...
    public function setArtmplusmonths3($v)
    {
        ...
        if ($this->artmplusmonths3 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMPLUSMONTHS3] = true;
        }
    ...
    public function setArtmduedate3($v)
    {
        ...
        if ($this->artmduedate3 !== $v) {
            $this->artmduedate3 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDATE3] = true;
        }
    ...
    public function setArtmplusyear3($v)
    {
        ...
        if ($this->artmplusyear3 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMPLUSYEAR3] = true;
        }
    ...
    public function setArtmsplit4($v)
    {
        ...
        if ($this->artmsplit4 !== $v) {
            $this->artmsplit4 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMSPLIT4] = true;
        }
    ...
    public function setArtmorderpct4($v)
    {
        ...
        if ($this->artmorderpct4 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMORDERPCT4] = true;
        }
    ...
    public function setArtmdiscpct4($v)
    {
        ...
        if ($this->artmdiscpct4 !== $v) {
            $this->artmdiscpct4 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCPCT4] = true;
        }
    ...
    public function setArtmdiscdays4($v)
    {
        ...
        if ($this->artmdiscdays4 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDAYS4] = true;
        }
    ...
    public function setArtmdiscday4($v)
    {
        ...
        if ($this->artmdiscday4 !== $v) {
            $this->artmdiscday4 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDAY4] = true;
        }
    ...
    public function setArtmdiscdate4($v)
    {
        ...
        if ($this->artmdiscdate4 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDATE4] = true;
        }
    ...
    public function setArtmduedays4($v)
    {
        ...
        if ($this->artmduedays4 !== $v) {
            $this->artmduedays4 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDAYS4] = true;
        }
    ...
    public function setArtmdueday4($v)
    {
        ...
        if ($this->artmdueday4 !== $v) {
            $this->artmdueday4 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDAY4] = true;
        }
    ...
    public function setArtmplusmonths4($v)
    {
        ...
        if ($this->artmplusmonths4 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMPLUSMONTHS4] = true;
        }
    ...
    public function setArtmduedate4($v)
    {
        ...
        if ($this->artmduedate4 !== $v) {
            $this->artmduedate4 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDATE4] = true;
        }
    ...
    public function setArtmplusyear4($v)
    {
        ...
        if ($this->artmplusyear4 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMPLUSYEAR4] = true;
        }
    ...
    public function setArtmsplit5($v)
    {
        ...
        if ($this->artmsplit5 !== $v) {
            $this->artmsplit5 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMSPLIT5] = true;
        }
    ...
    public function setArtmorderpct5($v)
    {
        ...
        if ($this->artmorderpct5 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMORDERPCT5] = true;
        }
    ...
    public function setArtmdiscpct5($v)
    {
        ...
        if ($this->artmdiscpct5 !== $v) {
            $this->artmdiscpct5 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCPCT5] = true;
        }
    ...
    public function setArtmdiscdays5($v)
    {
        ...
        if ($this->artmdiscdays5 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDAYS5] = true;
        }
    ...
    public function setArtmdiscday5($v)
    {
        ...
        if ($this->artmdiscday5 !== $v) {
            $this->artmdiscday5 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDAY5] = true;
        }
    ...
    public function setArtmdiscdate5($v)
    {
        ...
        if ($this->artmdiscdate5 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDATE5] = true;
        }
    ...
    public function setArtmduedays5($v)
    {
        ...
        if ($this->artmduedays5 !== $v) {
            $this->artmduedays5 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDAYS5] = true;
        }
    ...
    public function setArtmdueday5($v)
    {
        ...
        if ($this->artmdueday5 !== $v) {
            $this->artmdueday5 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDAY5] = true;
        }
    ...
    public function setArtmplusmonths5($v)
    {
        ...
        if ($this->artmplusmonths5 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMPLUSMONTHS5] = true;
        }
    ...
    public function setArtmduedate5($v)
    {
        ...
        if ($this->artmduedate5 !== $v) {
            $this->artmduedate5 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDATE5] = true;
        }
    ...
    public function setArtmplusyear5($v)
    {
        ...
        if ($this->artmplusyear5 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMPLUSYEAR5] = true;
        }
    ...
    public function setArtmsplit6($v)
    {
        ...
        if ($this->artmsplit6 !== $v) {
            $this->artmsplit6 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMSPLIT6] = true;
        }
    ...
    public function setArtmorderpct6($v)
    {
        ...
        if ($this->artmorderpct6 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMORDERPCT6] = true;
        }
    ...
    public function setArtmdiscpct6($v)
    {
        ...
        if ($this->artmdiscpct6 !== $v) {
            $this->artmdiscpct6 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCPCT6] = true;
        }
    ...
    public function setArtmdiscdays6($v)
    {
        ...
        if ($this->artmdiscdays6 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDAYS6] = true;
        }
    ...
    public function setArtmdiscday6($v)
    {
        ...
        if ($this->artmdiscday6 !== $v) {
            $this->artmdiscday6 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDAY6] = true;
        }
    ...
    public function setArtmdiscdate6($v)
    {
        ...
        if ($this->artmdiscdate6 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDISCDATE6] = true;
        }
    ...
    public function setArtmduedays6($v)
    {
        ...
        if ($this->artmduedays6 !== $v) {
            $this->artmduedays6 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDAYS6] = true;
        }
    ...
    public function setArtmdueday6($v)
    {
        ...
        if ($this->artmdueday6 !== $v) {
            $this->artmdueday6 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDAY6] = true;
        }
    ...
    public function setArtmplusmonths6($v)
    {
        ...
        if ($this->artmplusmonths6 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMPLUSMONTHS6] = true;
        }
    ...
    public function setArtmduedate6($v)
    {
        ...
        if ($this->artmduedate6 !== $v) {
            $this->artmduedate6 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDUEDATE6] = true;
        }
    ...
    public function setArtmplusyear6($v)
    {
        ...
        if ($this->artmplusyear6 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMPLUSYEAR6] = true;
        }
    ...
    public function setArtmdayfrom1($v)
    {
        ...
        if ($this->artmdayfrom1 !== $v) {
            $this->artmdayfrom1 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDAYFROM1] = true;
        }
    ...
    public function setArtmdaythru1($v)
    {
        ...
        if ($this->artmdaythru1 !== $v) {
            $this->artmdaythru1 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDAYTHRU1] = true;
        }
    ...
    public function setArtmeomdiscpct1($v)
    {
        ...
        if ($this->artmeomdiscpct1 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMDISCPCT1] = true;
        }
    ...
    public function setArtmeomdiscday1($v)
    {
        ...
        if ($this->artmeomdiscday1 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMDISCDAY1] = true;
        }
    ...
    public function setArtmeomdiscmonths1($v)
    {
        ...
        if ($this->artmeomdiscmonths1 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMDISCMONTHS1] = true;
        }
    ...
    public function setArtmeomdueday1($v)
    {
        ...
        if ($this->artmeomdueday1 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMDUEDAY1] = true;
        }
    ...
    public function setArtmeomplusmonths1($v)
    {
        ...
        if ($this->artmeomplusmonths1 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMPLUSMONTHS1] = true;
        }
    ...
    public function setArtmdayfrom2($v)
    {
        ...
        if ($this->artmdayfrom2 !== $v) {
            $this->artmdayfrom2 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDAYFROM2] = true;
        }
    ...
    public function setArtmdaythru2($v)
    {
        ...
        if ($this->artmdaythru2 !== $v) {
            $this->artmdaythru2 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDAYTHRU2] = true;
        }
    ...
    public function setArtmeomdiscpct2($v)
    {
        ...
        if ($this->artmeomdiscpct2 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMDISCPCT2] = true;
        }
    ...
    public function setArtmeomdiscday2($v)
    {
        ...
        if ($this->artmeomdiscday2 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMDISCDAY2] = true;
        }
    ...
    public function setArtmeomdiscmonths2($v)
    {
        ...
        if ($this->artmeomdiscmonths2 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMDISCMONTHS2] = true;
        }
    ...
    public function setArtmeomdueday2($v)
    {
        ...
        if ($this->artmeomdueday2 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMDUEDAY2] = true;
        }
    ...
    public function setArtmeomplusmonths2($v)
    {
        ...
        if ($this->artmeomplusmonths2 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMPLUSMONTHS2] = true;
        }
    ...
    public function setArtmdayfrom3($v)
    {
        ...
        if ($this->artmdayfrom3 !== $v) {
            $this->artmdayfrom3 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDAYFROM3] = true;
        }
    ...
    public function setArtmdaythru3($v)
    {
        ...
        if ($this->artmdaythru3 !== $v) {
            $this->artmdaythru3 = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMDAYTHRU3] = true;
        }
    ...
    public function setArtmeomdiscpct3($v)
    {
        ...
        if ($this->artmeomdiscpct3 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMDISCPCT3] = true;
        }
    ...
    public function setArtmeomdiscday3($v)
    {
        ...
        if ($this->artmeomdiscday3 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMDISCDAY3] = true;
        }
    ...
    public function setArtmeomdiscmonths3($v)
    {
        ...
        if ($this->artmeomdiscmonths3 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMDISCMONTHS3] = true;
        }
    ...
    public function setArtmeomdueday3($v)
    {
        ...
        if ($this->artmeomdueday3 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMDUEDAY3] = true;
        }
    ...
    public function setArtmeomplusmonths3($v)
    {
        ...
        if ($this->artmeomplusmonths3 !== $v) {
            ...
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMEOMPLUSMONTHS3] = true;
        }
    ...
    public function setArtmctry($v)
    {
        ...
        if ($this->artmctry !== $v) {
            $this->artmctry = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMCTRY] = true;
        }
    ...
    public function setArtmtermgrup($v)
    {
        ...
        if ($this->artmtermgrup !== $v) {
            $this->artmtermgrup = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_ARTMTERMGRUP] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[TermsCodeTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TermsCodeTableMap::translateFieldName('Artmtermcd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmtermcd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TermsCodeTableMap::translateFieldName('Artmtermdesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmtermdesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TermsCodeTableMap::translateFieldName('Artmmethod', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmmethod = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TermsCodeTableMap::translateFieldName('Artmtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmtype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TermsCodeTableMap::translateFieldName('Artmhold', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmhold = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TermsCodeTableMap::translateFieldName('Artmexpiredate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmexpiredate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : TermsCodeTableMap::translateFieldName('Artmfrtallow', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmfrtallow = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : TermsCodeTableMap::translateFieldName('Artmccprefix', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmccprefix = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : TermsCodeTableMap::translateFieldName('Artmsplit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmsplit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : TermsCodeTableMap::translateFieldName('Artmorderpct1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmorderpct1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscpct1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscpct1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscdays1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscdays1 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscday1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscday1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscdate1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscdate1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : TermsCodeTableMap::translateFieldName('Artmduedays1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmduedays1 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : TermsCodeTableMap::translateFieldName('Artmdueday1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdueday1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : TermsCodeTableMap::translateFieldName('Artmplusmonths1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmplusmonths1 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : TermsCodeTableMap::translateFieldName('Artmduedate1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmduedate1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : TermsCodeTableMap::translateFieldName('Artmplusyear1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmplusyear1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : TermsCodeTableMap::translateFieldName('Artmsplit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmsplit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : TermsCodeTableMap::translateFieldName('Artmorderpct2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmorderpct2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscpct2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscpct2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscdays2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscdays2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscday2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscday2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscdate2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscdate2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : TermsCodeTableMap::translateFieldName('Artmduedays2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmduedays2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : TermsCodeTableMap::translateFieldName('Artmdueday2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdueday2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : TermsCodeTableMap::translateFieldName('Artmplusmonths2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmplusmonths2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : TermsCodeTableMap::translateFieldName('Artmduedate2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmduedate2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : TermsCodeTableMap::translateFieldName('Artmplusyear2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmplusyear2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : TermsCodeTableMap::translateFieldName('Artmsplit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmsplit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : TermsCodeTableMap::translateFieldName('Artmorderpct3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmorderpct3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscpct3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscpct3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscdays3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscdays3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscday3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscday3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscdate3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscdate3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : TermsCodeTableMap::translateFieldName('Artmduedays3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmduedays3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : TermsCodeTableMap::translateFieldName('Artmdueday3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdueday3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : TermsCodeTableMap::translateFieldName('Artmplusmonths3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmplusmonths3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : TermsCodeTableMap::translateFieldName('Artmduedate3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmduedate3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : TermsCodeTableMap::translateFieldName('Artmplusyear3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmplusyear3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : TermsCodeTableMap::translateFieldName('Artmsplit4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmsplit4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : TermsCodeTableMap::translateFieldName('Artmorderpct4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmorderpct4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscpct4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscpct4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscdays4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscdays4 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscday4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscday4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscdate4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscdate4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : TermsCodeTableMap::translateFieldName('Artmduedays4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmduedays4 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : TermsCodeTableMap::translateFieldName('Artmdueday4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdueday4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : TermsCodeTableMap::translateFieldName('Artmplusmonths4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmplusmonths4 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : TermsCodeTableMap::translateFieldName('Artmduedate4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmduedate4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : TermsCodeTableMap::translateFieldName('Artmplusyear4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmplusyear4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : TermsCodeTableMap::translateFieldName('Artmsplit5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmsplit5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : TermsCodeTableMap::translateFieldName('Artmorderpct5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmorderpct5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscpct5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscpct5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscdays5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscdays5 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscday5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscday5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscdate5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscdate5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : TermsCodeTableMap::translateFieldName('Artmduedays5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmduedays5 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : TermsCodeTableMap::translateFieldName('Artmdueday5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdueday5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 60 + $startcol : TermsCodeTableMap::translateFieldName('Artmplusmonths5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmplusmonths5 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 61 + $startcol : TermsCodeTableMap::translateFieldName('Artmduedate5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmduedate5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 62 + $startcol : TermsCodeTableMap::translateFieldName('Artmplusyear5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmplusyear5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 63 + $startcol : TermsCodeTableMap::translateFieldName('Artmsplit6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmsplit6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 64 + $startcol : TermsCodeTableMap::translateFieldName('Artmorderpct6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmorderpct6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 65 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscpct6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscpct6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 66 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscdays6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscdays6 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 67 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscday6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscday6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 68 + $startcol : TermsCodeTableMap::translateFieldName('Artmdiscdate6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdiscdate6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 69 + $startcol : TermsCodeTableMap::translateFieldName('Artmduedays6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmduedays6 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 70 + $startcol : TermsCodeTableMap::translateFieldName('Artmdueday6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdueday6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 71 + $startcol : TermsCodeTableMap::translateFieldName('Artmplusmonths6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmplusmonths6 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 72 + $startcol : TermsCodeTableMap::translateFieldName('Artmduedate6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmduedate6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 73 + $startcol : TermsCodeTableMap::translateFieldName('Artmplusyear6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmplusyear6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 74 + $startcol : TermsCodeTableMap::translateFieldName('Artmdayfrom1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdayfrom1 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 75 + $startcol : TermsCodeTableMap::translateFieldName('Artmdaythru1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdaythru1 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 76 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomdiscpct1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomdiscpct1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 77 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomdiscday1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomdiscday1 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 78 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomdiscmonths1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomdiscmonths1 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 79 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomdueday1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomdueday1 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 80 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomplusmonths1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomplusmonths1 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 81 + $startcol : TermsCodeTableMap::translateFieldName('Artmdayfrom2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdayfrom2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 82 + $startcol : TermsCodeTableMap::translateFieldName('Artmdaythru2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdaythru2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 83 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomdiscpct2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomdiscpct2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 84 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomdiscday2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomdiscday2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 85 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomdiscmonths2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomdiscmonths2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 86 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomdueday2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomdueday2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 87 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomplusmonths2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomplusmonths2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 88 + $startcol : TermsCodeTableMap::translateFieldName('Artmdayfrom3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdayfrom3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 89 + $startcol : TermsCodeTableMap::translateFieldName('Artmdaythru3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmdaythru3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 90 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomdiscpct3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomdiscpct3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 91 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomdiscday3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomdiscday3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 92 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomdiscmonths3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomdiscmonths3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 93 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomdueday3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomdueday3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 94 + $startcol : TermsCodeTableMap::translateFieldName('Artmeomplusmonths3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmeomplusmonths3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 95 + $startcol : TermsCodeTableMap::translateFieldName('Artmctry', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmctry = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 96 + $startcol : TermsCodeTableMap::translateFieldName('Artmtermgrup', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artmtermgrup = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 97 + $startcol : TermsCodeTableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 98 + $startcol : TermsCodeTableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 99 + $startcol : TermsCodeTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 100; // 100 = TermsCodeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TermsCode'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTermsCodeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TermsCode::setDeleted()
     * @see TermsCode::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTermsCodeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TermsCodeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMTERMCD)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmTermCd';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMTERMDESC)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmTermDesc';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMMETHOD)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmMethod';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmType';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMHOLD)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmHold';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEXPIREDATE)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmExpireDate';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMFRTALLOW)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmFrtAllow';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMCCPREFIX)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmCcPrefix';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMSPLIT1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmSplit1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMORDERPCT1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmOrderPct1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCPCT1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscPct1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAYS1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDays1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAY1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDay1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDATE1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDate1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAYS1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDays1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAY1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDay1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSMONTHS1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmPlusMonths1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDATE1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDate1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSYEAR1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmPlusYear1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMSPLIT2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmSplit2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMORDERPCT2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmOrderPct2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCPCT2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscPct2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAYS2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDays2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAY2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDay2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDATE2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDate2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAYS2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDays2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAY2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDay2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSMONTHS2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmPlusMonths2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDATE2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDate2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSYEAR2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmPlusYear2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMSPLIT3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmSplit3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMORDERPCT3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmOrderPct3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCPCT3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscPct3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAYS3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDays3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAY3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDay3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDATE3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDate3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAYS3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDays3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAY3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDay3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSMONTHS3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmPlusMonths3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDATE3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDate3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSYEAR3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmPlusYear3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMSPLIT4)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmSplit4';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMORDERPCT4)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmOrderPct4';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCPCT4)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscPct4';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAYS4)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDays4';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAY4)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDay4';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDATE4)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDate4';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAYS4)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDays4';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAY4)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDay4';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSMONTHS4)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmPlusMonths4';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDATE4)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDate4';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSYEAR4)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmPlusYear4';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMSPLIT5)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmSplit5';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMORDERPCT5)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmOrderPct5';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCPCT5)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscPct5';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAYS5)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDays5';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAY5)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDay5';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDATE5)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDate5';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAYS5)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDays5';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAY5)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDay5';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSMONTHS5)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmPlusMonths5';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDATE5)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDate5';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSYEAR5)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmPlusYear5';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMSPLIT6)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmSplit6';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMORDERPCT6)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmOrderPct6';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCPCT6)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscPct6';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAYS6)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDays6';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAY6)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDay6';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDATE6)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDiscDate6';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAYS6)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDays6';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAY6)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDay6';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSMONTHS6)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmPlusMonths6';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDATE6)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDueDate6';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSYEAR6)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmPlusYear6';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDAYFROM1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDayFrom1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDAYTHRU1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDayThru1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCPCT1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomDiscPct1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCDAY1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomDiscDay1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCMONTHS1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomDiscMonths1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDUEDAY1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomDueDay1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMPLUSMONTHS1)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomPlusMonths1';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDAYFROM2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDayFrom2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDAYTHRU2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDayThru2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCPCT2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomDiscPct2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCDAY2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomDiscDay2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCMONTHS2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomDiscMonths2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDUEDAY2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomDueDay2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMPLUSMONTHS2)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomPlusMonths2';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDAYFROM3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDayFrom3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDAYTHRU3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmDayThru3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCPCT3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomDiscPct3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCDAY3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomDiscDay3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCMONTHS3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomDiscMonths3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDUEDAY3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomDueDay3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMPLUSMONTHS3)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmEomPlusMonths3';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMCTRY)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmCtry';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMTERMGRUP)) {
            $modifiedColumns[':p' . $index++]  = 'ArtmTermGrup';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_DATEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'DateUpdtd';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_DUMMY)) {
    ...
    {
        $pos = TermsCodeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['TermsCode'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TermsCode'][$this->hashCode()] = true;
        $keys = TermsCodeTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMTERMCD)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMTERMCD, $this->artmtermcd);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMTERMDESC)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMTERMDESC, $this->artmtermdesc);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMMETHOD)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMMETHOD, $this->artmmethod);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMTYPE)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMTYPE, $this->artmtype);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMHOLD)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMHOLD, $this->artmhold);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEXPIREDATE)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEXPIREDATE, $this->artmexpiredate);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMFRTALLOW)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMFRTALLOW, $this->artmfrtallow);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMCCPREFIX)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMCCPREFIX, $this->artmccprefix);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMSPLIT1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMSPLIT1, $this->artmsplit1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMORDERPCT1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMORDERPCT1, $this->artmorderpct1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCPCT1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCPCT1, $this->artmdiscpct1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAYS1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDAYS1, $this->artmdiscdays1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAY1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDAY1, $this->artmdiscday1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDATE1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDATE1, $this->artmdiscdate1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAYS1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDAYS1, $this->artmduedays1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAY1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDAY1, $this->artmdueday1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSMONTHS1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMPLUSMONTHS1, $this->artmplusmonths1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDATE1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDATE1, $this->artmduedate1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSYEAR1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMPLUSYEAR1, $this->artmplusyear1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMSPLIT2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMSPLIT2, $this->artmsplit2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMORDERPCT2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMORDERPCT2, $this->artmorderpct2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCPCT2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCPCT2, $this->artmdiscpct2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAYS2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDAYS2, $this->artmdiscdays2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAY2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDAY2, $this->artmdiscday2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDATE2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDATE2, $this->artmdiscdate2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAYS2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDAYS2, $this->artmduedays2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAY2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDAY2, $this->artmdueday2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSMONTHS2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMPLUSMONTHS2, $this->artmplusmonths2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDATE2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDATE2, $this->artmduedate2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSYEAR2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMPLUSYEAR2, $this->artmplusyear2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMSPLIT3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMSPLIT3, $this->artmsplit3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMORDERPCT3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMORDERPCT3, $this->artmorderpct3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCPCT3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCPCT3, $this->artmdiscpct3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAYS3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDAYS3, $this->artmdiscdays3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAY3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDAY3, $this->artmdiscday3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDATE3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDATE3, $this->artmdiscdate3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAYS3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDAYS3, $this->artmduedays3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAY3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDAY3, $this->artmdueday3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSMONTHS3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMPLUSMONTHS3, $this->artmplusmonths3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDATE3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDATE3, $this->artmduedate3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSYEAR3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMPLUSYEAR3, $this->artmplusyear3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMSPLIT4)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMSPLIT4, $this->artmsplit4);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMORDERPCT4)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMORDERPCT4, $this->artmorderpct4);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCPCT4)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCPCT4, $this->artmdiscpct4);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAYS4)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDAYS4, $this->artmdiscdays4);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAY4)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDAY4, $this->artmdiscday4);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDATE4)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDATE4, $this->artmdiscdate4);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAYS4)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDAYS4, $this->artmduedays4);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAY4)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDAY4, $this->artmdueday4);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSMONTHS4)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMPLUSMONTHS4, $this->artmplusmonths4);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDATE4)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDATE4, $this->artmduedate4);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSYEAR4)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMPLUSYEAR4, $this->artmplusyear4);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMSPLIT5)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMSPLIT5, $this->artmsplit5);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMORDERPCT5)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMORDERPCT5, $this->artmorderpct5);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCPCT5)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCPCT5, $this->artmdiscpct5);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAYS5)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDAYS5, $this->artmdiscdays5);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAY5)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDAY5, $this->artmdiscday5);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDATE5)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDATE5, $this->artmdiscdate5);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAYS5)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDAYS5, $this->artmduedays5);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAY5)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDAY5, $this->artmdueday5);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSMONTHS5)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMPLUSMONTHS5, $this->artmplusmonths5);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDATE5)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDATE5, $this->artmduedate5);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSYEAR5)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMPLUSYEAR5, $this->artmplusyear5);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMSPLIT6)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMSPLIT6, $this->artmsplit6);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMORDERPCT6)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMORDERPCT6, $this->artmorderpct6);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCPCT6)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCPCT6, $this->artmdiscpct6);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAYS6)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDAYS6, $this->artmdiscdays6);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDAY6)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDAY6, $this->artmdiscday6);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDISCDATE6)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDISCDATE6, $this->artmdiscdate6);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAYS6)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDAYS6, $this->artmduedays6);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDAY6)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDAY6, $this->artmdueday6);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSMONTHS6)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMPLUSMONTHS6, $this->artmplusmonths6);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDUEDATE6)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDUEDATE6, $this->artmduedate6);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMPLUSYEAR6)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMPLUSYEAR6, $this->artmplusyear6);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDAYFROM1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDAYFROM1, $this->artmdayfrom1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDAYTHRU1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDAYTHRU1, $this->artmdaythru1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCPCT1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMDISCPCT1, $this->artmeomdiscpct1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCDAY1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMDISCDAY1, $this->artmeomdiscday1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCMONTHS1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMDISCMONTHS1, $this->artmeomdiscmonths1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDUEDAY1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMDUEDAY1, $this->artmeomdueday1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMPLUSMONTHS1)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMPLUSMONTHS1, $this->artmeomplusmonths1);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDAYFROM2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDAYFROM2, $this->artmdayfrom2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDAYTHRU2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDAYTHRU2, $this->artmdaythru2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCPCT2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMDISCPCT2, $this->artmeomdiscpct2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCDAY2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMDISCDAY2, $this->artmeomdiscday2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCMONTHS2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMDISCMONTHS2, $this->artmeomdiscmonths2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDUEDAY2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMDUEDAY2, $this->artmeomdueday2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMPLUSMONTHS2)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMPLUSMONTHS2, $this->artmeomplusmonths2);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDAYFROM3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDAYFROM3, $this->artmdayfrom3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMDAYTHRU3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMDAYTHRU3, $this->artmdaythru3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCPCT3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMDISCPCT3, $this->artmeomdiscpct3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCDAY3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMDISCDAY3, $this->artmeomdiscday3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDISCMONTHS3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMDISCMONTHS3, $this->artmeomdiscmonths3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMDUEDAY3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMDUEDAY3, $this->artmeomdueday3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMEOMPLUSMONTHS3)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMEOMPLUSMONTHS3, $this->artmeomplusmonths3);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMCTRY)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMCTRY, $this->artmctry);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_ARTMTERMGRUP)) {
            $criteria->add(TermsCodeTableMap::COL_ARTMTERMGRUP, $this->artmtermgrup);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_DATEUPDTD)) {
            $criteria->add(TermsCodeTableMap::COL_DATEUPDTD, $this->dateupdtd);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_TIMEUPDTD)) {
            $criteria->add(TermsCodeTableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(TermsCodeTableMap::COL_DUMMY)) {
            $criteria->add(TermsCodeTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildTermsCodeQuery::create();
        $criteria->add(TermsCodeTableMap::COL_ARTMTERMCD, $this->artmtermcd);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TermsCode (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TermsCode Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(TermsCodeTableMap::DEFAULT_STRING_FORMAT);
    }
