...
abstract class ArStandardIndustrialClass implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\ArStandardIndustrialClassTableMap';
    ...
    /**
     * Initializes internal state of Base\ArStandardIndustrialClass object.
     * @see applyDefaults()
     */
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ArStandardIndustrialClass Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
