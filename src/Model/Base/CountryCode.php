...
/**
 * Base class that represents a row from the 'country_codes' table.
 *
 *
 *
...
abstract class CountryCode implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\CountryCodeTableMap';
    ...
    /**
     * The value for the ctryisoalpha3 field.
     *
     * Note: this column has a database default value of: ''
     * @var        string
     */
    protected $ctryisoalpha3;

    /**
     * The value for the ctrydesc field.
     *
     * @var        string|null
     */
    protected $ctrydesc;
    ...
    /**
     * The value for the ctryisoalpha2 field.
     *
     * @var        string|null
     */
    protected $ctryisoalpha2;

    /**
     * The value for the ctryisonumeric field.
     *
     * @var        int|null
     */
    protected $ctryisonumeric;

    /**
     * The value for the ctrycustomcode field.
     *
     * @var        string|null
     */
    protected $ctrycustomcode;

    /**
     * The value for the ctryexchrate field.
     *
     * @var        string|null
     */
    protected $ctryexchrate;

    /**
     * The value for the ctrydate field.
     *
     * @var        string|null
     */
    protected $ctrydate;
    ...
    /**
     * Get the [ctryisoalpha3] column value.
     *
     * @return string
     */
    public function getCtryisoalpha3()
    {
        return $this->ctryisoalpha3;
    }

    /**
     * Get the [ctrydesc] column value.
     *
     * @return string|null
     */
    public function getCtrydesc()
    {
        return $this->ctrydesc;
    }

    /**
     * Get the [ctryisoalpha2] column value.
     *
     * @return string|null
     */
    public function getCtryisoalpha2()
    {
        return $this->ctryisoalpha2;
    }

    /**
     * Get the [ctryisonumeric] column value.
     *
     * @return int|null
     */
    public function getCtryisonumeric()
    {
        return $this->ctryisonumeric;
    }

    /**
     * Get the [ctrycustomcode] column value.
     *
     * @return string|null
     */
    public function getCtrycustomcode()
    {
        return $this->ctrycustomcode;
    }

    /**
     * Get the [ctryexchrate] column value.
     *
     * @return string|null
     */
    public function getCtryexchrate()
    {
        return $this->ctryexchrate;
    }

    /**
     * Get the [ctrydate] column value.
     *
     * @return string|null
     */
    public function getCtrydate()
    {
        return $this->ctrydate;
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO country_codes (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'CtryIsoAlpha3':
                        $stmt->bindValue($identifier, $this->ctryisoalpha3, PDO::PARAM_STR);

                        break;
                    case 'CtryDesc':
                        $stmt->bindValue($identifier, $this->ctrydesc, PDO::PARAM_STR);

                        break;
                    case 'CtryIsoAlpha2':
                        $stmt->bindValue($identifier, $this->ctryisoalpha2, PDO::PARAM_STR);

                        break;
                    case 'CtryIsoNumeric':
                        $stmt->bindValue($identifier, $this->ctryisonumeric, PDO::PARAM_INT);

                        break;
                    case 'CtryCustomCode':
                        $stmt->bindValue($identifier, $this->ctrycustomcode, PDO::PARAM_STR);

                        break;
                    case 'CtryExchRate':
                        $stmt->bindValue($identifier, $this->ctryexchrate, PDO::PARAM_STR);

                        break;
                    case 'CtryDate':
                        $stmt->bindValue($identifier, $this->ctrydate, PDO::PARAM_STR);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            case 0:
                return $this->getCtryisoalpha3();

            case 1:
                return $this->getCtrydesc();

            case 2:
                return $this->getCtryisoalpha2();

            case 3:
                return $this->getCtryisonumeric();

            case 4:
                return $this->getCtrycustomcode();

            case 5:
                return $this->getCtryexchrate();

            case 6:
                return $this->getCtrydate();
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = []): array
    {
        ...
        $result = [
            ...
            $keys[2] => $this->getCtryisoalpha2(),
            $keys[3] => $this->getCtryisonumeric(),
            $keys[4] => $this->getCtrycustomcode(),
            $keys[5] => $this->getCtryexchrate(),
            $keys[6] => $this->getCtrydate(),
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setCtryisoalpha3($value);
                break;
            case 1:
                $this->setCtrydesc($value);
                break;
            case 2:
                $this->setCtryisoalpha2($value);
                break;
            case 3:
                $this->setCtryisonumeric($value);
                break;
            case 4:
                $this->setCtrycustomcode($value);
                break;
            case 5:
                $this->setCtryexchrate($value);
                break;
            case 6:
                $this->setCtrydate($value);
                break;
            case 7:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setCtrydesc($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setCtryisoalpha2($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setCtryisonumeric($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setCtrycustomcode($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setCtryexchrate($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setCtrydate($arr[$keys[6]]);
        }
    ...
    {
        $validPk = null !== $this->getCtryisoalpha3();
    ...
    /**
     * Generic method to set the primary key (ctryisoalpha3 column).
     *
    ...
    {
        return null === $this->getCtryisoalpha3();
    }
    ...
    {
        $copyObj->setCtryisoalpha3($this->getCtryisoalpha3());
        $copyObj->setCtrydesc($this->getCtrydesc());
        $copyObj->setCtryisoalpha2($this->getCtryisoalpha2());
        $copyObj->setCtryisonumeric($this->getCtryisonumeric());
        $copyObj->setCtrycustomcode($this->getCtrycustomcode());
        $copyObj->setCtryexchrate($this->getCtryexchrate());
        $copyObj->setCtrydate($this->getCtrydate());
    ...
    {
        $this->ctryisoalpha3 = null;
        $this->ctrydesc = null;
        $this->ctryisoalpha2 = null;
        $this->ctryisonumeric = null;
        $this->ctrycustomcode = null;
        $this->ctryexchrate = null;
        $this->ctrydate = null;
        $this->dateupdtd = null;
        $this->timeupdtd = null;
        $this->dummy = null;
