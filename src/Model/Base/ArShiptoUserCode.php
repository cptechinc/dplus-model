...
/**
 * Base class that represents a row from the 'ar_cust_susr' table.
 *
 *
 *
...
abstract class ArShiptoUserCode implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\ArShiptoUserCodeTableMap';
    ...
    /**
     * The value for the artbsusrcode field.
     *
     * Note: this column has a database default value of: ''
     * @var        string
     */
    protected $artbsusrcode;

    /**
     * The value for the artbsusrdesc field.
     *
     * @var        string|null
     */
    protected $artbsusrdesc;
    ...
    /**
     * Get the [artbsusrcode] column value.
     *
     * @return string
     */
    public function getArtbsusrcode()
    {
        return $this->artbsusrcode;
    }

    /**
     * Get the [artbsusrdesc] column value.
     *
     * @return string|null
     */
    public function getArtbsusrdesc()
    {
        return $this->artbsusrdesc;
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO ar_cust_susr (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'ArtbSusrCode':
                        $stmt->bindValue($identifier, $this->artbsusrcode, PDO::PARAM_STR);

                        break;
                    case 'ArtbSusrDesc':
                        $stmt->bindValue($identifier, $this->artbsusrdesc, PDO::PARAM_STR);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            case 0:
                return $this->getArtbsusrcode();

            case 1:
                return $this->getArtbsusrdesc();
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setArtbsusrcode($value);
                break;
            case 1:
                $this->setArtbsusrdesc($value);
                break;
            case 2:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setArtbsusrdesc($arr[$keys[1]]);
        }
    ...
    {
        $validPk = null !== $this->getArtbsusrcode();
    ...
    /**
     * Generic method to set the primary key (artbsusrcode column).
     *
    ...
    {
        return null === $this->getArtbsusrcode();
    }
    ...
    {
        $copyObj->setArtbsusrcode($this->getArtbsusrcode());
        $copyObj->setArtbsusrdesc($this->getArtbsusrdesc());
    ...
    {
        $this->artbsusrcode = null;
        $this->artbsusrdesc = null;
        $this->dateupdtd = null;
        $this->timeupdtd = null;
        $this->dummy = null;
        $this->alreadyInSave = false;
