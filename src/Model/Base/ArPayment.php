 ...
 */
abstract class ArPayment implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ArPaymentTableMap';
    ...
    /**
     * Initializes internal state of Base\ArPayment object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ArPayment</code> instance.  If
     * <code>obj</code> is an instance of <code>ArPayment</code>, delegates to
     * <code>equals(ArPayment)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ArPayment The current object, for fluid interface
     */
     ...
     * @return $this|\ArPayment The current object (for fluent API support)
     */
    public function setArcucustid($v)
    {
        ...
        if ($this->arcucustid !== $v) {
            $this->arcucustid = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCUCUSTID] = true;
        }
    ...
    public function setArcdinvnbr($v)
    {
        ...
        if ($this->arcdinvnbr !== $v) {
            $this->arcdinvnbr = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDINVNBR] = true;
        }
    ...
    public function setArcdinvseq($v)
    {
        ...
        if ($this->arcdinvseq !== $v) {
            $this->arcdinvseq = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDINVSEQ] = true;
        }
    ...
    public function setArcdpaid($v)
    {
        ...
        if ($this->arcdpaid !== $v) {
            $this->arcdpaid = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDPAID] = true;
        }
    ...
    public function setArcdinvdate($v)
    {
        ...
        if ($this->arcdinvdate !== $v) {
            $this->arcdinvdate = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDINVDATE] = true;
        }
    ...
    public function setArcdduedate($v)
    {
        ...
        if ($this->arcdduedate !== $v) {
            $this->arcdduedate = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDDUEDATE] = true;
        }
    ...
    public function setArcdchknbr($v)
    {
        ...
        if ($this->arcdchknbr !== $v) {
            $this->arcdchknbr = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDCHKNBR] = true;
        }
    ...
    public function setArcdamtdue($v)
    {
        ...
        if ($this->arcdamtdue !== $v) {
            $this->arcdamtdue = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDAMTDUE] = true;
        }
    ...
    public function setArcdamtpaid($v)
    {
        ...
        if ($this->arcdamtpaid !== $v) {
            $this->arcdamtpaid = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDAMTPAID] = true;
        }
    ...
    public function setArcddiscpaid($v)
    {
        ...
        if ($this->arcddiscpaid !== $v) {
            $this->arcddiscpaid = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDDISCPAID] = true;
        }
    ...
    public function setArcdcashacct($v)
    {
        ...
        if ($this->arcdcashacct !== $v) {
            $this->arcdcashacct = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDCASHACCT] = true;
        }
    ...
    public function setArcdcredacct($v)
    {
        ...
        if ($this->arcdcredacct !== $v) {
            $this->arcdcredacct = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDCREDACCT] = true;
        }
    ...
    public function setArcdtermcode($v)
    {
        ...
        if ($this->arcdtermcode !== $v) {
            $this->arcdtermcode = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTERMCODE] = true;
        }
    ...
    public function setArcdfrtallow($v)
    {
        ...
        if ($this->arcdfrtallow !== $v) {
            $this->arcdfrtallow = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDFRTALLOW] = true;
        }
    ...
    public function setArcdcustpo($v)
    {
        ...
        if ($this->arcdcustpo !== $v) {
            $this->arcdcustpo = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDCUSTPO] = true;
        }
    ...
    public function setArcdordrnbr($v)
    {
        ...
        if ($this->arcdordrnbr !== $v) {
            $this->arcdordrnbr = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDORDRNBR] = true;
        }
    ...
    public function setArcdtaxcode1($v)
    {
        ...
        if ($this->arcdtaxcode1 !== $v) {
            $this->arcdtaxcode1 = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXCODE1] = true;
        }
    ...
    public function setArcdtaxallow1($v)
    {
        ...
        if ($this->arcdtaxallow1 !== $v) {
            ...
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXALLOW1] = true;
        }
    ...
    public function setArcdtaxcode2($v)
    {
        ...
        if ($this->arcdtaxcode2 !== $v) {
            $this->arcdtaxcode2 = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXCODE2] = true;
        }
    ...
    public function setArcdtaxallow2($v)
    {
        ...
        if ($this->arcdtaxallow2 !== $v) {
            ...
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXALLOW2] = true;
        }
    ...
    public function setArcdtaxcode3($v)
    {
        ...
        if ($this->arcdtaxcode3 !== $v) {
            $this->arcdtaxcode3 = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXCODE3] = true;
        }
    ...
    public function setArcdtaxallow3($v)
    {
        ...
        if ($this->arcdtaxallow3 !== $v) {
            ...
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXALLOW3] = true;
        }
    ...
    public function setArcdtaxcode4($v)
    {
        ...
        if ($this->arcdtaxcode4 !== $v) {
            $this->arcdtaxcode4 = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXCODE4] = true;
        }
    ...
    public function setArcdtaxallow4($v)
    {
        ...
        if ($this->arcdtaxallow4 !== $v) {
            ...
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXALLOW4] = true;
        }
    ...
    public function setArcdtaxcode5($v)
    {
        ...
        if ($this->arcdtaxcode5 !== $v) {
            $this->arcdtaxcode5 = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXCODE5] = true;
        }
    ...
    public function setArcdtaxallow5($v)
    {
        ...
        if ($this->arcdtaxallow5 !== $v) {
            ...
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXALLOW5] = true;
        }
    ...
    public function setArcdtaxcode6($v)
    {
        ...
        if ($this->arcdtaxcode6 !== $v) {
            $this->arcdtaxcode6 = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXCODE6] = true;
        }
    ...
    public function setArcdtaxallow6($v)
    {
        ...
        if ($this->arcdtaxallow6 !== $v) {
            ...
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXALLOW6] = true;
        }
    ...
    public function setArcdtaxcode7($v)
    {
        ...
        if ($this->arcdtaxcode7 !== $v) {
            $this->arcdtaxcode7 = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXCODE7] = true;
        }
    ...
    public function setArcdtaxallow7($v)
    {
        ...
        if ($this->arcdtaxallow7 !== $v) {
            ...
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXALLOW7] = true;
        }
    ...
    public function setArcdtaxcode8($v)
    {
        ...
        if ($this->arcdtaxcode8 !== $v) {
            $this->arcdtaxcode8 = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXCODE8] = true;
        }
    ...
    public function setArcdtaxallow8($v)
    {
        ...
        if ($this->arcdtaxallow8 !== $v) {
            ...
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXALLOW8] = true;
        }
    ...
    public function setArcdtaxcode9($v)
    {
        ...
        if ($this->arcdtaxcode9 !== $v) {
            $this->arcdtaxcode9 = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXCODE9] = true;
        }
    ...
    public function setArcdtaxallow9($v)
    {
        ...
        if ($this->arcdtaxallow9 !== $v) {
            ...
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDTAXALLOW9] = true;
        }
    ...
    public function setArcdwriteoff($v)
    {
        ...
        if ($this->arcdwriteoff !== $v) {
            $this->arcdwriteoff = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDWRITEOFF] = true;
        }
    ...
    public function setArcdwriteoffreas($v)
    {
        ...
        if ($this->arcdwriteoffreas !== $v) {
            ...
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDWRITEOFFREAS] = true;
        }
    ...
    public function setArcdcomrate($v)
    {
        ...
        if ($this->arcdcomrate !== $v) {
            $this->arcdcomrate = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDCOMRATE] = true;
        }
    ...
    public function setArcdsalesamt($v)
    {
        ...
        if ($this->arcdsalesamt !== $v) {
            $this->arcdsalesamt = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDSALESAMT] = true;
        }
    ...
    public function setArcdpaydate($v)
    {
        ...
        if ($this->arcdpaydate !== $v) {
            $this->arcdpaydate = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDPAYDATE] = true;
        }
    ...
    public function setArcdglpd($v)
    {
        ...
        if ($this->arcdglpd !== $v) {
            $this->arcdglpd = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDGLPD] = true;
        }
    ...
    public function setArcdref($v)
    {
        ...
        if ($this->arcdref !== $v) {
            $this->arcdref = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_ARCDREF] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[ArPaymentTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ArPaymentTableMap::translateFieldName('Arcucustid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcucustid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ArPaymentTableMap::translateFieldName('Arcdinvnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdinvnbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ArPaymentTableMap::translateFieldName('Arcdinvseq', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdinvseq = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ArPaymentTableMap::translateFieldName('Arcdpaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdpaid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ArPaymentTableMap::translateFieldName('Arcdinvdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdinvdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ArPaymentTableMap::translateFieldName('Arcdduedate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdduedate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ArPaymentTableMap::translateFieldName('Arcdchknbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdchknbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ArPaymentTableMap::translateFieldName('Arcdamtdue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdamtdue = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ArPaymentTableMap::translateFieldName('Arcdamtpaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdamtpaid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ArPaymentTableMap::translateFieldName('Arcddiscpaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcddiscpaid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ArPaymentTableMap::translateFieldName('Arcdcashacct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdcashacct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ArPaymentTableMap::translateFieldName('Arcdcredacct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdcredacct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtermcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtermcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : ArPaymentTableMap::translateFieldName('Arcdfrtallow', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdfrtallow = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : ArPaymentTableMap::translateFieldName('Arcdcustpo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdcustpo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : ArPaymentTableMap::translateFieldName('Arcdordrnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdordrnbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxcode1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxcode1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxallow1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxallow1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxcode2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxcode2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxallow2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxallow2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxcode3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxcode3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxallow3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxallow3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxcode4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxcode4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxallow4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxallow4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxcode5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxcode5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxallow5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxallow5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxcode6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxcode6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxallow6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxallow6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxcode7', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxcode7 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxallow7', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxallow7 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxcode8', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxcode8 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxallow8', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxallow8 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxcode9', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxcode9 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : ArPaymentTableMap::translateFieldName('Arcdtaxallow9', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdtaxallow9 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : ArPaymentTableMap::translateFieldName('Arcdwriteoff', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdwriteoff = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : ArPaymentTableMap::translateFieldName('Arcdwriteoffreas', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdwriteoffreas = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : ArPaymentTableMap::translateFieldName('Arcdcomrate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdcomrate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : ArPaymentTableMap::translateFieldName('Arcdsalesamt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdsalesamt = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : ArPaymentTableMap::translateFieldName('Arcdpaydate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdpaydate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : ArPaymentTableMap::translateFieldName('Arcdglpd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdglpd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : ArPaymentTableMap::translateFieldName('Arcdref', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arcdref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : ArPaymentTableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : ArPaymentTableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : ArPaymentTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 44; // 44 = ArPaymentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ArPayment'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildArPaymentQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ArPayment::setDeleted()
     * @see ArPayment::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildArPaymentQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ArPaymentTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCUCUSTID)) {
            $modifiedColumns[':p' . $index++]  = 'ArcuCustId';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDINVNBR)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdInvNbr';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDINVSEQ)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdInvSeq';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDPAID)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdPaid';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDINVDATE)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdInvDate';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDDUEDATE)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdDueDate';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDCHKNBR)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdChkNbr';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDAMTDUE)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdAmtDue';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDAMTPAID)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdAmtPaid';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDDISCPAID)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdDiscPaid';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDCASHACCT)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdCashAcct';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDCREDACCT)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdCredAcct';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTERMCODE)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTermCode';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDFRTALLOW)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdFrtAllow';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDCUSTPO)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdCustPo';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDORDRNBR)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdOrdrNbr';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE1)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxCode1';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW1)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxAllow1';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE2)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxCode2';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW2)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxAllow2';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE3)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxCode3';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW3)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxAllow3';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE4)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxCode4';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW4)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxAllow4';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE5)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxCode5';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW5)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxAllow5';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE6)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxCode6';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW6)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxAllow6';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE7)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxCode7';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW7)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxAllow7';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE8)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxCode8';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW8)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxAllow8';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE9)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxCode9';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW9)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdTaxAllow9';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDWRITEOFF)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdWriteOff';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDWRITEOFFREAS)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdWriteOffReas';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDCOMRATE)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdComRate';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDSALESAMT)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdSalesAmt';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDPAYDATE)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdPayDate';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDGLPD)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdGlPd';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDREF)) {
            $modifiedColumns[':p' . $index++]  = 'ArcdRef';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_DATEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'DateUpdtd';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_DUMMY)) {
    ...
    {
        $pos = ArPaymentTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ArPayment'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ArPayment'][$this->hashCode()] = true;
        $keys = ArPaymentTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCUCUSTID)) {
            $criteria->add(ArPaymentTableMap::COL_ARCUCUSTID, $this->arcucustid);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDINVNBR)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDINVNBR, $this->arcdinvnbr);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDINVSEQ)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDINVSEQ, $this->arcdinvseq);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDPAID)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDPAID, $this->arcdpaid);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDINVDATE)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDINVDATE, $this->arcdinvdate);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDDUEDATE)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDDUEDATE, $this->arcdduedate);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDCHKNBR)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDCHKNBR, $this->arcdchknbr);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDAMTDUE)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDAMTDUE, $this->arcdamtdue);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDAMTPAID)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDAMTPAID, $this->arcdamtpaid);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDDISCPAID)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDDISCPAID, $this->arcddiscpaid);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDCASHACCT)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDCASHACCT, $this->arcdcashacct);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDCREDACCT)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDCREDACCT, $this->arcdcredacct);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTERMCODE)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTERMCODE, $this->arcdtermcode);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDFRTALLOW)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDFRTALLOW, $this->arcdfrtallow);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDCUSTPO)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDCUSTPO, $this->arcdcustpo);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDORDRNBR)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDORDRNBR, $this->arcdordrnbr);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE1)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXCODE1, $this->arcdtaxcode1);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW1)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXALLOW1, $this->arcdtaxallow1);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE2)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXCODE2, $this->arcdtaxcode2);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW2)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXALLOW2, $this->arcdtaxallow2);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE3)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXCODE3, $this->arcdtaxcode3);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW3)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXALLOW3, $this->arcdtaxallow3);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE4)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXCODE4, $this->arcdtaxcode4);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW4)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXALLOW4, $this->arcdtaxallow4);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE5)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXCODE5, $this->arcdtaxcode5);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW5)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXALLOW5, $this->arcdtaxallow5);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE6)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXCODE6, $this->arcdtaxcode6);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW6)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXALLOW6, $this->arcdtaxallow6);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE7)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXCODE7, $this->arcdtaxcode7);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW7)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXALLOW7, $this->arcdtaxallow7);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE8)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXCODE8, $this->arcdtaxcode8);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW8)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXALLOW8, $this->arcdtaxallow8);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXCODE9)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXCODE9, $this->arcdtaxcode9);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDTAXALLOW9)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDTAXALLOW9, $this->arcdtaxallow9);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDWRITEOFF)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDWRITEOFF, $this->arcdwriteoff);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDWRITEOFFREAS)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDWRITEOFFREAS, $this->arcdwriteoffreas);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDCOMRATE)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDCOMRATE, $this->arcdcomrate);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDSALESAMT)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDSALESAMT, $this->arcdsalesamt);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDPAYDATE)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDPAYDATE, $this->arcdpaydate);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDGLPD)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDGLPD, $this->arcdglpd);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_ARCDREF)) {
            $criteria->add(ArPaymentTableMap::COL_ARCDREF, $this->arcdref);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_DATEUPDTD)) {
            $criteria->add(ArPaymentTableMap::COL_DATEUPDTD, $this->dateupdtd);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_TIMEUPDTD)) {
            $criteria->add(ArPaymentTableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(ArPaymentTableMap::COL_DUMMY)) {
            $criteria->add(ArPaymentTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildArPaymentQuery::create();
        $criteria->add(ArPaymentTableMap::COL_ARCUCUSTID, $this->arcucustid);
        $criteria->add(ArPaymentTableMap::COL_ARCDINVNBR, $this->arcdinvnbr);
        $criteria->add(ArPaymentTableMap::COL_ARCDINVSEQ, $this->arcdinvseq);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ArPayment (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ArPayment Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCustomer(ConnectionInterface $con = null)
    {
        if ($this->aCustomer === null && (($this->arcucustid !== "" && $this->arcucustid !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCustomer->addArPayments($this);
             */
        }
    ...
    {
        if (null !== $this->aCustomer) {
            $this->aCustomer->removeArPayment($this);
        }
    ...
    {
        return (string) $this->exportTo(ArPaymentTableMap::DEFAULT_STRING_FORMAT);
    }
