...
abstract class WarehouseBin implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\WarehouseBinTableMap';
     ...
     *
     * @param ChildInvBinAreaCode|null $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildInvBinAreaCode|null The associated ChildInvBinAreaCode object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
