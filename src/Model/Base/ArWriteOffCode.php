...
/**
 * Base class that represents a row from the 'ar_cust_woff' table.
 *
 *
 *
...
abstract class ArWriteOffCode implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\ArWriteOffCodeTableMap';
    ...
    /**
     * The value for the artbwoffcode field.
     *
     * Note: this column has a database default value of: ''
     * @var        string
     */
    protected $artbwoffcode;

    /**
     * The value for the artbwoffdesc field.
     *
     * @var        string|null
     */
    ...
    /**
     * Get the [artbwoffcode] column value.
     *
     * @return string
     */
    public function getArtbwoffcode()
    {
        return $this->artbwoffcode;
    }

    /**
     * Get the [artbwoffdesc] column value.
     *
     * @return string|null
     */
    public function getArtbwoffdesc()
    {
        return $this->artbwoffdesc;
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO ar_cust_woff (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'ArtbWoffCode':
                        $stmt->bindValue($identifier, $this->artbwoffcode, PDO::PARAM_STR);
    ...
    {
        $validPk = null !== $this->getArtbwoffcode();
    ...
    /**
     * Generic method to set the primary key (artbwoffcode column).
     *
    ...
    {
        return null === $this->getArtbwoffcode();
    }
