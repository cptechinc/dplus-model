...
/**
 * Base class that represents a row from the 'sys_login_role' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class SysLoginRole implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SysLoginRoleTableMap';
    ...
    /**
     * The value for the qtblrolecode field.
     *
     * @var        string
     */
    protected $qtblrolecode;

    /**
     * The value for the qtblroledesc field.
     *
     * @var        string
     */
    protected $qtblroledesc;
    ...
    /**
     * Initializes internal state of Base\SysLoginRole object.
     */
    ...
    /**
     * Compares this with another <code>SysLoginRole</code> instance.  If
     * <code>obj</code> is an instance of <code>SysLoginRole</code>, delegates to
     * <code>equals(SysLoginRole)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SysLoginRole The current object, for fluid interface
     */
    ...
    /**
     * Get the [qtblrolecode] column value.
     *
     * @return string
     */
    public function getQtblrolecode()
    {
        return $this->qtblrolecode;
    }

    /**
     * Get the [qtblroledesc] column value.
     *
     * @return string
     */
    public function getQtblroledesc()
    {
        return $this->qtblroledesc;
    }
    ...
    /**
     * Set the value of [qtblrolecode] column.
     *
     * @param string $v new value
     * @return $this|\SysLoginRole The current object (for fluent API support)
     */
    public function setQtblrolecode($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->qtblrolecode !== $v) {
            $this->qtblrolecode = $v;
            $this->modifiedColumns[SysLoginRoleTableMap::COL_QTBLROLECODE] = true;
        }
    ...
    /**
     * Set the value of [qtblroledesc] column.
     *
     * @param string $v new value
     * @return $this|\SysLoginRole The current object (for fluent API support)
     */
    public function setQtblroledesc($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->qtblroledesc !== $v) {
            $this->qtblroledesc = $v;
            $this->modifiedColumns[SysLoginRoleTableMap::COL_QTBLROLEDESC] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[SysLoginRoleTableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[SysLoginRoleTableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[SysLoginRoleTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SysLoginRoleTableMap::translateFieldName('Qtblrolecode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qtblrolecode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SysLoginRoleTableMap::translateFieldName('Qtblroledesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qtblroledesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SysLoginRoleTableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SysLoginRoleTableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SysLoginRoleTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = SysLoginRoleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\SysLoginRole'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSysLoginRoleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SysLoginRole::setDeleted()
     * @see SysLoginRole::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSysLoginRoleQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SysLoginRoleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SysLoginRoleTableMap::COL_QTBLROLECODE)) {
            $modifiedColumns[':p' . $index++]  = 'QtblRoleCode';
        }
        if ($this->isColumnModified(SysLoginRoleTableMap::COL_QTBLROLEDESC)) {
            $modifiedColumns[':p' . $index++]  = 'QtblRoleDesc';
        }
        if ($this->isColumnModified(SysLoginRoleTableMap::COL_DATEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'DateUpdtd';
        }
        if ($this->isColumnModified(SysLoginRoleTableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(SysLoginRoleTableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'dummy';
        }

        $sql = sprintf(
            'INSERT INTO sys_login_role (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'QtblRoleCode':
                        $stmt->bindValue($identifier, $this->qtblrolecode, PDO::PARAM_STR);
                        break;
                    case 'QtblRoleDesc':
                        $stmt->bindValue($identifier, $this->qtblroledesc, PDO::PARAM_STR);
                        break;
                    case 'DateUpdtd':
    ...
    {
        $pos = SysLoginRoleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getQtblrolecode();
                break;
            case 1:
                return $this->getQtblroledesc();
                break;
            case 2:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SysLoginRole'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SysLoginRole'][$this->hashCode()] = true;
        $keys = SysLoginRoleTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getQtblrolecode(),
            $keys[1] => $this->getQtblroledesc(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setQtblrolecode($value);
                break;
            case 1:
                $this->setQtblroledesc($value);
                break;
            case 2:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setQtblrolecode($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setQtblroledesc($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SysLoginRoleTableMap::COL_QTBLROLECODE)) {
            $criteria->add(SysLoginRoleTableMap::COL_QTBLROLECODE, $this->qtblrolecode);
        }
        if ($this->isColumnModified(SysLoginRoleTableMap::COL_QTBLROLEDESC)) {
            $criteria->add(SysLoginRoleTableMap::COL_QTBLROLEDESC, $this->qtblroledesc);
        }
        if ($this->isColumnModified(SysLoginRoleTableMap::COL_DATEUPDTD)) {
            $criteria->add(SysLoginRoleTableMap::COL_DATEUPDTD, $this->dateupdtd);
        }
        if ($this->isColumnModified(SysLoginRoleTableMap::COL_TIMEUPDTD)) {
            $criteria->add(SysLoginRoleTableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(SysLoginRoleTableMap::COL_DUMMY)) {
            $criteria->add(SysLoginRoleTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildSysLoginRoleQuery::create();
        $criteria->add(SysLoginRoleTableMap::COL_QTBLROLECODE, $this->qtblrolecode);
    ...
    {
        $validPk = null !== $this->getQtblrolecode();
    ...
    /**
     * Generic method to set the primary key (qtblrolecode column).
     *
    ...
    {
        return null === $this->getQtblrolecode();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SysLoginRole (or compatible) type.
    ...
    {
        $copyObj->setQtblrolecode($this->getQtblrolecode());
        $copyObj->setQtblroledesc($this->getQtblroledesc());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SysLoginRole Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildSysLoginRole is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSysLoginRole The current object (for fluent API support)
     */
    public function setDplusUsers(Collection $dplusUsers, ConnectionInterface $con = null)
    {
        ...
        foreach ($dplusUsersToDelete as $dplusUserRemoved) {
            $dplusUserRemoved->setSysLoginRole(null);
        }
    ...
    protected function doAddDplusUser(ChildDplusUser $dplusUser)
    {
        ...
        $dplusUser->setSysLoginRole($this);
    }
    ...
    public function removeDplusUser(ChildDplusUser $dplusUser)
    {
        if ($this->getDplusUsers()->contains($dplusUser)) {
            ...
            $dplusUser->setSysLoginRole(null);
        }
     ...
     * Otherwise if this SysLoginRole is new, it will return
     * an empty collection; or if this SysLoginRole has previously
     * been saved, it will retrieve related DplusUsers from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SysLoginRole.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildDplusUser[] List of ChildDplusUser objects
     */
    public function getDplusUsersJoinSysLoginGroup(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildDplusUserQuery::create(null, $criteria);
        $query->joinWith('SysLoginGroup', $joinBehavior);
    ...
    {
        $this->qtblrolecode = null;
        $this->qtblroledesc = null;
        $this->dateupdtd = null;
        $this->timeupdtd = null;
        $this->dummy = null;
        $this->alreadyInSave = false;
    ...
    {
        return (string) $this->exportTo(SysLoginRoleTableMap::DEFAULT_STRING_FORMAT);
    }
