...
/**
 * Base class that represents a row from the 'ar_cust_cusr' table.
 *
 *
 *
...
abstract class ArCustUserCode implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\ArCustUserCodeTableMap';
    ...
    /**
     * The value for the artbcusrcode field.
     *
     * Note: this column has a database default value of: ''
     * @var        string
     */
    protected $artbcusrcode;

    /**
     * The value for the artbcusrdesc field.
     *
     * @var        string|null
     */
    protected $artbcusrdesc;
    ...
    /**
     * Get the [artbcusrcode] column value.
     *
     * @return string
     */
    public function getArtbcusrcode()
    {
        return $this->artbcusrcode;
    }

    /**
     * Get the [artbcusrdesc] column value.
     *
     * @return string|null
     */
    public function getArtbcusrdesc()
    {
        return $this->artbcusrdesc;
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO ar_cust_cusr (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'ArtbCusrCode':
                        $stmt->bindValue($identifier, $this->artbcusrcode, PDO::PARAM_STR);

                        break;
                    case 'ArtbCusrDesc':
                        $stmt->bindValue($identifier, $this->artbcusrdesc, PDO::PARAM_STR);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            case 0:
                return $this->getArtbcusrcode();

            case 1:
                return $this->getArtbcusrdesc();
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setArtbcusrcode($value);
                break;
            case 1:
                $this->setArtbcusrdesc($value);
                break;
            case 2:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setArtbcusrdesc($arr[$keys[1]]);
        }
    ...
    {
        $validPk = null !== $this->getArtbcusrcode();
    ...
    /**
     * Generic method to set the primary key (artbcusrcode column).
     *
    ...
    {
        return null === $this->getArtbcusrcode();
    }
    ...
    {
        $copyObj->setArtbcusrcode($this->getArtbcusrcode());
        $copyObj->setArtbcusrdesc($this->getArtbcusrdesc());
    ...
    {
        $this->artbcusrcode = null;
        $this->artbcusrdesc = null;
        $this->dateupdtd = null;
        $this->timeupdtd = null;
        $this->dummy = null;
        $this->alreadyInSave = false;
