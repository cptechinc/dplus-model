 ...
 */
abstract class InvKitComponent implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InvKitComponentTableMap';
    ...
    /**
     * Initializes internal state of Base\InvKitComponent object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>InvKitComponent</code> instance.  If
     * <code>obj</code> is an instance of <code>InvKitComponent</code>, delegates to
     * <code>equals(InvKitComponent)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|InvKitComponent The current object, for fluid interface
     */
    ...
    public function setKtdtkey1($v)
    {
        ...
        if ($this->ktdtkey1 !== $v) {
            $this->ktdtkey1 = $v;
            $this->modifiedColumns[InvKitComponentTableMap::COL_KTDTKEY1] = true;
        }

        if ($this->aInvKit !== null && $this->aInvKit->getInititemnbr() !== $v) {
            $this->aInvKit = null;
        }
    ...
    public function setInititemnbr($v)
    {
        ...
        if ($this->inititemnbr !== $v) {
            $this->inititemnbr = $v;
            $this->modifiedColumns[InvKitComponentTableMap::COL_INITITEMNBR] = true;
        }
    ...
    public function setKtdtuom($v)
    {
        ...
        if ($this->ktdtuom !== $v) {
            $this->ktdtuom = $v;
            $this->modifiedColumns[InvKitComponentTableMap::COL_KTDTUOM] = true;
        }
    ...
    public function setKtdtusagrate($v)
    {
        ...
        if ($this->ktdtusagrate !== $v) {
            $this->ktdtusagrate = $v;
            $this->modifiedColumns[InvKitComponentTableMap::COL_KTDTUSAGRATE] = true;
        }
    ...
    public function setKtdtvendsupply($v)
    {
        ...
        if ($this->ktdtvendsupply !== $v) {
            ...
            $this->modifiedColumns[InvKitComponentTableMap::COL_KTDTVENDSUPPLY] = true;
        }
    ...
    public function setKtdtfreegoods($v)
    {
        ...
        if ($this->ktdtfreegoods !== $v) {
            ...
            $this->modifiedColumns[InvKitComponentTableMap::COL_KTDTFREEGOODS] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[InvKitComponentTableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[InvKitComponentTableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[InvKitComponentTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InvKitComponentTableMap::translateFieldName('Ktdtkey1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ktdtkey1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InvKitComponentTableMap::translateFieldName('Inititemnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inititemnbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InvKitComponentTableMap::translateFieldName('Ktdtuom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ktdtuom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : InvKitComponentTableMap::translateFieldName('Ktdtusagrate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ktdtusagrate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : InvKitComponentTableMap::translateFieldName('Ktdtvendsupply', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : InvKitComponentTableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : InvKitComponentTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 10; // 10 = InvKitComponentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\InvKitComponent'), 0, $e);
        }
    }
    ...
    {
        if ($this->aInvKit !== null && $this->ktdtkey1 !== $this->aInvKit->getInititemnbr()) {
            $this->aInvKit = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInvKitComponentQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see InvKitComponent::setDeleted()
     * @see InvKitComponent::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildInvKitComponentQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InvKitComponentTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aInvKit !== null) {
                if ($this->aInvKit->isModified() || $this->aInvKit->isNew()) {
                    $affectedRows += $this->aInvKit->save($con);
                }
                $this->setInvKit($this->aInvKit);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InvKitComponentTableMap::COL_KTDTKEY1)) {
            $modifiedColumns[':p' . $index++]  = 'KtdtKey1';
        }
        if ($this->isColumnModified(InvKitComponentTableMap::COL_INITITEMNBR)) {
            $modifiedColumns[':p' . $index++]  = 'InitItemNbr';
        }
        if ($this->isColumnModified(InvKitComponentTableMap::COL_KTDTUOM)) {
            $modifiedColumns[':p' . $index++]  = 'KtdtUom';
        }
        if ($this->isColumnModified(InvKitComponentTableMap::COL_KTDTUSAGRATE)) {
            $modifiedColumns[':p' . $index++]  = 'KtdtUsagRate';
        }
        if ($this->isColumnModified(InvKitComponentTableMap::COL_KTDTVENDSUPPLY)) {
        ...
        if ($this->isColumnModified(InvKitComponentTableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(InvKitComponentTableMap::COL_DUMMY)) {
    ...
    {
        $pos = InvKitComponentTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['InvKitComponent'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['InvKitComponent'][$this->hashCode()] = true;
        $keys = InvKitComponentTableMap::getFieldNames($keyType);
        $result = array(
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aInvKit) {
                ...
                $result[$key] = $this->aInvKit->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InvKitComponentTableMap::COL_KTDTKEY1)) {
            $criteria->add(InvKitComponentTableMap::COL_KTDTKEY1, $this->ktdtkey1);
        }
        if ($this->isColumnModified(InvKitComponentTableMap::COL_INITITEMNBR)) {
            $criteria->add(InvKitComponentTableMap::COL_INITITEMNBR, $this->inititemnbr);
        }
        if ($this->isColumnModified(InvKitComponentTableMap::COL_KTDTUOM)) {
            $criteria->add(InvKitComponentTableMap::COL_KTDTUOM, $this->ktdtuom);
        }
        if ($this->isColumnModified(InvKitComponentTableMap::COL_KTDTUSAGRATE)) {
            $criteria->add(InvKitComponentTableMap::COL_KTDTUSAGRATE, $this->ktdtusagrate);
        }
        if ($this->isColumnModified(InvKitComponentTableMap::COL_KTDTVENDSUPPLY)) {
            $criteria->add(InvKitComponentTableMap::COL_KTDTVENDSUPPLY, $this->ktdtvendsupply);
        }
        if ($this->isColumnModified(InvKitComponentTableMap::COL_KTDTFREEGOODS)) {
        ...
        if ($this->isColumnModified(InvKitComponentTableMap::COL_TIMEUPDTD)) {
            $criteria->add(InvKitComponentTableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(InvKitComponentTableMap::COL_DUMMY)) {
            $criteria->add(InvKitComponentTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildInvKitComponentQuery::create();
        $criteria->add(InvKitComponentTableMap::COL_KTDTKEY1, $this->ktdtkey1);
        $criteria->add(InvKitComponentTableMap::COL_INITITEMNBR, $this->inititemnbr);
    ...
    public function hashCode()
    {
        ...
        //relation head to table inv_kit_head
        if ($this->aInvKit && $hash = spl_object_hash($this->aInvKit)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InvKitComponent (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InvKitComponent Clone of current object.
     * @throws PropelException
     */
    ...
    public function getItemMasterItem(ConnectionInterface $con = null)
    {
        if ($this->aItemMasterItem === null && (($this->inititemnbr !== "" && $this->inititemnbr !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aItemMasterItem->addInvKitComponents($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a ChildInvKit object.
     *
     * @param  ChildInvKit $v
     * @return $this|\InvKitComponent The current object (for fluent API support)
     * @throws PropelException
    ...
    public function setInvKit(ChildInvKit $v = null)
    {
        if ($v === null) {
            ...
            $this->setKtdtkey1($v->getInititemnbr());
        }

        $this->aInvKit = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildInvKit object, it will not be re-added.
        if ($v !== null) {
            $v->addInvKitComponent($this);
        }
    ...
    /**
     * Get the associated ChildInvKit object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildInvKit The associated ChildInvKit object.
     * @throws PropelException
     */
    public function getInvKit(ConnectionInterface $con = null)
    {
        if ($this->aInvKit === null && (($this->ktdtkey1 !== "" && $this->ktdtkey1 !== null))) {
            $this->aInvKit = ChildInvKitQuery::create()->findPk($this->ktdtkey1, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aInvKit->addInvKitComponents($this);
             */
        }
    ...
    {
        if (null !== $this->aItemMasterItem) {
            $this->aItemMasterItem->removeInvKitComponent($this);
        }
        if (null !== $this->aInvKit) {
            $this->aInvKit->removeInvKitComponent($this);
        }
        $this->ktdtkey1 = null;
    ...
    {
        return (string) $this->exportTo(InvKitComponentTableMap::DEFAULT_STRING_FORMAT);
    }
