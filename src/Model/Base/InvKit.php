...
/**
 * Base class that represents a row from the 'inv_kit_head' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class InvKit implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InvKitTableMap';
    ...
    /**
     * Initializes internal state of Base\InvKit object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>InvKit</code> instance.  If
     * <code>obj</code> is an instance of <code>InvKit</code>, delegates to
     * <code>equals(InvKit)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|InvKit The current object, for fluid interface
     */
     ...
     * @return $this|\InvKit The current object (for fluent API support)
     */
    public function setInititemnbr($v)
    {
        ...
        if ($this->inititemnbr !== $v) {
            $this->inititemnbr = $v;
            $this->modifiedColumns[InvKitTableMap::COL_INITITEMNBR] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[InvKitTableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[InvKitTableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[InvKitTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InvKitTableMap::translateFieldName('Inititemnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inititemnbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InvKitTableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InvKitTableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : InvKitTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = InvKitTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\InvKit'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInvKitQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see InvKit::setDeleted()
     * @see InvKit::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildInvKitQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InvKitTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InvKitTableMap::COL_INITITEMNBR)) {
            $modifiedColumns[':p' . $index++]  = 'InitItemNbr';
        }
        if ($this->isColumnModified(InvKitTableMap::COL_DATEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'DateUpdtd';
        }
        if ($this->isColumnModified(InvKitTableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(InvKitTableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'dummy';
        }

        $sql = sprintf(
            'INSERT INTO inv_kit_head (%s) VALUES (%s)',
    ...
    {
        $pos = InvKitTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['InvKit'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['InvKit'][$this->hashCode()] = true;
        $keys = InvKitTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getInititemnbr(),
            $keys[1] => $this->getDateupdtd(),
            $keys[2] => $this->getTimeupdtd(),
            $keys[3] => $this->getDummy(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setDateupdtd($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setTimeupdtd($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setDummy($arr[$keys[3]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InvKitTableMap::COL_INITITEMNBR)) {
            $criteria->add(InvKitTableMap::COL_INITITEMNBR, $this->inititemnbr);
        }
        if ($this->isColumnModified(InvKitTableMap::COL_DATEUPDTD)) {
            $criteria->add(InvKitTableMap::COL_DATEUPDTD, $this->dateupdtd);
        }
        if ($this->isColumnModified(InvKitTableMap::COL_TIMEUPDTD)) {
            $criteria->add(InvKitTableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(InvKitTableMap::COL_DUMMY)) {
            $criteria->add(InvKitTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildInvKitQuery::create();
        $criteria->add(InvKitTableMap::COL_INITITEMNBR, $this->inititemnbr);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InvKit (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InvKit Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildInvKit is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildInvKit The current object (for fluent API support)
     */
    public function setInvKitComponents(Collection $invKitComponents, ConnectionInterface $con = null)
    {
        ...
        foreach ($invKitComponentsToDelete as $invKitComponentRemoved) {
            $invKitComponentRemoved->setInvKit(null);
        }
    ...
    protected function doAddInvKitComponent(ChildInvKitComponent $invKitComponent)
    {
        ...
        $invKitComponent->setInvKit($this);
    }
    ...
    public function removeInvKitComponent(ChildInvKitComponent $invKitComponent)
    {
        if ($this->getInvKitComponents()->contains($invKitComponent)) {
            ...
            $invKitComponent->setInvKit(null);
        }
     ...
     * Otherwise if this InvKit is new, it will return
     * an empty collection; or if this InvKit has previously
     * been saved, it will retrieve related InvKitComponents from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in InvKit.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildInvKitComponent[] List of ChildInvKitComponent objects
     */
    public function getInvKitComponentsJoinItemMasterItem(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildInvKitComponentQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aItemMasterItem) {
            $this->aItemMasterItem->removeInvKit($this);
        }
    ...
    {
        return (string) $this->exportTo(InvKitTableMap::DEFAULT_STRING_FORMAT);
    }
