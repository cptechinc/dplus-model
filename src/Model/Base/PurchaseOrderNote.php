...
/**
 * Base class that represents a row from the 'notes_po_head_det' table.
 *
 *
 *
...
abstract class PurchaseOrderNote implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\PurchaseOrderNoteTableMap';
    ...
    /**
     * The value for the pontpordeditorview field.
     *
     * @var        string|null
     */
    protected $pontpordeditorview;
    ...
    /**
     * Get the [pontpordeditorview] column value.
     *
     * @return string|null
     */
    public function getPontpordeditorview()
    {
        return $this->pontpordeditorview;
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO notes_po_head_det (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'PodtLine':
                        ...
                        break;
                    case 'PontPordEditOrView':
                        $stmt->bindValue($identifier, $this->pontpordeditorview, PDO::PARAM_STR);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 4:
                return $this->getPontpordeditorview();
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = []): array
    {
        ...
        $result = [
            ...
            $keys[4] => $this->getPontpordeditorview(),
            $keys[5] => $this->getPontform(),
            $keys[6] => $this->getPontseq(),
            $keys[7] => $this->getPontnote(),
            $keys[8] => $this->getPontkey2(),
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                $this->setPontpordeditorview($value);
                break;
            case 5:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setPontpordeditorview($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setPontform($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setPontseq($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setPontnote($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setPontkey2($arr[$keys[8]]);
        }
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setPontpordeditorview($this->getPontpordeditorview());
