 ...
 */
abstract class SalesOrderNotes implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SalesOrderNotesTableMap';
    ...
    /**
     * Initializes internal state of Base\SalesOrderNotes object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>SalesOrderNotes</code> instance.  If
     * <code>obj</code> is an instance of <code>SalesOrderNotes</code>, delegates to
     * <code>equals(SalesOrderNotes)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SalesOrderNotes The current object, for fluid interface
     */
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[SalesOrderNotesTableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[SalesOrderNotesTableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[SalesOrderNotesTableMap::COL_DUMMY] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSalesOrderNotesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SalesOrderNotes::setDeleted()
     * @see SalesOrderNotes::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSalesOrderNotesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SalesOrderNotesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SalesOrderNotesTableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(SalesOrderNotesTableMap::COL_DUMMY)) {
    ...
    {
        $pos = SalesOrderNotesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['SalesOrderNotes'][$this->hashCode()])) {
            return '*RECURSION*';
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SalesOrderNotesTableMap::COL_TIMEUPDTD)) {
            $criteria->add(SalesOrderNotesTableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(SalesOrderNotesTableMap::COL_DUMMY)) {
            $criteria->add(SalesOrderNotesTableMap::COL_DUMMY, $this->dummy);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SalesOrderNotes (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SalesOrderNotes Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(SalesOrderNotesTableMap::DEFAULT_STRING_FORMAT);
    }
