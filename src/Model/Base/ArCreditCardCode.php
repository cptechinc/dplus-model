...
/**
 * Base class that represents a row from the 'ar_cust_crcd' table.
 *
 *
 *
...
abstract class ArCreditCardCode implements ActiveRecordInterface
{
    ...
    /**
     * The value for the artbcrcdcode field.
     *
     * Note: this column has a database default value of: ''
     * @var        string
     */
    protected $artbcrcdcode;

    /**
     * The value for the artbcrcdname field.
     *
     * @var        string
     */
    protected $artbcrcdname;

    /**
     * The value for the artbcrcdglacct field.
     *
     * @var        string
     */
    protected $artbcrcdglacct;

    /**
     * The value for the artbcrcdcustid field.
     *
     * @var        string
     */
    protected $artbcrcdcustid;

    /**
     * The value for the artbcrcdchrgglacct field.
     *
     * @var        string
     */
    protected $artbcrcdchrgglacct;

    /**
     * The value for the artbcrcdchrgrate field.
     *
     * @var        string
     */
    protected $artbcrcdchrgrate;

    /**
     * The value for the artbcrcdchrgtrancost field.
     *
     * @var        string
     */
    protected $artbcrcdchrgtrancost;

    /**
     * The value for the artbcrcdccsurchgpct field.
     *
     * @var        string
     */
    protected $artbcrcdccsurchgpct;

    /**
     * The value for the artbcrcdlmccsurchgpct field.
     *
     * @var        string
     */
    protected $artbcrcdlmccsurchgpct;
    ...
    /**
     * Get the [artbcrcdcode] column value.
     *
     * @return string
     */
    public function getArtbcrcdcode()
    {
        return $this->artbcrcdcode;
    }

    /**
     * Get the [artbcrcdname] column value.
     *
     * @return string
     */
    public function getArtbcrcdname()
    {
        return $this->artbcrcdname;
    }

    /**
     * Get the [artbcrcdglacct] column value.
     *
     * @return string
     */
    public function getArtbcrcdglacct()
    {
        return $this->artbcrcdglacct;
    }

    /**
     * Get the [artbcrcdcustid] column value.
     *
     * @return string
     */
    public function getArtbcrcdcustid()
    {
        return $this->artbcrcdcustid;
    }

    /**
     * Get the [artbcrcdchrgglacct] column value.
     *
     * @return string
     */
    public function getArtbcrcdchrgglacct()
    {
        return $this->artbcrcdchrgglacct;
    }

    /**
     * Get the [artbcrcdchrgrate] column value.
     *
     * @return string
     */
    public function getArtbcrcdchrgrate()
    {
        return $this->artbcrcdchrgrate;
    }

    /**
     * Get the [artbcrcdchrgtrancost] column value.
     *
     * @return string
     */
    public function getArtbcrcdchrgtrancost()
    {
        return $this->artbcrcdchrgtrancost;
    }

    /**
     * Get the [artbcrcdccsurchgpct] column value.
     *
     * @return string
     */
    public function getArtbcrcdccsurchgpct()
    {
        return $this->artbcrcdccsurchgpct;
    }

    /**
     * Get the [artbcrcdlmccsurchgpct] column value.
     *
     * @return string
     */
    public function getArtbcrcdlmccsurchgpct()
    {
        return $this->artbcrcdlmccsurchgpct;
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO ar_cust_crcd (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'ArtbCrcdCode':
                        $stmt->bindValue($identifier, $this->artbcrcdcode, PDO::PARAM_STR);
                        break;
                    case 'ArtbCrcdName':
                        $stmt->bindValue($identifier, $this->artbcrcdname, PDO::PARAM_STR);
                        break;
                    case 'ArtbCrcdGlAcct':
                        $stmt->bindValue($identifier, $this->artbcrcdglacct, PDO::PARAM_STR);
                        break;
                    case 'ArtbCrcdCustId':
                        $stmt->bindValue($identifier, $this->artbcrcdcustid, PDO::PARAM_STR);
                        break;
                    case 'ArtbCrcdChrgGlAcct':
                        $stmt->bindValue($identifier, $this->artbcrcdchrgglacct, PDO::PARAM_STR);
                        break;
                    case 'ArtbCrcdChrgRate':
                        $stmt->bindValue($identifier, $this->artbcrcdchrgrate, PDO::PARAM_STR);
                        break;
                    case 'ArtbCrcdChrgTranCost':
                        $stmt->bindValue($identifier, $this->artbcrcdchrgtrancost, PDO::PARAM_STR);
                        break;
                    case 'ArtbCrcdCcSurchgPct':
                        $stmt->bindValue($identifier, $this->artbcrcdccsurchgpct, PDO::PARAM_STR);
                        break;
                    case 'ArtbCrcdLmCcSurchgPct':
                        $stmt->bindValue($identifier, $this->artbcrcdlmccsurchgpct, PDO::PARAM_STR);
                        break;
                    case 'DateUpdtd':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getArtbcrcdcode();
                break;
            case 1:
                return $this->getArtbcrcdname();
                break;
            case 2:
                return $this->getArtbcrcdglacct();
                break;
            case 3:
                return $this->getArtbcrcdcustid();
                break;
            case 4:
                return $this->getArtbcrcdchrgglacct();
                break;
            case 5:
                return $this->getArtbcrcdchrgrate();
                break;
            case 6:
                return $this->getArtbcrcdchrgtrancost();
                break;
            case 7:
                return $this->getArtbcrcdccsurchgpct();
                break;
            case 8:
                return $this->getArtbcrcdlmccsurchgpct();
                break;
            case 9:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getArtbcrcdglacct(),
            $keys[3] => $this->getArtbcrcdcustid(),
            $keys[4] => $this->getArtbcrcdchrgglacct(),
            $keys[5] => $this->getArtbcrcdchrgrate(),
            $keys[6] => $this->getArtbcrcdchrgtrancost(),
            $keys[7] => $this->getArtbcrcdccsurchgpct(),
            $keys[8] => $this->getArtbcrcdlmccsurchgpct(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setArtbcrcdcode($value);
                break;
            case 1:
                $this->setArtbcrcdname($value);
                break;
            case 2:
                $this->setArtbcrcdglacct($value);
                break;
            case 3:
                $this->setArtbcrcdcustid($value);
                break;
            case 4:
                $this->setArtbcrcdchrgglacct($value);
                break;
            case 5:
                $this->setArtbcrcdchrgrate($value);
                break;
            case 6:
                $this->setArtbcrcdchrgtrancost($value);
                break;
            case 7:
                $this->setArtbcrcdccsurchgpct($value);
                break;
            case 8:
                $this->setArtbcrcdlmccsurchgpct($value);
                break;
            case 9:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setArtbcrcdname($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setArtbcrcdglacct($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setArtbcrcdcustid($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setArtbcrcdchrgglacct($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setArtbcrcdchrgrate($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setArtbcrcdchrgtrancost($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setArtbcrcdccsurchgpct($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setArtbcrcdlmccsurchgpct($arr[$keys[8]]);
        }
    ...
    {
        $validPk = null !== $this->getArtbcrcdcode();
    ...
    /**
     * Generic method to set the primary key (artbcrcdcode column).
     *
    ...
    {
        return null === $this->getArtbcrcdcode();
    }
    ...
    {
        $copyObj->setArtbcrcdcode($this->getArtbcrcdcode());
        $copyObj->setArtbcrcdname($this->getArtbcrcdname());
        $copyObj->setArtbcrcdglacct($this->getArtbcrcdglacct());
        $copyObj->setArtbcrcdcustid($this->getArtbcrcdcustid());
        $copyObj->setArtbcrcdchrgglacct($this->getArtbcrcdchrgglacct());
        $copyObj->setArtbcrcdchrgrate($this->getArtbcrcdchrgrate());
        $copyObj->setArtbcrcdchrgtrancost($this->getArtbcrcdchrgtrancost());
        $copyObj->setArtbcrcdccsurchgpct($this->getArtbcrcdccsurchgpct());
        $copyObj->setArtbcrcdlmccsurchgpct($this->getArtbcrcdlmccsurchgpct());
    ...
    {
        $this->artbcrcdcode = null;
        $this->artbcrcdname = null;
        $this->artbcrcdglacct = null;
        $this->artbcrcdcustid = null;
        $this->artbcrcdchrgglacct = null;
        $this->artbcrcdchrgrate = null;
        $this->artbcrcdchrgtrancost = null;
        $this->artbcrcdccsurchgpct = null;
        $this->artbcrcdlmccsurchgpct = null;
        $this->dateupdtd = null;
        $this->timeupdtd = null;
        $this->dummy = null;
        $this->alreadyInSave = false;
