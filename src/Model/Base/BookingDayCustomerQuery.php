 ...
 *
 * @method     ChildBookingDayCustomer|null findOne(?ConnectionInterface $con = null) Return the first ChildBookingDayCustomer matching the query
 ...
 *
 * @method     ChildBookingDayCustomer|null findOneByArcucustid(string $ArcuCustId) Return the first ChildBookingDayCustomer filtered by the ArcuCustId column
 * @method     ChildBookingDayCustomer|null findOneByArstshipid(string $ArstShipId) Return the first ChildBookingDayCustomer filtered by the ArstShipId column
 * @method     ChildBookingDayCustomer|null findOneByBkgcdate(string $BkgcDate) Return the first ChildBookingDayCustomer filtered by the BkgcDate column
 * @method     ChildBookingDayCustomer|null findOneByArspsaleper1(string $ArspSalePer1) Return the first ChildBookingDayCustomer filtered by the ArspSalePer1 column
 * @method     ChildBookingDayCustomer|null findOneByBkgcnetamt(string $BkgcNetAmt) Return the first ChildBookingDayCustomer filtered by the BkgcNetAmt column
 * @method     ChildBookingDayCustomer|null findOneByDateupdtd(string $DateUpdtd) Return the first ChildBookingDayCustomer filtered by the DateUpdtd column
 * @method     ChildBookingDayCustomer|null findOneByTimeupdtd(string $TimeUpdtd) Return the first ChildBookingDayCustomer filtered by the TimeUpdtd column
 * @method     ChildBookingDayCustomer|null findOneByDummy(string $dummy) Return the first ChildBookingDayCustomer filtered by the dummy column
 *
 ...
 *
 * @method     ChildBookingDayCustomer[]|Collection find(?ConnectionInterface $con = null) Return ChildBookingDayCustomer objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildBookingDayCustomer> find(?ConnectionInterface $con = null) Return ChildBookingDayCustomer objects based on current ModelCriteria
 *
 * @method     ChildBookingDayCustomer[]|Collection findByArcucustid(string|array<string> $ArcuCustId) Return ChildBookingDayCustomer objects filtered by the ArcuCustId column
 * @psalm-method Collection&\Traversable<ChildBookingDayCustomer> findByArcucustid(string|array<string> $ArcuCustId) Return ChildBookingDayCustomer objects filtered by the ArcuCustId column
 * @method     ChildBookingDayCustomer[]|Collection findByArstshipid(string|array<string> $ArstShipId) Return ChildBookingDayCustomer objects filtered by the ArstShipId column
 * @psalm-method Collection&\Traversable<ChildBookingDayCustomer> findByArstshipid(string|array<string> $ArstShipId) Return ChildBookingDayCustomer objects filtered by the ArstShipId column
 * @method     ChildBookingDayCustomer[]|Collection findByBkgcdate(string|array<string> $BkgcDate) Return ChildBookingDayCustomer objects filtered by the BkgcDate column
 * @psalm-method Collection&\Traversable<ChildBookingDayCustomer> findByBkgcdate(string|array<string> $BkgcDate) Return ChildBookingDayCustomer objects filtered by the BkgcDate column
 * @method     ChildBookingDayCustomer[]|Collection findByArspsaleper1(string|array<string> $ArspSalePer1) Return ChildBookingDayCustomer objects filtered by the ArspSalePer1 column
 * @psalm-method Collection&\Traversable<ChildBookingDayCustomer> findByArspsaleper1(string|array<string> $ArspSalePer1) Return ChildBookingDayCustomer objects filtered by the ArspSalePer1 column
 * @method     ChildBookingDayCustomer[]|Collection findByBkgcnetamt(string|array<string> $BkgcNetAmt) Return ChildBookingDayCustomer objects filtered by the BkgcNetAmt column
 * @psalm-method Collection&\Traversable<ChildBookingDayCustomer> findByBkgcnetamt(string|array<string> $BkgcNetAmt) Return ChildBookingDayCustomer objects filtered by the BkgcNetAmt column
 * @method     ChildBookingDayCustomer[]|Collection findByDateupdtd(string|array<string> $DateUpdtd) Return ChildBookingDayCustomer objects filtered by the DateUpdtd column
 * @psalm-method Collection&\Traversable<ChildBookingDayCustomer> findByDateupdtd(string|array<string> $DateUpdtd) Return ChildBookingDayCustomer objects filtered by the DateUpdtd column
 * @method     ChildBookingDayCustomer[]|Collection findByTimeupdtd(string|array<string> $TimeUpdtd) Return ChildBookingDayCustomer objects filtered by the TimeUpdtd column
 * @psalm-method Collection&\Traversable<ChildBookingDayCustomer> findByTimeupdtd(string|array<string> $TimeUpdtd) Return ChildBookingDayCustomer objects filtered by the TimeUpdtd column
 * @method     ChildBookingDayCustomer[]|Collection findByDummy(string|array<string> $dummy) Return ChildBookingDayCustomer objects filtered by the dummy column
 * @psalm-method Collection&\Traversable<ChildBookingDayCustomer> findByDummy(string|array<string> $dummy) Return ChildBookingDayCustomer objects filtered by the dummy column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildBookingDayCustomer> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class BookingDayCustomerQuery extends ModelCriteria
{
    ...
    public function filterByArcucustid($arcucustid = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookingDayCustomerTableMap::COL_ARCUCUSTID, $arcucustid, $comparison);
    ...
    public function filterByArstshipid($arstshipid = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookingDayCustomerTableMap::COL_ARSTSHIPID, $arstshipid, $comparison);
     ...
     * $query->filterByBkgcdate(['foo', 'bar']); // WHERE BkgcDate IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $bkgcdate The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByBkgcdate($bkgcdate = null, ?string $comparison = null)
    {
        if (null === $comparison) {
        ...
        $this->addUsingAlias(BookingDayCustomerTableMap::COL_BKGCDATE, $bkgcdate, $comparison);
    ...
    public function filterByArspsaleper1($arspsaleper1 = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookingDayCustomerTableMap::COL_ARSPSALEPER1, $arspsaleper1, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByBkgcnetamt($bkgcnetamt = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookingDayCustomerTableMap::COL_BKGCNETAMT, $bkgcnetamt, $comparison);
    ...
    public function filterByDateupdtd($dateupdtd = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookingDayCustomerTableMap::COL_DATEUPDTD, $dateupdtd, $comparison);
    ...
    public function filterByTimeupdtd($timeupdtd = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookingDayCustomerTableMap::COL_TIMEUPDTD, $timeupdtd, $comparison);
    ...
    public function filterByDummy($dummy = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookingDayCustomerTableMap::COL_DUMMY, $dummy, $comparison);
