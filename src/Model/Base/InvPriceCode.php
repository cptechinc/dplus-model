...
/**
 * Base class that represents a row from the 'inv_pric_code' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class InvPriceCode implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InvPriceCodeTableMap';
    ...
    /**
     * The value for the intbpricdesc field.
     *
     * @var        string
     */
    protected $intbpricdesc;

    /**
     * The value for the intbpricsaleprog field.
     *
     * @var        string
     */
    protected $intbpricsaleprog;

    /**
     * The value for the intbpriccostpct field.
     *
     * @var        string
     */
    protected $intbpriccostpct;
    ...
    /**
     * Initializes internal state of Base\InvPriceCode object.
     */
    ...
    /**
     * Compares this with another <code>InvPriceCode</code> instance.  If
     * <code>obj</code> is an instance of <code>InvPriceCode</code>, delegates to
     * <code>equals(InvPriceCode)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|InvPriceCode The current object, for fluid interface
     */
    ...
    /**
     * Get the [intbpricdesc] column value.
     *
     * @return string
     */
    public function getIntbpricdesc()
    {
        return $this->intbpricdesc;
    }

    /**
     * Get the [intbpricsaleprog] column value.
     *
     * @return string
     */
    public function getIntbpricsaleprog()
    {
        return $this->intbpricsaleprog;
    }

    /**
     * Get the [intbpriccostpct] column value.
     *
     * @return string
     */
    public function getIntbpriccostpct()
    {
        return $this->intbpriccostpct;
    }
     ...
     * @return $this|\InvPriceCode The current object (for fluent API support)
     */
    public function setIntbpricgrup($v)
    {
        ...
        if ($this->intbpricgrup !== $v) {
            $this->intbpricgrup = $v;
            $this->modifiedColumns[InvPriceCodeTableMap::COL_INTBPRICGRUP] = true;
        }
    ...
    /**
     * Set the value of [intbpricdesc] column.
     *
     * @param string $v new value
     * @return $this|\InvPriceCode The current object (for fluent API support)
     */
    public function setIntbpricdesc($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->intbpricdesc !== $v) {
            $this->intbpricdesc = $v;
            $this->modifiedColumns[InvPriceCodeTableMap::COL_INTBPRICDESC] = true;
        }
    ...
    /**
     * Set the value of [intbpricsaleprog] column.
     *
     * @param string $v new value
     * @return $this|\InvPriceCode The current object (for fluent API support)
     */
    public function setIntbpricsaleprog($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->intbpricsaleprog !== $v) {
            $this->intbpricsaleprog = $v;
            $this->modifiedColumns[InvPriceCodeTableMap::COL_INTBPRICSALEPROG] = true;
        }
    ...
    /**
     * Set the value of [intbpriccostpct] column.
     *
     * @param string $v new value
     * @return $this|\InvPriceCode The current object (for fluent API support)
     */
    public function setIntbpriccostpct($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->intbpriccostpct !== $v) {
            $this->intbpriccostpct = $v;
            $this->modifiedColumns[InvPriceCodeTableMap::COL_INTBPRICCOSTPCT] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[InvPriceCodeTableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[InvPriceCodeTableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[InvPriceCodeTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InvPriceCodeTableMap::translateFieldName('Intbpricgrup', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbpricgrup = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InvPriceCodeTableMap::translateFieldName('Intbpricdesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbpricdesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InvPriceCodeTableMap::translateFieldName('Intbpricsaleprog', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbpricsaleprog = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : InvPriceCodeTableMap::translateFieldName('Intbpriccostpct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbpriccostpct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : InvPriceCodeTableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : InvPriceCodeTableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : InvPriceCodeTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = InvPriceCodeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\InvPriceCode'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInvPriceCodeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see InvPriceCode::setDeleted()
     * @see InvPriceCode::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildInvPriceCodeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InvPriceCodeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_INTBPRICGRUP)) {
            $modifiedColumns[':p' . $index++]  = 'IntbPricGrup';
        }
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_INTBPRICDESC)) {
            $modifiedColumns[':p' . $index++]  = 'IntbPricDesc';
        }
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_INTBPRICSALEPROG)) {
            $modifiedColumns[':p' . $index++]  = 'IntbPricSaleProg';
        }
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_INTBPRICCOSTPCT)) {
            $modifiedColumns[':p' . $index++]  = 'IntbPricCostPct';
        }
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_DATEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'DateUpdtd';
        }
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'dummy';
        }

        $sql = sprintf(
            'INSERT INTO inv_pric_code (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'IntbPricGrup':
                        ...
                        break;
                    case 'IntbPricDesc':
                        $stmt->bindValue($identifier, $this->intbpricdesc, PDO::PARAM_STR);
                        break;
                    case 'IntbPricSaleProg':
                        $stmt->bindValue($identifier, $this->intbpricsaleprog, PDO::PARAM_STR);
                        break;
                    case 'IntbPricCostPct':
                        $stmt->bindValue($identifier, $this->intbpriccostpct, PDO::PARAM_STR);
                        break;
                    case 'DateUpdtd':
    ...
    {
        $pos = InvPriceCodeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getIntbpricdesc();
                break;
            case 2:
                return $this->getIntbpricsaleprog();
                break;
            case 3:
                return $this->getIntbpriccostpct();
                break;
            case 4:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['InvPriceCode'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['InvPriceCode'][$this->hashCode()] = true;
        $keys = InvPriceCodeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIntbpricgrup(),
            $keys[1] => $this->getIntbpricdesc(),
            $keys[2] => $this->getIntbpricsaleprog(),
            $keys[3] => $this->getIntbpriccostpct(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setIntbpricdesc($value);
                break;
            case 2:
                $this->setIntbpricsaleprog($value);
                break;
            case 3:
                $this->setIntbpriccostpct($value);
                break;
            case 4:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIntbpricgrup($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setIntbpricdesc($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setIntbpricsaleprog($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setIntbpriccostpct($arr[$keys[3]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_INTBPRICGRUP)) {
            $criteria->add(InvPriceCodeTableMap::COL_INTBPRICGRUP, $this->intbpricgrup);
        }
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_INTBPRICDESC)) {
            $criteria->add(InvPriceCodeTableMap::COL_INTBPRICDESC, $this->intbpricdesc);
        }
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_INTBPRICSALEPROG)) {
            $criteria->add(InvPriceCodeTableMap::COL_INTBPRICSALEPROG, $this->intbpricsaleprog);
        }
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_INTBPRICCOSTPCT)) {
            $criteria->add(InvPriceCodeTableMap::COL_INTBPRICCOSTPCT, $this->intbpriccostpct);
        }
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_DATEUPDTD)) {
            $criteria->add(InvPriceCodeTableMap::COL_DATEUPDTD, $this->dateupdtd);
        }
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_TIMEUPDTD)) {
            $criteria->add(InvPriceCodeTableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(InvPriceCodeTableMap::COL_DUMMY)) {
            $criteria->add(InvPriceCodeTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildInvPriceCodeQuery::create();
        $criteria->add(InvPriceCodeTableMap::COL_INTBPRICGRUP, $this->intbpricgrup);
    ...
    {
        $validPk = null !== $this->getIntbpricgrup();
    ...
    /**
     * Generic method to set the primary key (intbpricgrup column).
     *
    ...
    {
        return null === $this->getIntbpricgrup();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InvPriceCode (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIntbpricdesc($this->getIntbpricdesc());
        $copyObj->setIntbpricsaleprog($this->getIntbpricsaleprog());
        $copyObj->setIntbpriccostpct($this->getIntbpriccostpct());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InvPriceCode Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildInvPriceCode is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildInvPriceCode The current object (for fluent API support)
     */
    public function setItemMasterItems(Collection $itemMasterItems, ConnectionInterface $con = null)
    {
        ...
        foreach ($itemMasterItemsToDelete as $itemMasterItemRemoved) {
            $itemMasterItemRemoved->setInvPriceCode(null);
        }
    ...
    protected function doAddItemMasterItem(ChildItemMasterItem $itemMasterItem)
    {
        ...
        $itemMasterItem->setInvPriceCode($this);
    }
    ...
    public function removeItemMasterItem(ChildItemMasterItem $itemMasterItem)
    {
        if ($this->getItemMasterItems()->contains($itemMasterItem)) {
            ...
            $itemMasterItem->setInvPriceCode(null);
        }
     ...
     * Otherwise if this InvPriceCode is new, it will return
     * an empty collection; or if this InvPriceCode has previously
     * been saved, it will retrieve related ItemMasterItems from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in InvPriceCode.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function clear()
    {
        ...
        $this->intbpricdesc = null;
        $this->intbpricsaleprog = null;
        $this->intbpriccostpct = null;
        $this->dateupdtd = null;
        $this->timeupdtd = null;
        $this->dummy = null;
        $this->alreadyInSave = false;
    ...
    {
        return (string) $this->exportTo(InvPriceCodeTableMap::DEFAULT_STRING_FORMAT);
    }
