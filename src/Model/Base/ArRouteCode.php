...
/**
 * Base class that represents a row from the 'ar_cust_rout' table.
 *
 *
 *
...
abstract class ArRouteCode implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\ArRouteCodeTableMap';
    ...
    /**
     * The value for the artbroutedesc field.
     *
     * @var        string|null
     */
    protected $artbroutedesc;
    ...
    /**
     * Get the [artbroutedesc] column value.
     *
     * @return string|null
     */
    public function getArtbroutedesc()
    {
        return $this->artbroutedesc;
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO ar_cust_rout (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'ArtbRoute':
                        ...
                        break;
                    case 'ArtbRouteDesc':
                        $stmt->bindValue($identifier, $this->artbroutedesc, PDO::PARAM_STR);
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setArtbroutedesc($arr[$keys[1]]);
        }
    ...
    {
        $validPk = null !== $this->getArtbroute();
    ...
    /**
     * Generic method to set the primary key (artbroute column).
     *
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setArtbroutedesc($this->getArtbroutedesc());
