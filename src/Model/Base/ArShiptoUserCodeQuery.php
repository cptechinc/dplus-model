 ...
 *
 * @method     ChildArShiptoUserCode|null findOne(?ConnectionInterface $con = null) Return the first ChildArShiptoUserCode matching the query
 ...
 *
 * @method     ChildArShiptoUserCode|null findOneByArtbsusrcode(string $ArtbSusrCode) Return the first ChildArShiptoUserCode filtered by the ArtbSusrCode column
 * @method     ChildArShiptoUserCode|null findOneByArtbsusrdesc(string $ArtbSusrDesc) Return the first ChildArShiptoUserCode filtered by the ArtbSusrDesc column
 * @method     ChildArShiptoUserCode|null findOneByDateupdtd(string $DateUpdtd) Return the first ChildArShiptoUserCode filtered by the DateUpdtd column
 * @method     ChildArShiptoUserCode|null findOneByTimeupdtd(string $TimeUpdtd) Return the first ChildArShiptoUserCode filtered by the TimeUpdtd column
 * @method     ChildArShiptoUserCode|null findOneByDummy(string $dummy) Return the first ChildArShiptoUserCode filtered by the dummy column
 *
 ...
 *
 * @method     ChildArShiptoUserCode[]|Collection find(?ConnectionInterface $con = null) Return ChildArShiptoUserCode objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildArShiptoUserCode> find(?ConnectionInterface $con = null) Return ChildArShiptoUserCode objects based on current ModelCriteria
 *
 * @method     ChildArShiptoUserCode[]|Collection findByArtbsusrcode(string|array<string> $ArtbSusrCode) Return ChildArShiptoUserCode objects filtered by the ArtbSusrCode column
 * @psalm-method Collection&\Traversable<ChildArShiptoUserCode> findByArtbsusrcode(string|array<string> $ArtbSusrCode) Return ChildArShiptoUserCode objects filtered by the ArtbSusrCode column
 * @method     ChildArShiptoUserCode[]|Collection findByArtbsusrdesc(string|array<string> $ArtbSusrDesc) Return ChildArShiptoUserCode objects filtered by the ArtbSusrDesc column
 * @psalm-method Collection&\Traversable<ChildArShiptoUserCode> findByArtbsusrdesc(string|array<string> $ArtbSusrDesc) Return ChildArShiptoUserCode objects filtered by the ArtbSusrDesc column
 * @method     ChildArShiptoUserCode[]|Collection findByDateupdtd(string|array<string> $DateUpdtd) Return ChildArShiptoUserCode objects filtered by the DateUpdtd column
 * @psalm-method Collection&\Traversable<ChildArShiptoUserCode> findByDateupdtd(string|array<string> $DateUpdtd) Return ChildArShiptoUserCode objects filtered by the DateUpdtd column
 * @method     ChildArShiptoUserCode[]|Collection findByTimeupdtd(string|array<string> $TimeUpdtd) Return ChildArShiptoUserCode objects filtered by the TimeUpdtd column
 * @psalm-method Collection&\Traversable<ChildArShiptoUserCode> findByTimeupdtd(string|array<string> $TimeUpdtd) Return ChildArShiptoUserCode objects filtered by the TimeUpdtd column
 * @method     ChildArShiptoUserCode[]|Collection findByDummy(string|array<string> $dummy) Return ChildArShiptoUserCode objects filtered by the dummy column
 * @psalm-method Collection&\Traversable<ChildArShiptoUserCode> findByDummy(string|array<string> $dummy) Return ChildArShiptoUserCode objects filtered by the dummy column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildArShiptoUserCode> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class ArShiptoUserCodeQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(ArShiptoUserCodeTableMap::COL_ARTBSUSRCODE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(ArShiptoUserCodeTableMap::COL_ARTBSUSRCODE, $keys, Criteria::IN);
     ...
     * $query->filterByArtbsusrcode(['foo', 'bar']); // WHERE ArtbSusrCode IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $artbsusrcode The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByArtbsusrcode($artbsusrcode = null, ?string $comparison = null)
    {
        if (null === $comparison) {
        ...
        $this->addUsingAlias(ArShiptoUserCodeTableMap::COL_ARTBSUSRCODE, $artbsusrcode, $comparison);
     ...
     * $query->filterByArtbsusrdesc(['foo', 'bar']); // WHERE ArtbSusrDesc IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $artbsusrdesc The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByArtbsusrdesc($artbsusrdesc = null, ?string $comparison = null)
    {
        if (null === $comparison) {
        ...
        $this->addUsingAlias(ArShiptoUserCodeTableMap::COL_ARTBSUSRDESC, $artbsusrdesc, $comparison);
    ...
    public function filterByDateupdtd($dateupdtd = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ArShiptoUserCodeTableMap::COL_DATEUPDTD, $dateupdtd, $comparison);
    ...
    public function filterByTimeupdtd($timeupdtd = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ArShiptoUserCodeTableMap::COL_TIMEUPDTD, $timeupdtd, $comparison);
    ...
    public function filterByDummy($dummy = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ArShiptoUserCodeTableMap::COL_DUMMY, $dummy, $comparison);
     ...
     *
     * @param ChildArShiptoUserCode $arShiptoUserCode Object to remove from the list of results
     *
     * @return $this The current query, for fluid interface
     */
    public function prune($arShiptoUserCode = null)
    {
        if ($arShiptoUserCode) {
            $this->addUsingAlias(ArShiptoUserCodeTableMap::COL_ARTBSUSRCODE, $arShiptoUserCode->getArtbsusrcode(), Criteria::NOT_EQUAL);
        }
