...
abstract class InvBinAreaCode implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\InvBinAreaCodeTableMap';
     ...
     * Otherwise if this InvBinAreaCode is new, it will return
     * an empty collection; or if this InvBinAreaCode has previously
     * been saved, it will retrieve related WarehouseBins from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in InvBinAreaCode.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildWarehouseBin}> List of ChildWarehouseBin objects
     */
    public function getWarehouseBinsJoinWarehouse(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildWarehouseBinQuery::create(null, $criteria);
