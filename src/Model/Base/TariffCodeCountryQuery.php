 ...
 *
 * @method     ChildTariffCodeCountry|null findOne(?ConnectionInterface $con = null) Return the first ChildTariffCodeCountry matching the query
 ...
 *
 * @method     ChildTariffCodeCountry|null findOneByIntbtaricode(string $IntbTariCode) Return the first ChildTariffCodeCountry filtered by the IntbTariCode column
 * @method     ChildTariffCodeCountry|null findOneByIntbtrcoctry(string $IntbTrcoCtry) Return the first ChildTariffCodeCountry filtered by the IntbTrcoCtry column
 * @method     ChildTariffCodeCountry|null findOneByDateupdtd(string $DateUpdtd) Return the first ChildTariffCodeCountry filtered by the DateUpdtd column
 * @method     ChildTariffCodeCountry|null findOneByTimeupdtd(string $TimeUpdtd) Return the first ChildTariffCodeCountry filtered by the TimeUpdtd column
 * @method     ChildTariffCodeCountry|null findOneByDummy(string $dummy) Return the first ChildTariffCodeCountry filtered by the dummy column
 *
 ...
 *
 * @method     ChildTariffCodeCountry[]|Collection find(?ConnectionInterface $con = null) Return ChildTariffCodeCountry objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildTariffCodeCountry> find(?ConnectionInterface $con = null) Return ChildTariffCodeCountry objects based on current ModelCriteria
 *
 * @method     ChildTariffCodeCountry[]|Collection findByIntbtaricode(string|array<string> $IntbTariCode) Return ChildTariffCodeCountry objects filtered by the IntbTariCode column
 * @psalm-method Collection&\Traversable<ChildTariffCodeCountry> findByIntbtaricode(string|array<string> $IntbTariCode) Return ChildTariffCodeCountry objects filtered by the IntbTariCode column
 * @method     ChildTariffCodeCountry[]|Collection findByIntbtrcoctry(string|array<string> $IntbTrcoCtry) Return ChildTariffCodeCountry objects filtered by the IntbTrcoCtry column
 * @psalm-method Collection&\Traversable<ChildTariffCodeCountry> findByIntbtrcoctry(string|array<string> $IntbTrcoCtry) Return ChildTariffCodeCountry objects filtered by the IntbTrcoCtry column
 * @method     ChildTariffCodeCountry[]|Collection findByDateupdtd(string|array<string> $DateUpdtd) Return ChildTariffCodeCountry objects filtered by the DateUpdtd column
 * @psalm-method Collection&\Traversable<ChildTariffCodeCountry> findByDateupdtd(string|array<string> $DateUpdtd) Return ChildTariffCodeCountry objects filtered by the DateUpdtd column
 * @method     ChildTariffCodeCountry[]|Collection findByTimeupdtd(string|array<string> $TimeUpdtd) Return ChildTariffCodeCountry objects filtered by the TimeUpdtd column
 * @psalm-method Collection&\Traversable<ChildTariffCodeCountry> findByTimeupdtd(string|array<string> $TimeUpdtd) Return ChildTariffCodeCountry objects filtered by the TimeUpdtd column
 * @method     ChildTariffCodeCountry[]|Collection findByDummy(string|array<string> $dummy) Return ChildTariffCodeCountry objects filtered by the dummy column
 * @psalm-method Collection&\Traversable<ChildTariffCodeCountry> findByDummy(string|array<string> $dummy) Return ChildTariffCodeCountry objects filtered by the dummy column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildTariffCodeCountry> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class TariffCodeCountryQuery extends ModelCriteria
{
    ...
    public function filterByIntbtaricode($intbtaricode = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(TariffCodeCountryTableMap::COL_INTBTARICODE, $intbtaricode, $comparison);
     ...
     * $query->filterByIntbtrcoctry(['foo', 'bar']); // WHERE IntbTrcoCtry IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $intbtrcoctry The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByIntbtrcoctry($intbtrcoctry = null, ?string $comparison = null)
    {
        if (null === $comparison) {
        ...
        $this->addUsingAlias(TariffCodeCountryTableMap::COL_INTBTRCOCTRY, $intbtrcoctry, $comparison);
    ...
    public function filterByDateupdtd($dateupdtd = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(TariffCodeCountryTableMap::COL_DATEUPDTD, $dateupdtd, $comparison);
    ...
    public function filterByTimeupdtd($timeupdtd = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(TariffCodeCountryTableMap::COL_TIMEUPDTD, $timeupdtd, $comparison);
    ...
    public function filterByDummy($dummy = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(TariffCodeCountryTableMap::COL_DUMMY, $dummy, $comparison);
