 ...
 *
 * @method     ChildArWriteOffCode|null findOne(?ConnectionInterface $con = null) Return the first ChildArWriteOffCode matching the query
 ...
 *
 * @method     ChildArWriteOffCode|null findOneByArtbwoffcode(string $ArtbWoffCode) Return the first ChildArWriteOffCode filtered by the ArtbWoffCode column
 * @method     ChildArWriteOffCode|null findOneByArtbwoffdesc(string $ArtbWoffDesc) Return the first ChildArWriteOffCode filtered by the ArtbWoffDesc column
 * @method     ChildArWriteOffCode|null findOneByDateupdtd(string $DateUpdtd) Return the first ChildArWriteOffCode filtered by the DateUpdtd column
 * @method     ChildArWriteOffCode|null findOneByTimeupdtd(string $TimeUpdtd) Return the first ChildArWriteOffCode filtered by the TimeUpdtd column
 * @method     ChildArWriteOffCode|null findOneByDummy(string $dummy) Return the first ChildArWriteOffCode filtered by the dummy column
 *
 ...
 *
 * @method     ChildArWriteOffCode[]|Collection find(?ConnectionInterface $con = null) Return ChildArWriteOffCode objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildArWriteOffCode> find(?ConnectionInterface $con = null) Return ChildArWriteOffCode objects based on current ModelCriteria
 *
 * @method     ChildArWriteOffCode[]|Collection findByArtbwoffcode(string|array<string> $ArtbWoffCode) Return ChildArWriteOffCode objects filtered by the ArtbWoffCode column
 * @psalm-method Collection&\Traversable<ChildArWriteOffCode> findByArtbwoffcode(string|array<string> $ArtbWoffCode) Return ChildArWriteOffCode objects filtered by the ArtbWoffCode column
 * @method     ChildArWriteOffCode[]|Collection findByArtbwoffdesc(string|array<string> $ArtbWoffDesc) Return ChildArWriteOffCode objects filtered by the ArtbWoffDesc column
 * @psalm-method Collection&\Traversable<ChildArWriteOffCode> findByArtbwoffdesc(string|array<string> $ArtbWoffDesc) Return ChildArWriteOffCode objects filtered by the ArtbWoffDesc column
 * @method     ChildArWriteOffCode[]|Collection findByDateupdtd(string|array<string> $DateUpdtd) Return ChildArWriteOffCode objects filtered by the DateUpdtd column
 * @psalm-method Collection&\Traversable<ChildArWriteOffCode> findByDateupdtd(string|array<string> $DateUpdtd) Return ChildArWriteOffCode objects filtered by the DateUpdtd column
 * @method     ChildArWriteOffCode[]|Collection findByTimeupdtd(string|array<string> $TimeUpdtd) Return ChildArWriteOffCode objects filtered by the TimeUpdtd column
 * @psalm-method Collection&\Traversable<ChildArWriteOffCode> findByTimeupdtd(string|array<string> $TimeUpdtd) Return ChildArWriteOffCode objects filtered by the TimeUpdtd column
 * @method     ChildArWriteOffCode[]|Collection findByDummy(string|array<string> $dummy) Return ChildArWriteOffCode objects filtered by the dummy column
 * @psalm-method Collection&\Traversable<ChildArWriteOffCode> findByDummy(string|array<string> $dummy) Return ChildArWriteOffCode objects filtered by the dummy column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildArWriteOffCode> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class ArWriteOffCodeQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(ArWriteOffCodeTableMap::COL_ARTBWOFFCODE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(ArWriteOffCodeTableMap::COL_ARTBWOFFCODE, $keys, Criteria::IN);
     ...
     * $query->filterByArtbwoffcode(['foo', 'bar']); // WHERE ArtbWoffCode IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $artbwoffcode The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByArtbwoffcode($artbwoffcode = null, ?string $comparison = null)
    {
        if (null === $comparison) {
        ...
        $this->addUsingAlias(ArWriteOffCodeTableMap::COL_ARTBWOFFCODE, $artbwoffcode, $comparison);
     ...
     * $query->filterByArtbwoffdesc(['foo', 'bar']); // WHERE ArtbWoffDesc IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $artbwoffdesc The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByArtbwoffdesc($artbwoffdesc = null, ?string $comparison = null)
    {
        if (null === $comparison) {
        ...
        $this->addUsingAlias(ArWriteOffCodeTableMap::COL_ARTBWOFFDESC, $artbwoffdesc, $comparison);
    ...
    public function filterByDateupdtd($dateupdtd = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ArWriteOffCodeTableMap::COL_DATEUPDTD, $dateupdtd, $comparison);
    ...
    public function filterByTimeupdtd($timeupdtd = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ArWriteOffCodeTableMap::COL_TIMEUPDTD, $timeupdtd, $comparison);
    ...
    public function filterByDummy($dummy = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ArWriteOffCodeTableMap::COL_DUMMY, $dummy, $comparison);
