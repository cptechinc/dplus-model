...
/**
 * Base class that represents a row from the 'ar_cust_comm' table.
 *
 *
 *
...
abstract class ArCommissionCode implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\ArCommissionCodeTableMap';
    ...
    /**
     * The value for the artbcommdesc field.
     *
     * @var        string|null
     */
    protected $artbcommdesc;
    ...
    /**
     * Get the [artbcommdesc] column value.
     *
     * @return string|null
     */
    public function getArtbcommdesc()
    {
        return $this->artbcommdesc;
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO ar_cust_comm (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'ArtbCommCode':
                        ...
                        break;
                    case 'ArtbCommDesc':
                        $stmt->bindValue($identifier, $this->artbcommdesc, PDO::PARAM_STR);
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setArtbcommdesc($arr[$keys[1]]);
        }
    ...
    {
        $validPk = null !== $this->getArtbcommcode();
    ...
    /**
     * Generic method to set the primary key (artbcommcode column).
     *
    ...
    {
        return null === $this->getArtbcommcode();
    }
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setArtbcommdesc($this->getArtbcommdesc());
