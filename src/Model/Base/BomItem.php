...
/**
 * Base class that represents a row from the 'pr_bmat_head' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class BomItem implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BomItemTableMap';
    ...
    /**
     * The value for the bomhlevel field.
     *
     * @var        int
     */
    protected $bomhlevel;
    ...
    /**
     * Initializes internal state of Base\BomItem object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>BomItem</code> instance.  If
     * <code>obj</code> is an instance of <code>BomItem</code>, delegates to
     * <code>equals(BomItem)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|BomItem The current object, for fluid interface
     */
    ...
    /**
     * Get the [bomhlevel] column value.
     *
     * @return int
     */
    public function getBomhlevel()
    {
        return $this->bomhlevel;
    }
     ...
     * @return $this|\BomItem The current object (for fluent API support)
     */
    public function setBomhproditem($v)
    {
        ...
        if ($this->bomhproditem !== $v) {
            $this->bomhproditem = $v;
            $this->modifiedColumns[BomItemTableMap::COL_BOMHPRODITEM] = true;
        }
    ...
    /**
     * Set the value of [bomhlevel] column.
     *
     * @param int $v new value
     * @return $this|\BomItem The current object (for fluent API support)
     */
    public function setBomhlevel($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->bomhlevel !== $v) {
            $this->bomhlevel = $v;
            $this->modifiedColumns[BomItemTableMap::COL_BOMHLEVEL] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[BomItemTableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[BomItemTableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[BomItemTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BomItemTableMap::translateFieldName('Bomhproditem', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bomhproditem = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BomItemTableMap::translateFieldName('Bomhlevel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bomhlevel = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BomItemTableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BomItemTableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : BomItemTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = BomItemTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\BomItem'), 0, $e);
        }
    }
    ...
    {
        if ($this->aItemMasterItem !== null && $this->bomhproditem !== $this->aItemMasterItem->getInititemnbr()) {
            $this->aItemMasterItem = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBomItemQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see BomItem::setDeleted()
     * @see BomItem::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBomItemQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BomItemTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BomItemTableMap::COL_BOMHPRODITEM)) {
            $modifiedColumns[':p' . $index++]  = 'BomhProdItem';
        }
        if ($this->isColumnModified(BomItemTableMap::COL_BOMHLEVEL)) {
            $modifiedColumns[':p' . $index++]  = 'BomhLevel';
        }
        if ($this->isColumnModified(BomItemTableMap::COL_DATEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'DateUpdtd';
        }
        if ($this->isColumnModified(BomItemTableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(BomItemTableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'dummy';
        }

        $sql = sprintf(
            'INSERT INTO pr_bmat_head (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'BomhProdItem':
                        ...
                        break;
                    case 'BomhLevel':
                        $stmt->bindValue($identifier, $this->bomhlevel, PDO::PARAM_INT);
                        break;
                    case 'DateUpdtd':
    ...
    {
        $pos = BomItemTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['BomItem'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BomItem'][$this->hashCode()] = true;
        $keys = BomItemTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getBomhproditem(),
            $keys[1] => $this->getBomhlevel(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BomItemTableMap::COL_BOMHPRODITEM)) {
            $criteria->add(BomItemTableMap::COL_BOMHPRODITEM, $this->bomhproditem);
        }
        if ($this->isColumnModified(BomItemTableMap::COL_BOMHLEVEL)) {
            $criteria->add(BomItemTableMap::COL_BOMHLEVEL, $this->bomhlevel);
        }
        if ($this->isColumnModified(BomItemTableMap::COL_DATEUPDTD)) {
            $criteria->add(BomItemTableMap::COL_DATEUPDTD, $this->dateupdtd);
        }
        if ($this->isColumnModified(BomItemTableMap::COL_TIMEUPDTD)) {
            $criteria->add(BomItemTableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(BomItemTableMap::COL_DUMMY)) {
            $criteria->add(BomItemTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildBomItemQuery::create();
        $criteria->add(BomItemTableMap::COL_BOMHPRODITEM, $this->bomhproditem);
    ...
    /**
     * Generic method to set the primary key (bomhproditem column).
     *
    ...
    {
        return null === $this->getBomhproditem();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \BomItem (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setBomhlevel($this->getBomhlevel());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \BomItem Clone of current object.
     * @throws PropelException
     */
    ...
    public function setItemMasterItem(ChildItemMasterItem $v = null)
    {
        if ($v === null) {
            ...
            $this->setBomhproditem($v->getInititemnbr());
        }
    ...
    {
        if ($this->aItemMasterItem === null && (($this->bomhproditem !== "" && $this->bomhproditem !== null))) {
            $this->aItemMasterItem = ChildItemMasterItemQuery::create()->findPk($this->bomhproditem, $con);
            // Because this foreign key represents a one-to-one relationship, we will create a bi-directional association.
            $this->aItemMasterItem->setBomItem($this);
        }
     ...
     * If this ChildBomItem is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildBomItem The current object (for fluent API support)
     */
    public function setBomComponents(Collection $bomComponents, ConnectionInterface $con = null)
    {
        ...
        foreach ($bomComponentsToDelete as $bomComponentRemoved) {
            $bomComponentRemoved->setBomItem(null);
        }
     ...
     * Otherwise if this BomItem is new, it will return
     * an empty collection; or if this BomItem has previously
     * been saved, it will retrieve related BomComponents from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in BomItem.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildBomComponent[] List of ChildBomComponent objects
     */
    public function getBomComponentsJoinItemMasterItem(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBomComponentQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aItemMasterItem) {
            $this->aItemMasterItem->removeBomItem($this);
        }
    ...
    {
        return (string) $this->exportTo(BomItemTableMap::DEFAULT_STRING_FORMAT);
    }
