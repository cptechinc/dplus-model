...
abstract class ConfigAr implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : ConfigArTableMap::translateFieldName('Artbconfsviadef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfsviadef = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : ConfigArTableMap::translateFieldName('Artbconftermdef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconftermdef = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : ConfigArTableMap::translateFieldName('Artbconftaxdef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconftaxdef = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : ConfigArTableMap::translateFieldName('Artbconfstmtdef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfstmtdef = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : ConfigArTableMap::translateFieldName('Artbconfallowbo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfallowbo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : ConfigArTableMap::translateFieldName('Artbconfallowfc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfallowfc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : ConfigArTableMap::translateFieldName('Artbconfusepriccode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfusepriccode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : ConfigArTableMap::translateFieldName('Artbconfpricdef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfpricdef = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : ConfigArTableMap::translateFieldName('Artbconfusecommcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfusecommcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : ConfigArTableMap::translateFieldName('Artbconfcommdef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfcommdef = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : ConfigArTableMap::translateFieldName('Artbconfcustlabl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfcustlabl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : ConfigArTableMap::translateFieldName('Artbconfcustreq', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfcustreq = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : ConfigArTableMap::translateFieldName('Artbconfcustdef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfcustdef = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : ConfigArTableMap::translateFieldName('Artbconfshiplabl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfshiplabl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : ConfigArTableMap::translateFieldName('Artbconfshipreq', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfshipreq = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : ConfigArTableMap::translateFieldName('Artbconfshipdef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfshipdef = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : ConfigArTableMap::translateFieldName('Artbconfreqdate2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfreqdate2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : ConfigArTableMap::translateFieldName('Artbconfreqdate3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfreqdate3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : ConfigArTableMap::translateFieldName('Artbconfreqdate4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfreqdate4 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 60 + $startcol : ConfigArTableMap::translateFieldName('Artbconfuseweb', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfuseweb = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 61 + $startcol : ConfigArTableMap::translateFieldName('Artbconfpayhstoredays', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfpayhstoredays = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 62 + $startcol : ConfigArTableMap::translateFieldName('Artbconfbyclerk', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfbyclerk = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 63 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2ecrwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2ecrwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 64 + $startcol : ConfigArTableMap::translateFieldName('Artbconfzerotermdisc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfzerotermdisc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 65 + $startcol : ConfigArTableMap::translateFieldName('Artbconfuseautocidgen', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfuseautocidgen = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 66 + $startcol : ConfigArTableMap::translateFieldName('Artbconfprefixlen', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfprefixlen = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 67 + $startcol : ConfigArTableMap::translateFieldName('Artbconfparagecredlast', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfparagecredlast = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 68 + $startcol : ConfigArTableMap::translateFieldName('Artbconfincludecod', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfincludecod = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 69 + $startcol : ConfigArTableMap::translateFieldName('Artbconfaddlpricdisc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfaddlpricdisc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 70 + $startcol : ConfigArTableMap::translateFieldName('Artbconfapdonoehd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfapdonoehd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 71 + $startcol : ConfigArTableMap::translateFieldName('Artbconfnbrsp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfnbrsp = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 72 + $startcol : ConfigArTableMap::translateFieldName('Artbconfforcesplvl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfforcesplvl = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 73 + $startcol : ConfigArTableMap::translateFieldName('Artbconfcustgetopt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfcustgetopt = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 74 + $startcol : ConfigArTableMap::translateFieldName('Artbconfaddicmnt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfaddicmnt = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 75 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2appaddiscitmpdm', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2appaddiscitmpdm = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 76 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2rfndselectamt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2rfndselectamt = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 77 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2rfndglacct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2rfndglacct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 78 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2rfndapterm', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2rfndapterm = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 79 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2rfndarterm', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2rfndarterm = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 80 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2cwoterm', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2cwoterm = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 81 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2ccterm', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2ccterm = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 82 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2ccbatch', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2ccbatch = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 83 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2ccsavedays', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2ccsavedays = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 84 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2aprvdccasdeposit', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2aprvdccasdeposit = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 85 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2cmqtysign', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2cmqtysign = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 86 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2bolline', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2bolline = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 87 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2bolcols', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2bolcols = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 88 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2usesounitwght', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2usesounitwght = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 89 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2delzbal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2delzbal = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 90 + $startcol : ConfigArTableMap::translateFieldName('Artbconfstopcustchg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfstopcustchg = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 91 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2prospecteditcmm', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2prospecteditcmm = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 92 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2prospectnotestocmm', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2prospectnotestocmm = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 93 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2ctrygetdflt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2ctrygetdflt = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 94 + $startcol : ConfigArTableMap::translateFieldName('Artbconfrptbywhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfrptbywhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 95 + $startcol : ConfigArTableMap::translateFieldName('Artbconfappendpos', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfappendpos = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 96 + $startcol : ConfigArTableMap::translateFieldName('Artbconfincoasstacct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfincoasstacct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 97 + $startcol : ConfigArTableMap::translateFieldName('Artbconfincoliabacct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfincoliabacct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 98 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2incoasstacct2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2incoasstacct2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 99 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2incoliabacct2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2incoliabacct2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 100 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2usesurchg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2usesurchg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 101 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2surchgitemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2surchgitemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 102 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2surchgigrupseq', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2surchgigrupseq = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 103 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2surchgsviaseq', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2surchgsviaseq = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 104 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2surchgcstidseq', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2surchgcstidseq = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 105 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2surchgcstpcseq', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2surchgcstpcseq = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 106 + $startcol : ConfigArTableMap::translateFieldName('Artbconfzeroinvcline', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfzeroinvcline = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 107 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2zeroordrship', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2zeroordrship = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 108 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2zeroordrmess', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2zeroordrmess = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 109 + $startcol : ConfigArTableMap::translateFieldName('Artbconfcashacctwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbconfcashacctwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 110 + $startcol : ConfigArTableMap::translateFieldName('Artbcon2mtaxfrtflagorcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artbcon2mtaxfrtflagorcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 111 + $startcol : ConfigArTableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 112 + $startcol : ConfigArTableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 113 + $startcol : ConfigArTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 114; // 114 = ConfigArTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[41] => $this->getArtbconfsviadef(),
            $keys[42] => $this->getArtbconftermdef(),
            $keys[43] => $this->getArtbconftaxdef(),
            $keys[44] => $this->getArtbconfstmtdef(),
            $keys[45] => $this->getArtbconfallowbo(),
            $keys[46] => $this->getArtbconfallowfc(),
            $keys[47] => $this->getArtbconfusepriccode(),
            $keys[48] => $this->getArtbconfpricdef(),
            $keys[49] => $this->getArtbconfusecommcode(),
            $keys[50] => $this->getArtbconfcommdef(),
            $keys[51] => $this->getArtbconfcustlabl(),
            $keys[52] => $this->getArtbconfcustreq(),
            $keys[53] => $this->getArtbconfcustdef(),
            $keys[54] => $this->getArtbconfshiplabl(),
            $keys[55] => $this->getArtbconfshipreq(),
            $keys[56] => $this->getArtbconfshipdef(),
            $keys[57] => $this->getArtbconfreqdate2(),
            $keys[58] => $this->getArtbconfreqdate3(),
            $keys[59] => $this->getArtbconfreqdate4(),
            $keys[60] => $this->getArtbconfuseweb(),
            $keys[61] => $this->getArtbconfpayhstoredays(),
            $keys[62] => $this->getArtbconfbyclerk(),
            $keys[63] => $this->getArtbcon2ecrwhse(),
            $keys[64] => $this->getArtbconfzerotermdisc(),
            $keys[65] => $this->getArtbconfuseautocidgen(),
            $keys[66] => $this->getArtbconfprefixlen(),
            $keys[67] => $this->getArtbconfparagecredlast(),
            $keys[68] => $this->getArtbconfincludecod(),
            $keys[69] => $this->getArtbconfaddlpricdisc(),
            $keys[70] => $this->getArtbconfapdonoehd(),
            $keys[71] => $this->getArtbconfnbrsp(),
            $keys[72] => $this->getArtbconfforcesplvl(),
            $keys[73] => $this->getArtbconfcustgetopt(),
            $keys[74] => $this->getArtbconfaddicmnt(),
            $keys[75] => $this->getArtbcon2appaddiscitmpdm(),
            $keys[76] => $this->getArtbcon2rfndselectamt(),
            $keys[77] => $this->getArtbcon2rfndglacct(),
            $keys[78] => $this->getArtbcon2rfndapterm(),
            $keys[79] => $this->getArtbcon2rfndarterm(),
            $keys[80] => $this->getArtbcon2cwoterm(),
            $keys[81] => $this->getArtbcon2ccterm(),
            $keys[82] => $this->getArtbcon2ccbatch(),
            $keys[83] => $this->getArtbcon2ccsavedays(),
            $keys[84] => $this->getArtbcon2aprvdccasdeposit(),
            $keys[85] => $this->getArtbcon2cmqtysign(),
            $keys[86] => $this->getArtbcon2bolline(),
            $keys[87] => $this->getArtbcon2bolcols(),
            $keys[88] => $this->getArtbcon2usesounitwght(),
            $keys[89] => $this->getArtbcon2delzbal(),
            $keys[90] => $this->getArtbconfstopcustchg(),
            $keys[91] => $this->getArtbcon2prospecteditcmm(),
            $keys[92] => $this->getArtbcon2prospectnotestocmm(),
            $keys[93] => $this->getArtbcon2ctrygetdflt(),
            $keys[94] => $this->getArtbconfrptbywhse(),
            $keys[95] => $this->getArtbconfappendpos(),
            $keys[96] => $this->getArtbconfincoasstacct(),
            $keys[97] => $this->getArtbconfincoliabacct(),
            $keys[98] => $this->getArtbcon2incoasstacct2(),
            $keys[99] => $this->getArtbcon2incoliabacct2(),
            $keys[100] => $this->getArtbcon2usesurchg(),
            $keys[101] => $this->getArtbcon2surchgitemid(),
            $keys[102] => $this->getArtbcon2surchgigrupseq(),
            $keys[103] => $this->getArtbcon2surchgsviaseq(),
            $keys[104] => $this->getArtbcon2surchgcstidseq(),
            $keys[105] => $this->getArtbcon2surchgcstpcseq(),
            $keys[106] => $this->getArtbconfzeroinvcline(),
            $keys[107] => $this->getArtbcon2zeroordrship(),
            $keys[108] => $this->getArtbcon2zeroordrmess(),
            $keys[109] => $this->getArtbconfcashacctwhse(),
            $keys[110] => $this->getArtbcon2mtaxfrtflagorcode(),
            $keys[111] => $this->getDateupdtd(),
            $keys[112] => $this->getTimeupdtd(),
            $keys[113] => $this->getDummy(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[41], $arr)) {
            $this->setArtbconfsviadef($arr[$keys[41]]);
        }
        if (array_key_exists($keys[42], $arr)) {
            $this->setArtbconftermdef($arr[$keys[42]]);
        }
        if (array_key_exists($keys[43], $arr)) {
            $this->setArtbconftaxdef($arr[$keys[43]]);
        }
        if (array_key_exists($keys[44], $arr)) {
            $this->setArtbconfstmtdef($arr[$keys[44]]);
        }
        if (array_key_exists($keys[45], $arr)) {
            $this->setArtbconfallowbo($arr[$keys[45]]);
        }
        if (array_key_exists($keys[46], $arr)) {
            $this->setArtbconfallowfc($arr[$keys[46]]);
        }
        if (array_key_exists($keys[47], $arr)) {
            $this->setArtbconfusepriccode($arr[$keys[47]]);
        }
        if (array_key_exists($keys[48], $arr)) {
            $this->setArtbconfpricdef($arr[$keys[48]]);
        }
        if (array_key_exists($keys[49], $arr)) {
            $this->setArtbconfusecommcode($arr[$keys[49]]);
        }
        if (array_key_exists($keys[50], $arr)) {
            $this->setArtbconfcommdef($arr[$keys[50]]);
        }
        if (array_key_exists($keys[51], $arr)) {
            $this->setArtbconfcustlabl($arr[$keys[51]]);
        }
        if (array_key_exists($keys[52], $arr)) {
            $this->setArtbconfcustreq($arr[$keys[52]]);
        }
        if (array_key_exists($keys[53], $arr)) {
            $this->setArtbconfcustdef($arr[$keys[53]]);
        }
        if (array_key_exists($keys[54], $arr)) {
            $this->setArtbconfshiplabl($arr[$keys[54]]);
        }
        if (array_key_exists($keys[55], $arr)) {
            $this->setArtbconfshipreq($arr[$keys[55]]);
        }
        if (array_key_exists($keys[56], $arr)) {
            $this->setArtbconfshipdef($arr[$keys[56]]);
        }
        if (array_key_exists($keys[57], $arr)) {
            $this->setArtbconfreqdate2($arr[$keys[57]]);
        }
        if (array_key_exists($keys[58], $arr)) {
            $this->setArtbconfreqdate3($arr[$keys[58]]);
        }
        if (array_key_exists($keys[59], $arr)) {
            $this->setArtbconfreqdate4($arr[$keys[59]]);
        }
        if (array_key_exists($keys[60], $arr)) {
            $this->setArtbconfuseweb($arr[$keys[60]]);
        }
        if (array_key_exists($keys[61], $arr)) {
            $this->setArtbconfpayhstoredays($arr[$keys[61]]);
        }
        if (array_key_exists($keys[62], $arr)) {
            $this->setArtbconfbyclerk($arr[$keys[62]]);
        }
        if (array_key_exists($keys[63], $arr)) {
            $this->setArtbcon2ecrwhse($arr[$keys[63]]);
        }
        if (array_key_exists($keys[64], $arr)) {
            $this->setArtbconfzerotermdisc($arr[$keys[64]]);
        }
        if (array_key_exists($keys[65], $arr)) {
            $this->setArtbconfuseautocidgen($arr[$keys[65]]);
        }
        if (array_key_exists($keys[66], $arr)) {
            $this->setArtbconfprefixlen($arr[$keys[66]]);
        }
        if (array_key_exists($keys[67], $arr)) {
            $this->setArtbconfparagecredlast($arr[$keys[67]]);
        }
        if (array_key_exists($keys[68], $arr)) {
            $this->setArtbconfincludecod($arr[$keys[68]]);
        }
        if (array_key_exists($keys[69], $arr)) {
            $this->setArtbconfaddlpricdisc($arr[$keys[69]]);
        }
        if (array_key_exists($keys[70], $arr)) {
            $this->setArtbconfapdonoehd($arr[$keys[70]]);
        }
        if (array_key_exists($keys[71], $arr)) {
            $this->setArtbconfnbrsp($arr[$keys[71]]);
        }
        if (array_key_exists($keys[72], $arr)) {
            $this->setArtbconfforcesplvl($arr[$keys[72]]);
        }
        if (array_key_exists($keys[73], $arr)) {
            $this->setArtbconfcustgetopt($arr[$keys[73]]);
        }
        if (array_key_exists($keys[74], $arr)) {
            $this->setArtbconfaddicmnt($arr[$keys[74]]);
        }
        if (array_key_exists($keys[75], $arr)) {
            $this->setArtbcon2appaddiscitmpdm($arr[$keys[75]]);
        }
        if (array_key_exists($keys[76], $arr)) {
            $this->setArtbcon2rfndselectamt($arr[$keys[76]]);
        }
        if (array_key_exists($keys[77], $arr)) {
            $this->setArtbcon2rfndglacct($arr[$keys[77]]);
        }
        if (array_key_exists($keys[78], $arr)) {
            $this->setArtbcon2rfndapterm($arr[$keys[78]]);
        }
        if (array_key_exists($keys[79], $arr)) {
            $this->setArtbcon2rfndarterm($arr[$keys[79]]);
        }
        if (array_key_exists($keys[80], $arr)) {
            $this->setArtbcon2cwoterm($arr[$keys[80]]);
        }
        if (array_key_exists($keys[81], $arr)) {
            $this->setArtbcon2ccterm($arr[$keys[81]]);
        }
        if (array_key_exists($keys[82], $arr)) {
            $this->setArtbcon2ccbatch($arr[$keys[82]]);
        }
        if (array_key_exists($keys[83], $arr)) {
            $this->setArtbcon2ccsavedays($arr[$keys[83]]);
        }
        if (array_key_exists($keys[84], $arr)) {
            $this->setArtbcon2aprvdccasdeposit($arr[$keys[84]]);
        }
        if (array_key_exists($keys[85], $arr)) {
            $this->setArtbcon2cmqtysign($arr[$keys[85]]);
        }
        if (array_key_exists($keys[86], $arr)) {
            $this->setArtbcon2bolline($arr[$keys[86]]);
        }
        if (array_key_exists($keys[87], $arr)) {
            $this->setArtbcon2bolcols($arr[$keys[87]]);
        }
        if (array_key_exists($keys[88], $arr)) {
            $this->setArtbcon2usesounitwght($arr[$keys[88]]);
        }
        if (array_key_exists($keys[89], $arr)) {
            $this->setArtbcon2delzbal($arr[$keys[89]]);
        }
        if (array_key_exists($keys[90], $arr)) {
            $this->setArtbconfstopcustchg($arr[$keys[90]]);
        }
        if (array_key_exists($keys[91], $arr)) {
            $this->setArtbcon2prospecteditcmm($arr[$keys[91]]);
        }
        if (array_key_exists($keys[92], $arr)) {
            $this->setArtbcon2prospectnotestocmm($arr[$keys[92]]);
        }
        if (array_key_exists($keys[93], $arr)) {
            $this->setArtbcon2ctrygetdflt($arr[$keys[93]]);
        }
        if (array_key_exists($keys[94], $arr)) {
            $this->setArtbconfrptbywhse($arr[$keys[94]]);
        }
        if (array_key_exists($keys[95], $arr)) {
            $this->setArtbconfappendpos($arr[$keys[95]]);
        }
        if (array_key_exists($keys[96], $arr)) {
            $this->setArtbconfincoasstacct($arr[$keys[96]]);
        }
        if (array_key_exists($keys[97], $arr)) {
            $this->setArtbconfincoliabacct($arr[$keys[97]]);
        }
        if (array_key_exists($keys[98], $arr)) {
            $this->setArtbcon2incoasstacct2($arr[$keys[98]]);
        }
        if (array_key_exists($keys[99], $arr)) {
            $this->setArtbcon2incoliabacct2($arr[$keys[99]]);
        }
        if (array_key_exists($keys[100], $arr)) {
            $this->setArtbcon2usesurchg($arr[$keys[100]]);
        }
        if (array_key_exists($keys[101], $arr)) {
            $this->setArtbcon2surchgitemid($arr[$keys[101]]);
        }
        if (array_key_exists($keys[102], $arr)) {
            $this->setArtbcon2surchgigrupseq($arr[$keys[102]]);
        }
        if (array_key_exists($keys[103], $arr)) {
            $this->setArtbcon2surchgsviaseq($arr[$keys[103]]);
        }
        if (array_key_exists($keys[104], $arr)) {
            $this->setArtbcon2surchgcstidseq($arr[$keys[104]]);
        }
        if (array_key_exists($keys[105], $arr)) {
            $this->setArtbcon2surchgcstpcseq($arr[$keys[105]]);
        }
        if (array_key_exists($keys[106], $arr)) {
            $this->setArtbconfzeroinvcline($arr[$keys[106]]);
        }
        if (array_key_exists($keys[107], $arr)) {
            $this->setArtbcon2zeroordrship($arr[$keys[107]]);
        }
        if (array_key_exists($keys[108], $arr)) {
            $this->setArtbcon2zeroordrmess($arr[$keys[108]]);
        }
        if (array_key_exists($keys[109], $arr)) {
            $this->setArtbconfcashacctwhse($arr[$keys[109]]);
        }
        if (array_key_exists($keys[110], $arr)) {
            $this->setArtbcon2mtaxfrtflagorcode($arr[$keys[110]]);
        }
        if (array_key_exists($keys[111], $arr)) {
            $this->setDateupdtd($arr[$keys[111]]);
        }
        if (array_key_exists($keys[112], $arr)) {
            $this->setTimeupdtd($arr[$keys[112]]);
        }
        if (array_key_exists($keys[113], $arr)) {
            $this->setDummy($arr[$keys[113]]);
        }
    }
