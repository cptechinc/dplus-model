...
abstract class ConfigIi implements ActiveRecordInterface
{
    ...
    public function setIitboptncode($v)
    {
        ...
        if ($this->iitboptncode !== $v) {
            $this->iitboptncode = $v;
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNCODE] = true;
        }
    ...
    public function setIitboptnactavail($v)
    {
        ...
        if ($this->iitboptnactavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNACTAVAIL] = true;
        }
    ...
    public function setIitboptnactwhse($v)
    {
        ...
        if ($this->iitboptnactwhse !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNACTWHSE] = true;
        }
    ...
    public function setIitboptnactdet($v)
    {
        ...
        if ($this->iitboptnactdet !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNACTDET] = true;
        }
    ...
    public function setIitboptnactdaysback($v)
    {
        ...
        if ($this->iitboptnactdaysback !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNACTDAYSBACK] = true;
        }
    ...
    public function setIitboptnactstrtdate($v)
    {
        ...
        if ($this->iitboptnactstrtdate !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNACTSTRTDATE] = true;
        }
    ...
    public function setIitboptncostavail($v)
    {
        ...
        if ($this->iitboptncostavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNCOSTAVAIL] = true;
        }
    ...
    public function setIitboptncostwhse($v)
    {
        ...
        if ($this->iitboptncostwhse !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNCOSTWHSE] = true;
        }
    ...
    public function setIitboptncostdet($v)
    {
        ...
        if ($this->iitboptncostdet !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNCOSTDET] = true;
        }
    ...
    public function setIitboptngenavail($v)
    {
        ...
        if ($this->iitboptngenavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNGENAVAIL] = true;
        }
    ...
    public function setIitboptnktavail($v)
    {
        ...
        if ($this->iitboptnktavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNKTAVAIL] = true;
        }
    ...
    public function setIitboptnpricavail($v)
    {
        ...
        if ($this->iitboptnpricavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNPRICAVAIL] = true;
        }
    ...
    public function setIitboptnphavail($v)
    {
        ...
        if ($this->iitboptnphavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNPHAVAIL] = true;
        }
    ...
    public function setIitboptnphwhse($v)
    {
        ...
        if ($this->iitboptnphwhse !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNPHWHSE] = true;
        }
    ...
    public function setIitboptnphdet($v)
    {
        ...
        if ($this->iitboptnphdet !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNPHDET] = true;
        }
    ...
    public function setIitboptnphdaysback($v)
    {
        ...
        if ($this->iitboptnphdaysback !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNPHDAYSBACK] = true;
        }
    ...
    public function setIitboptnphstrtdate($v)
    {
        ...
        if ($this->iitboptnphstrtdate !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNPHSTRTDATE] = true;
        }
    ...
    public function setIitboptnpoavail($v)
    {
        ...
        if ($this->iitboptnpoavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNPOAVAIL] = true;
        }
    ...
    public function setIitboptnpowhse($v)
    {
        ...
        if ($this->iitboptnpowhse !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNPOWHSE] = true;
        }
    ...
    public function setIitboptnreqravail($v)
    {
        ...
        if ($this->iitboptnreqravail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNREQRAVAIL] = true;
        }
    ...
    public function setIitboptnreqrwhse($v)
    {
        ...
        if ($this->iitboptnreqrwhse !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNREQRWHSE] = true;
        }
    ...
    public function setIitboptnreqrview($v)
    {
        ...
        if ($this->iitboptnreqrview !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNREQRVIEW] = true;
        }
    ...
    public function setIitboptnshavail($v)
    {
        ...
        if ($this->iitboptnshavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSHAVAIL] = true;
        }
    ...
    public function setIitboptnshwhse($v)
    {
        ...
        if ($this->iitboptnshwhse !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSHWHSE] = true;
        }
    ...
    public function setIitboptnshdet($v)
    {
        ...
        if ($this->iitboptnshdet !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSHDET] = true;
        }
    ...
    public function setIitboptnshdaysback($v)
    {
        ...
        if ($this->iitboptnshdaysback !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSHDAYSBACK] = true;
        }
    ...
    public function setIitboptnshstrtdate($v)
    {
        ...
        if ($this->iitboptnshstrtdate !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSHSTRTDATE] = true;
        }
    ...
    public function setIitboptnsoavail($v)
    {
        ...
        if ($this->iitboptnsoavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSOAVAIL] = true;
        }
    ...
    public function setIitboptnsowhse($v)
    {
        ...
        if ($this->iitboptnsowhse !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSOWHSE] = true;
        }
    ...
    public function setIitboptnserlotavail($v)
    {
        ...
        if ($this->iitboptnserlotavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSERLOTAVAIL] = true;
        }
    ...
    public function setIitboptnstckavail($v)
    {
        ...
        if ($this->iitboptnstckavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSTCKAVAIL] = true;
        }
    ...
    public function setIitboptnstckwhse($v)
    {
        ...
        if ($this->iitboptnstckwhse !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSTCKWHSE] = true;
        }
    ...
    public function setIitboptnstckdet($v)
    {
        ...
        if ($this->iitboptnstckdet !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSTCKDET] = true;
        }
    ...
    public function setIitboptnsubsupavail($v)
    {
        ...
        if ($this->iitboptnsubsupavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSUBSUPAVAIL] = true;
        }
    ...
    public function setIitboptnsubsupwhse($v)
    {
        ...
        if ($this->iitboptnsubsupwhse !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNSUBSUPWHSE] = true;
        }
    ...
    public function setIitboptnlsavail($v)
    {
        ...
        if ($this->iitboptnlsavail !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNLSAVAIL] = true;
        }
    ...
    public function setIitboptnlswhse($v)
    {
        ...
        if ($this->iitboptnlswhse !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNLSWHSE] = true;
        }
    ...
    public function setIitboptndesc1or2($v)
    {
        ...
        if ($this->iitboptndesc1or2 !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNDESC1OR2] = true;
        }
    ...
    public function setIitboptndelcerts($v)
    {
        ...
        if ($this->iitboptndelcerts !== $v) {
            ...
            $this->modifiedColumns[ConfigIiTableMap::COL_IITBOPTNDELCERTS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptncode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptncode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnactavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnactavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnactwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnactwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnactdet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnactdet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnactdaysback', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnactdaysback = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnactstrtdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnactstrtdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptncostavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptncostavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptncostwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptncostwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptncostdet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptncostdet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptngenavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptngenavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnktavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnktavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnpricavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnpricavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnphavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnphavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnphwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnphwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnphdet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnphdet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnphdaysback', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnphdaysback = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnphstrtdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnphstrtdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnpoavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnpoavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnpowhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnpowhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnreqravail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnreqravail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnreqrwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnreqrwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnreqrview', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnreqrview = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnshavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnshavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnshwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnshwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnshdet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnshdet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnshdaysback', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnshdaysback = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnshstrtdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnshstrtdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnsoavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnsoavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnsowhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnsowhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnserlotavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnserlotavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnstckavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnstckavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnstckwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnstckwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnstckdet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnstckdet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnsubsupavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnsubsupavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnsubsupwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnsubsupwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnlsavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnlsavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptnlswhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptnlswhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptndesc1or2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptndesc1or2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : ConfigIiTableMap::translateFieldName('Iitboptndelcerts', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iitboptndelcerts = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : ConfigIiTableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : ConfigIiTableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : ConfigIiTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 42; // 42 = ConfigIiTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNCODE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnCode';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNACTAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnActAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNACTWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnActWhse';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNACTDET)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnActDet';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNACTDAYSBACK)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnActDaysBack';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNACTSTRTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnActStrtDate';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNCOSTAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnCostAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNCOSTWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnCostWhse';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNCOSTDET)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnCostDet';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNGENAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnGenAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNKTAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnKtAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPRICAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnPricAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPHAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnPhAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPHWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnPhWhse';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPHDET)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnPhDet';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPHDAYSBACK)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnPhDaysBack';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPHSTRTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnPhStrtDate';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPOAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnPoAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPOWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnPoWhse';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNREQRAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnReqrAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNREQRWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnReqrWhse';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNREQRVIEW)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnReqrView';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSHAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnShAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSHWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnShWhse';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSHDET)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnShDet';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSHDAYSBACK)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnShDaysBack';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSHSTRTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnShStrtDate';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSOAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnSoAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSOWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnSoWhse';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSERLOTAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnSerlotAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSTCKAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnStckAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSTCKWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnStckWhse';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSTCKDET)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnStckDet';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSUBSUPAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnSubsupAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSUBSUPWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnSubsupWhse';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNLSAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnLsAvail';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNLSWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnLsWhse';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNDESC1OR2)) {
            $modifiedColumns[':p' . $index++]  = 'IitbOptnDesc1Or2';
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNDELCERTS)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNCODE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNCODE, $this->iitboptncode);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNACTAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNACTAVAIL, $this->iitboptnactavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNACTWHSE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNACTWHSE, $this->iitboptnactwhse);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNACTDET)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNACTDET, $this->iitboptnactdet);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNACTDAYSBACK)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNACTDAYSBACK, $this->iitboptnactdaysback);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNACTSTRTDATE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNACTSTRTDATE, $this->iitboptnactstrtdate);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNCOSTAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNCOSTAVAIL, $this->iitboptncostavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNCOSTWHSE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNCOSTWHSE, $this->iitboptncostwhse);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNCOSTDET)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNCOSTDET, $this->iitboptncostdet);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNGENAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNGENAVAIL, $this->iitboptngenavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNKTAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNKTAVAIL, $this->iitboptnktavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPRICAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNPRICAVAIL, $this->iitboptnpricavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPHAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNPHAVAIL, $this->iitboptnphavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPHWHSE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNPHWHSE, $this->iitboptnphwhse);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPHDET)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNPHDET, $this->iitboptnphdet);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPHDAYSBACK)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNPHDAYSBACK, $this->iitboptnphdaysback);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPHSTRTDATE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNPHSTRTDATE, $this->iitboptnphstrtdate);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPOAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNPOAVAIL, $this->iitboptnpoavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNPOWHSE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNPOWHSE, $this->iitboptnpowhse);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNREQRAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNREQRAVAIL, $this->iitboptnreqravail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNREQRWHSE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNREQRWHSE, $this->iitboptnreqrwhse);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNREQRVIEW)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNREQRVIEW, $this->iitboptnreqrview);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSHAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSHAVAIL, $this->iitboptnshavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSHWHSE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSHWHSE, $this->iitboptnshwhse);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSHDET)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSHDET, $this->iitboptnshdet);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSHDAYSBACK)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSHDAYSBACK, $this->iitboptnshdaysback);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSHSTRTDATE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSHSTRTDATE, $this->iitboptnshstrtdate);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSOAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSOAVAIL, $this->iitboptnsoavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSOWHSE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSOWHSE, $this->iitboptnsowhse);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSERLOTAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSERLOTAVAIL, $this->iitboptnserlotavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSTCKAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSTCKAVAIL, $this->iitboptnstckavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSTCKWHSE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSTCKWHSE, $this->iitboptnstckwhse);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSTCKDET)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSTCKDET, $this->iitboptnstckdet);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSUBSUPAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSUBSUPAVAIL, $this->iitboptnsubsupavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNSUBSUPWHSE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNSUBSUPWHSE, $this->iitboptnsubsupwhse);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNLSAVAIL)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNLSAVAIL, $this->iitboptnlsavail);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNLSWHSE)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNLSWHSE, $this->iitboptnlswhse);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNDESC1OR2)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNDESC1OR2, $this->iitboptndesc1or2);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_IITBOPTNDELCERTS)) {
            $criteria->add(ConfigIiTableMap::COL_IITBOPTNDELCERTS, $this->iitboptndelcerts);
        }
        if ($this->isColumnModified(ConfigIiTableMap::COL_DATEUPDTD)) {
