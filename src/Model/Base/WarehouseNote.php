...
/**
 * Base class that represents a row from the 'notes_whse_invc_stmt' table.
 *
 *
 *
...
abstract class WarehouseNote implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\WarehouseNoteTableMap';
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO notes_whse_invc_stmt (%s) VALUES (%s)',
