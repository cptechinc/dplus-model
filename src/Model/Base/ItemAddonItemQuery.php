 ...
 *
 * @method     ChildItemAddonItem|null findOne(?ConnectionInterface $con = null) Return the first ChildItemAddonItem matching the query
 ...
 *
 * @method     ChildItemAddonItem|null findOneByInititemnbr(string $InitItemNbr) Return the first ChildItemAddonItem filtered by the InitItemNbr column
 * @method     ChildItemAddonItem|null findOneByAdonadditemnbr(string $AdonAddItemNbr) Return the first ChildItemAddonItem filtered by the AdonAddItemNbr column
 * @method     ChildItemAddonItem|null findOneByDateupdtd(string $DateUpdtd) Return the first ChildItemAddonItem filtered by the DateUpdtd column
 * @method     ChildItemAddonItem|null findOneByTimeupdtd(string $TimeUpdtd) Return the first ChildItemAddonItem filtered by the TimeUpdtd column
 * @method     ChildItemAddonItem|null findOneByDummy(string $dummy) Return the first ChildItemAddonItem filtered by the dummy column
 *
 ...
 *
 * @method     ChildItemAddonItem[]|Collection find(?ConnectionInterface $con = null) Return ChildItemAddonItem objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildItemAddonItem> find(?ConnectionInterface $con = null) Return ChildItemAddonItem objects based on current ModelCriteria
 *
 * @method     ChildItemAddonItem[]|Collection findByInititemnbr(string|array<string> $InitItemNbr) Return ChildItemAddonItem objects filtered by the InitItemNbr column
 * @psalm-method Collection&\Traversable<ChildItemAddonItem> findByInititemnbr(string|array<string> $InitItemNbr) Return ChildItemAddonItem objects filtered by the InitItemNbr column
 * @method     ChildItemAddonItem[]|Collection findByAdonadditemnbr(string|array<string> $AdonAddItemNbr) Return ChildItemAddonItem objects filtered by the AdonAddItemNbr column
 * @psalm-method Collection&\Traversable<ChildItemAddonItem> findByAdonadditemnbr(string|array<string> $AdonAddItemNbr) Return ChildItemAddonItem objects filtered by the AdonAddItemNbr column
 * @method     ChildItemAddonItem[]|Collection findByDateupdtd(string|array<string> $DateUpdtd) Return ChildItemAddonItem objects filtered by the DateUpdtd column
 * @psalm-method Collection&\Traversable<ChildItemAddonItem> findByDateupdtd(string|array<string> $DateUpdtd) Return ChildItemAddonItem objects filtered by the DateUpdtd column
 * @method     ChildItemAddonItem[]|Collection findByTimeupdtd(string|array<string> $TimeUpdtd) Return ChildItemAddonItem objects filtered by the TimeUpdtd column
 * @psalm-method Collection&\Traversable<ChildItemAddonItem> findByTimeupdtd(string|array<string> $TimeUpdtd) Return ChildItemAddonItem objects filtered by the TimeUpdtd column
 * @method     ChildItemAddonItem[]|Collection findByDummy(string|array<string> $dummy) Return ChildItemAddonItem objects filtered by the dummy column
 * @psalm-method Collection&\Traversable<ChildItemAddonItem> findByDummy(string|array<string> $dummy) Return ChildItemAddonItem objects filtered by the dummy column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildItemAddonItem> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class ItemAddonItemQuery extends ModelCriteria
{
    ...
    public function filterByInititemnbr($inititemnbr = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ItemAddonItemTableMap::COL_INITITEMNBR, $inititemnbr, $comparison);
     ...
     * $query->filterByAdonadditemnbr(['foo', 'bar']); // WHERE AdonAddItemNbr IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $adonadditemnbr The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByAdonadditemnbr($adonadditemnbr = null, ?string $comparison = null)
    {
        if (null === $comparison) {
        ...
        $this->addUsingAlias(ItemAddonItemTableMap::COL_ADONADDITEMNBR, $adonadditemnbr, $comparison);
    ...
    public function filterByDateupdtd($dateupdtd = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ItemAddonItemTableMap::COL_DATEUPDTD, $dateupdtd, $comparison);
    ...
    public function filterByTimeupdtd($timeupdtd = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ItemAddonItemTableMap::COL_TIMEUPDTD, $timeupdtd, $comparison);
    ...
    public function filterByDummy($dummy = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ItemAddonItemTableMap::COL_DUMMY, $dummy, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByItemMasterItemRelatedByAdonadditemnbr($itemMasterItem, ?string $comparison = null)
    {
        if ($itemMasterItem instanceof \ItemMasterItem) {
            return $this
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinItemMasterItemRelatedByAdonadditemnbr(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     * @return $this
     */
    public function withItemMasterItemRelatedByAdonadditemnbrQuery(
        callable $callable,
        string $relationAlias = null,
        ?string $joinType = Criteria::INNER_JOIN
    ) {
        $relatedQuery = $this->useItemMasterItemRelatedByAdonadditemnbrQuery(
            $relationAlias,
            $joinType
        );
        $callable($relatedQuery);
    ...
    /**
     * Use the ItemMasterItemRelatedByAdonadditemnbr relation to the ItemMasterItem table for an EXISTS query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @return \ItemMasterItemQuery The inner query object of the EXISTS statement
     */
    public function useItemMasterItemRelatedByAdonadditemnbrExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \ItemMasterItemQuery */
        $q = $this->useExistsQuery('ItemMasterItemRelatedByAdonadditemnbr', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the ItemMasterItemRelatedByAdonadditemnbr relation to the ItemMasterItem table for a NOT EXISTS query.
     *
     * @see useItemMasterItemRelatedByAdonadditemnbrExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \ItemMasterItemQuery The inner query object of the NOT EXISTS statement
     */
    public function useItemMasterItemRelatedByAdonadditemnbrNotExistsQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \ItemMasterItemQuery */
        $q = $this->useExistsQuery('ItemMasterItemRelatedByAdonadditemnbr', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the ItemMasterItemRelatedByAdonadditemnbr relation to the ItemMasterItem table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @return \ItemMasterItemQuery The inner query object of the IN statement
     */
    public function useInItemMasterItemRelatedByAdonadditemnbrQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \ItemMasterItemQuery */
        $q = $this->useInQuery('ItemMasterItemRelatedByAdonadditemnbr', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the ItemMasterItemRelatedByAdonadditemnbr relation to the ItemMasterItem table for a NOT IN query.
     *
     * @see useItemMasterItemRelatedByAdonadditemnbrInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \ItemMasterItemQuery The inner query object of the NOT IN statement
     */
    public function useNotInItemMasterItemRelatedByAdonadditemnbrQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \ItemMasterItemQuery */
        $q = $this->useInQuery('ItemMasterItemRelatedByAdonadditemnbr', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
