 ...
 * @method     ChildConfigSalesOrderQuery orderByOetbcon3zeroprcitmpdm($order = Criteria::ASC) Order by the OetbCon3ZeroPrcItmPdm column
 ...
 * @method     ChildConfigSalesOrderQuery groupByOetbcon3zeroprcitmpdm() Group by the OetbCon3ZeroPrcItmPdm column
 ...
 * @method     ChildConfigSalesOrder findOneByOetbcon3zeroprcitmpdm(string $OetbCon3ZeroPrcItmPdm) Return the first ChildConfigSalesOrder filtered by the OetbCon3ZeroPrcItmPdm column
 ...
 * @method     ChildConfigSalesOrder requireOneByOetbcon3zeroprcitmpdm(string $OetbCon3ZeroPrcItmPdm) Return the first ChildConfigSalesOrder filtered by the OetbCon3ZeroPrcItmPdm column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildConfigSalesOrder[]|ObjectCollection findByOetbcon3zeroprcitmpdm(string $OetbCon3ZeroPrcItmPdm) Return ChildConfigSalesOrder objects filtered by the OetbCon3ZeroPrcItmPdm column
...
abstract class ConfigSalesOrderQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query on the OetbCon3ZeroPrcItmPdm column
     *
     * Example usage:
     * <code>
     * $query->filterByOetbcon3zeroprcitmpdm('fooValue');   // WHERE OetbCon3ZeroPrcItmPdm = 'fooValue'
     * $query->filterByOetbcon3zeroprcitmpdm('%fooValue%', Criteria::LIKE); // WHERE OetbCon3ZeroPrcItmPdm LIKE '%fooValue%'
     * </code>
     *
     * @param     string $oetbcon3zeroprcitmpdm The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildConfigSalesOrderQuery The current query, for fluid interface
     */
    public function filterByOetbcon3zeroprcitmpdm($oetbcon3zeroprcitmpdm = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($oetbcon3zeroprcitmpdm)) {
                $comparison = Criteria::IN;
            }
        }

        return $this->addUsingAlias(ConfigSalesOrderTableMap::COL_OETBCON3ZEROPRCITMPDM, $oetbcon3zeroprcitmpdm, $comparison);
    }
