...
use Base\ArStandardIndustrialClassQuery as BaseArStandardIndustrialClassQuery;
 ...
 *
 */
class ArStandardIndustrialClassQuery extends BaseArStandardIndustrialClassQuery {
	use QueryTraits;
}
