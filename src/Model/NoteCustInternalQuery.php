...
use Base\NoteCustInternalQuery as BaseNoteCustInternalQuery;
 ...
 * -----------------------------------------------------------------------------------------
 * FilterByXXX()
 * @method  NoteCustInternalQuery filterByCustid(string $id)      Filter the query by the arcucustid column
 * FindOneByXXX()
 * 
 * FindByXXX()
 *
 *
 */
class NoteCustInternalQuery extends BaseNoteCustInternalQuery {
	use QueryTraits;
