...
class SalespersonGroupCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.SalespersonGroupCodeTableMap';
     ...
     */
    const TABLE_NAME = 'ar_cust_spgp';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\SalespersonGroupCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'SalespersonGroupCode';
     ...
     */
    const COL_ARTBSPGPCODE = 'ar_cust_spgp.ArtbSpgpCode';

    /**
     * the column name for the ArtbSpgpDesc field
     */
    const COL_ARTBSPGPDESC = 'ar_cust_spgp.ArtbSpgpDesc';

    /**
     * the column name for the DateUpdtd field
     */
    const COL_DATEUPDTD = 'ar_cust_spgp.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    const COL_TIMEUPDTD = 'ar_cust_spgp.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    const COL_DUMMY = 'ar_cust_spgp.dummy';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Artbspgpcode', 'Artbspgpdesc', 'Dateupdtd', 'Timeupdtd', 'Dummy', ),
        self::TYPE_CAMELNAME     => array('artbspgpcode', 'artbspgpdesc', 'dateupdtd', 'timeupdtd', 'dummy', ),
        self::TYPE_COLNAME       => array(SalespersonGroupCodeTableMap::COL_ARTBSPGPCODE, SalespersonGroupCodeTableMap::COL_ARTBSPGPDESC, SalespersonGroupCodeTableMap::COL_DATEUPDTD, SalespersonGroupCodeTableMap::COL_TIMEUPDTD, SalespersonGroupCodeTableMap::COL_DUMMY, ),
        self::TYPE_FIELDNAME     => array('ArtbSpgpCode', 'ArtbSpgpDesc', 'DateUpdtd', 'TimeUpdtd', 'dummy', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Artbspgpcode' => 0, 'Artbspgpdesc' => 1, 'Dateupdtd' => 2, 'Timeupdtd' => 3, 'Dummy' => 4, ),
        self::TYPE_CAMELNAME     => array('artbspgpcode' => 0, 'artbspgpdesc' => 1, 'dateupdtd' => 2, 'timeupdtd' => 3, 'dummy' => 4, ),
        self::TYPE_COLNAME       => array(SalespersonGroupCodeTableMap::COL_ARTBSPGPCODE => 0, SalespersonGroupCodeTableMap::COL_ARTBSPGPDESC => 1, SalespersonGroupCodeTableMap::COL_DATEUPDTD => 2, SalespersonGroupCodeTableMap::COL_TIMEUPDTD => 3, SalespersonGroupCodeTableMap::COL_DUMMY => 4, ),
        self::TYPE_FIELDNAME     => array('ArtbSpgpCode' => 0, 'ArtbSpgpDesc' => 1, 'DateUpdtd' => 2, 'TimeUpdtd' => 3, 'dummy' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SalespersonGroupCodeTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SalespersonGroupCodeTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SalespersonGroupCodeTableMap());
        }
    }
...
} // SalespersonGroupCodeTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
SalespersonGroupCodeTableMap::buildTableMap();
