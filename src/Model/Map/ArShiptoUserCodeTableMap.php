...
class ArShiptoUserCodeTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.ArShiptoUserCodeTableMap';
     ...
     */
    public const TABLE_NAME = 'ar_cust_susr';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'ArShiptoUserCode';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\ArShiptoUserCode';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'ArShiptoUserCode';
     ...
     */
    public const COL_ARTBSUSRCODE = 'ar_cust_susr.ArtbSusrCode';

    /**
     * the column name for the ArtbSusrDesc field
     */
    public const COL_ARTBSUSRDESC = 'ar_cust_susr.ArtbSusrDesc';

    /**
     * the column name for the DateUpdtd field
     */
    public const COL_DATEUPDTD = 'ar_cust_susr.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    public const COL_TIMEUPDTD = 'ar_cust_susr.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    public const COL_DUMMY = 'ar_cust_susr.dummy';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Artbsusrcode', 'Artbsusrdesc', 'Dateupdtd', 'Timeupdtd', 'Dummy', ],
        self::TYPE_CAMELNAME     => ['artbsusrcode', 'artbsusrdesc', 'dateupdtd', 'timeupdtd', 'dummy', ],
        self::TYPE_COLNAME       => [ArShiptoUserCodeTableMap::COL_ARTBSUSRCODE, ArShiptoUserCodeTableMap::COL_ARTBSUSRDESC, ArShiptoUserCodeTableMap::COL_DATEUPDTD, ArShiptoUserCodeTableMap::COL_TIMEUPDTD, ArShiptoUserCodeTableMap::COL_DUMMY, ],
        self::TYPE_FIELDNAME     => ['ArtbSusrCode', 'ArtbSusrDesc', 'DateUpdtd', 'TimeUpdtd', 'dummy', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Artbsusrcode' => 0, 'Artbsusrdesc' => 1, 'Dateupdtd' => 2, 'Timeupdtd' => 3, 'Dummy' => 4, ],
        self::TYPE_CAMELNAME     => ['artbsusrcode' => 0, 'artbsusrdesc' => 1, 'dateupdtd' => 2, 'timeupdtd' => 3, 'dummy' => 4, ],
        self::TYPE_COLNAME       => [ArShiptoUserCodeTableMap::COL_ARTBSUSRCODE => 0, ArShiptoUserCodeTableMap::COL_ARTBSUSRDESC => 1, ArShiptoUserCodeTableMap::COL_DATEUPDTD => 2, ArShiptoUserCodeTableMap::COL_TIMEUPDTD => 3, ArShiptoUserCodeTableMap::COL_DUMMY => 4, ],
        self::TYPE_FIELDNAME     => ['ArtbSusrCode' => 0, 'ArtbSusrDesc' => 1, 'DateUpdtd' => 2, 'TimeUpdtd' => 3, 'dummy' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        'Artbsusrcode' => 'ARTBSUSRCODE',
        'ArShiptoUserCode.Artbsusrcode' => 'ARTBSUSRCODE',
        'artbsusrcode' => 'ARTBSUSRCODE',
        'arShiptoUserCode.artbsusrcode' => 'ARTBSUSRCODE',
        'ArShiptoUserCodeTableMap::COL_ARTBSUSRCODE' => 'ARTBSUSRCODE',
        'COL_ARTBSUSRCODE' => 'ARTBSUSRCODE',
        'ArtbSusrCode' => 'ARTBSUSRCODE',
        'ar_cust_susr.ArtbSusrCode' => 'ARTBSUSRCODE',
        'Artbsusrdesc' => 'ARTBSUSRDESC',
        'ArShiptoUserCode.Artbsusrdesc' => 'ARTBSUSRDESC',
        'artbsusrdesc' => 'ARTBSUSRDESC',
        'arShiptoUserCode.artbsusrdesc' => 'ARTBSUSRDESC',
        'ArShiptoUserCodeTableMap::COL_ARTBSUSRDESC' => 'ARTBSUSRDESC',
        'COL_ARTBSUSRDESC' => 'ARTBSUSRDESC',
        'ArtbSusrDesc' => 'ARTBSUSRDESC',
        'ar_cust_susr.ArtbSusrDesc' => 'ARTBSUSRDESC',
        'Dateupdtd' => 'DATEUPDTD',
        'ArShiptoUserCode.Dateupdtd' => 'DATEUPDTD',
        'dateupdtd' => 'DATEUPDTD',
        'arShiptoUserCode.dateupdtd' => 'DATEUPDTD',
        'ArShiptoUserCodeTableMap::COL_DATEUPDTD' => 'DATEUPDTD',
        'COL_DATEUPDTD' => 'DATEUPDTD',
        'DateUpdtd' => 'DATEUPDTD',
        'ar_cust_susr.DateUpdtd' => 'DATEUPDTD',
        'Timeupdtd' => 'TIMEUPDTD',
        'ArShiptoUserCode.Timeupdtd' => 'TIMEUPDTD',
        'timeupdtd' => 'TIMEUPDTD',
        'arShiptoUserCode.timeupdtd' => 'TIMEUPDTD',
        'ArShiptoUserCodeTableMap::COL_TIMEUPDTD' => 'TIMEUPDTD',
        'COL_TIMEUPDTD' => 'TIMEUPDTD',
        'TimeUpdtd' => 'TIMEUPDTD',
        'ar_cust_susr.TimeUpdtd' => 'TIMEUPDTD',
        'Dummy' => 'DUMMY',
        'ArShiptoUserCode.Dummy' => 'DUMMY',
        'dummy' => 'DUMMY',
        'arShiptoUserCode.dummy' => 'DUMMY',
        'ArShiptoUserCodeTableMap::COL_DUMMY' => 'DUMMY',
        'COL_DUMMY' => 'DUMMY',
        'ar_cust_susr.dummy' => 'DUMMY',
    ];
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(ArShiptoUserCodeTableMap::COL_ARTBSUSRCODE);
            $criteria->removeSelectColumn(ArShiptoUserCodeTableMap::COL_ARTBSUSRDESC);
            $criteria->removeSelectColumn(ArShiptoUserCodeTableMap::COL_DATEUPDTD);
            $criteria->removeSelectColumn(ArShiptoUserCodeTableMap::COL_TIMEUPDTD);
            $criteria->removeSelectColumn(ArShiptoUserCodeTableMap::COL_DUMMY);
        } else {
            $criteria->removeSelectColumn($alias . '.ArtbSusrCode');
            $criteria->removeSelectColumn($alias . '.ArtbSusrDesc');
