...
class ArWriteOffCodeTableMap extends TableMap
{
     ...
     */
    const COL_ARTBWOFFCODE = 'ar_cust_woff.ArtbWoffCode';
     ...
     */
    const COL_DATEUPDTD = 'ar_cust_woff.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    const COL_TIMEUPDTD = 'ar_cust_woff.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    const COL_DUMMY = 'ar_cust_woff.dummy';
