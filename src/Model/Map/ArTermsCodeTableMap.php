...
class ArTermsCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.ArTermsCodeTableMap';
     ...
     */
    const OM_CLASS = '\\ArTermsCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ArTermsCode';
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(ArTermsCodeTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(ArTermsCodeTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new ArTermsCodeTableMap());
        }
    }
...
//
ArTermsCodeTableMap::buildTableMap();
