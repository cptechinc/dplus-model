...
class SalesHistoryNotesTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(SalesHistoryNotesTableMap::COL_QNTYPE, SalesHistoryNotesTableMap::COL_QNTYPEDESC, SalesHistoryNotesTableMap::COL_OEHDNBR, SalesHistoryNotesTableMap::COL_OEDTLINE, SalesHistoryNotesTableMap::COL_QNORDRLOTSER, SalesHistoryNotesTableMap::COL_QNORDRPICKTICKET, SalesHistoryNotesTableMap::COL_QNORDRPACKTICKET, SalesHistoryNotesTableMap::COL_QNORDRINVOICE, SalesHistoryNotesTableMap::COL_QNORDRACKNOW, SalesHistoryNotesTableMap::COL_QNSEQ, SalesHistoryNotesTableMap::COL_QNNOTE, SalesHistoryNotesTableMap::COL_QNKEY2, SalesHistoryNotesTableMap::COL_QNFORM, SalesHistoryNotesTableMap::COL_DATEUPDTD, SalesHistoryNotesTableMap::COL_TIMEUPDTD, SalesHistoryNotesTableMap::COL_DUMMY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(SalesHistoryNotesTableMap::COL_QNTYPE => 0, SalesHistoryNotesTableMap::COL_QNTYPEDESC => 1, SalesHistoryNotesTableMap::COL_OEHDNBR => 2, SalesHistoryNotesTableMap::COL_OEDTLINE => 3, SalesHistoryNotesTableMap::COL_QNORDRLOTSER => 4, SalesHistoryNotesTableMap::COL_QNORDRPICKTICKET => 5, SalesHistoryNotesTableMap::COL_QNORDRPACKTICKET => 6, SalesHistoryNotesTableMap::COL_QNORDRINVOICE => 7, SalesHistoryNotesTableMap::COL_QNORDRACKNOW => 8, SalesHistoryNotesTableMap::COL_QNSEQ => 9, SalesHistoryNotesTableMap::COL_QNNOTE => 10, SalesHistoryNotesTableMap::COL_QNKEY2 => 11, SalesHistoryNotesTableMap::COL_QNFORM => 12, SalesHistoryNotesTableMap::COL_DATEUPDTD => 13, SalesHistoryNotesTableMap::COL_TIMEUPDTD => 14, SalesHistoryNotesTableMap::COL_DUMMY => 15, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_QNTYPE);
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_QNTYPEDESC);
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_OEHDNBR);
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_OEDTLINE);
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_QNORDRLOTSER);
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_QNORDRPICKTICKET);
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_QNORDRPACKTICKET);
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_QNORDRINVOICE);
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_QNORDRACKNOW);
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_QNSEQ);
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_QNNOTE);
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_QNKEY2);
            $criteria->addSelectColumn(SalesHistoryNotesTableMap::COL_QNFORM);
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(SalesHistoryNotesTableMap::COL_QNTYPE, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(SalesHistoryNotesTableMap::COL_QNSEQ, $value[1]));
                $criterion->addAnd($criteria->getNewCriterion(SalesHistoryNotesTableMap::COL_QNKEY2, $value[2]));
                $criterion->addAnd($criteria->getNewCriterion(SalesHistoryNotesTableMap::COL_QNFORM, $value[3]));
