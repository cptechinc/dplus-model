...
class TaxCodeZipTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.TaxCodeZipTableMap';
     ...
     */
    const TABLE_NAME = 'ar_cust_txzp';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\TaxCodeZip';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TaxCodeZip';
     ...
     */
    const COL_ARTBZIPCODE = 'ar_cust_txzp.ArtbZipCode';

    /**
     * the column name for the ArtbTxzpTaxCode field
     */
    const COL_ARTBTXZPTAXCODE = 'ar_cust_txzp.ArtbTxzpTaxCode';

    /**
     * the column name for the DateUpdtd field
     */
    const COL_DATEUPDTD = 'ar_cust_txzp.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    const COL_TIMEUPDTD = 'ar_cust_txzp.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    const COL_DUMMY = 'ar_cust_txzp.dummy';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Artbzipcode', 'Artbtxzptaxcode', 'Dateupdtd', 'Timeupdtd', 'Dummy', ),
        self::TYPE_CAMELNAME     => array('artbzipcode', 'artbtxzptaxcode', 'dateupdtd', 'timeupdtd', 'dummy', ),
        self::TYPE_COLNAME       => array(TaxCodeZipTableMap::COL_ARTBZIPCODE, TaxCodeZipTableMap::COL_ARTBTXZPTAXCODE, TaxCodeZipTableMap::COL_DATEUPDTD, TaxCodeZipTableMap::COL_TIMEUPDTD, TaxCodeZipTableMap::COL_DUMMY, ),
        self::TYPE_FIELDNAME     => array('ArtbZipCode', 'ArtbTxzpTaxCode', 'DateUpdtd', 'TimeUpdtd', 'dummy', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Artbzipcode' => 0, 'Artbtxzptaxcode' => 1, 'Dateupdtd' => 2, 'Timeupdtd' => 3, 'Dummy' => 4, ),
        self::TYPE_CAMELNAME     => array('artbzipcode' => 0, 'artbtxzptaxcode' => 1, 'dateupdtd' => 2, 'timeupdtd' => 3, 'dummy' => 4, ),
        self::TYPE_COLNAME       => array(TaxCodeZipTableMap::COL_ARTBZIPCODE => 0, TaxCodeZipTableMap::COL_ARTBTXZPTAXCODE => 1, TaxCodeZipTableMap::COL_DATEUPDTD => 2, TaxCodeZipTableMap::COL_TIMEUPDTD => 3, TaxCodeZipTableMap::COL_DUMMY => 4, ),
        self::TYPE_FIELDNAME     => array('ArtbZipCode' => 0, 'ArtbTxzpTaxCode' => 1, 'DateUpdtd' => 2, 'TimeUpdtd' => 3, 'dummy' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(TaxCodeZipTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(TaxCodeZipTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new TaxCodeZipTableMap());
        }
    }
...
//
TaxCodeZipTableMap::buildTableMap();
