...
class SoReasonCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.SoReasonCodeTableMap';
     ...
     */
    const TABLE_NAME = 'so_reas_code';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\SoReasonCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'SoReasonCode';
     ...
     */
    const COL_OETBREASCODE = 'so_reas_code.OetbReasCode';

    /**
     * the column name for the OetbReasDesc field
     */
    const COL_OETBREASDESC = 'so_reas_code.OetbReasDesc';

    /**
     * the column name for the DateUpdtd field
     */
    const COL_DATEUPDTD = 'so_reas_code.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    const COL_TIMEUPDTD = 'so_reas_code.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    const COL_DUMMY = 'so_reas_code.dummy';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Oetbreascode', 'Oetbreasdesc', 'Dateupdtd', 'Timeupdtd', 'Dummy', ),
        self::TYPE_CAMELNAME     => array('oetbreascode', 'oetbreasdesc', 'dateupdtd', 'timeupdtd', 'dummy', ),
        self::TYPE_COLNAME       => array(SoReasonCodeTableMap::COL_OETBREASCODE, SoReasonCodeTableMap::COL_OETBREASDESC, SoReasonCodeTableMap::COL_DATEUPDTD, SoReasonCodeTableMap::COL_TIMEUPDTD, SoReasonCodeTableMap::COL_DUMMY, ),
        self::TYPE_FIELDNAME     => array('OetbReasCode', 'OetbReasDesc', 'DateUpdtd', 'TimeUpdtd', 'dummy', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Oetbreascode' => 0, 'Oetbreasdesc' => 1, 'Dateupdtd' => 2, 'Timeupdtd' => 3, 'Dummy' => 4, ),
        self::TYPE_CAMELNAME     => array('oetbreascode' => 0, 'oetbreasdesc' => 1, 'dateupdtd' => 2, 'timeupdtd' => 3, 'dummy' => 4, ),
        self::TYPE_COLNAME       => array(SoReasonCodeTableMap::COL_OETBREASCODE => 0, SoReasonCodeTableMap::COL_OETBREASDESC => 1, SoReasonCodeTableMap::COL_DATEUPDTD => 2, SoReasonCodeTableMap::COL_TIMEUPDTD => 3, SoReasonCodeTableMap::COL_DUMMY => 4, ),
        self::TYPE_FIELDNAME     => array('OetbReasCode' => 0, 'OetbReasDesc' => 1, 'DateUpdtd' => 2, 'TimeUpdtd' => 3, 'dummy' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SoReasonCodeTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SoReasonCodeTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SoReasonCodeTableMap());
        }
    }
...
} // SoReasonCodeTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
SoReasonCodeTableMap::buildTableMap();
