...
class ArCommissionCodeTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.ArCommissionCodeTableMap';
     ...
     */
    public const TABLE_NAME = 'ar_cust_comm';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'ArCommissionCode';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\ArCommissionCode';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'ArCommissionCode';
     ...
     */
    public const COL_ARTBCOMMCODE = 'ar_cust_comm.ArtbCommCode';

    /**
     * the column name for the ArtbCommDesc field
     */
    public const COL_ARTBCOMMDESC = 'ar_cust_comm.ArtbCommDesc';

    /**
     * the column name for the DateUpdtd field
     */
    public const COL_DATEUPDTD = 'ar_cust_comm.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    public const COL_TIMEUPDTD = 'ar_cust_comm.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    public const COL_DUMMY = 'ar_cust_comm.dummy';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Artbcommcode', 'Artbcommdesc', 'Dateupdtd', 'Timeupdtd', 'Dummy', ],
        self::TYPE_CAMELNAME     => ['artbcommcode', 'artbcommdesc', 'dateupdtd', 'timeupdtd', 'dummy', ],
        self::TYPE_COLNAME       => [ArCommissionCodeTableMap::COL_ARTBCOMMCODE, ArCommissionCodeTableMap::COL_ARTBCOMMDESC, ArCommissionCodeTableMap::COL_DATEUPDTD, ArCommissionCodeTableMap::COL_TIMEUPDTD, ArCommissionCodeTableMap::COL_DUMMY, ],
        self::TYPE_FIELDNAME     => ['ArtbCommCode', 'ArtbCommDesc', 'DateUpdtd', 'TimeUpdtd', 'dummy', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Artbcommcode' => 0, 'Artbcommdesc' => 1, 'Dateupdtd' => 2, 'Timeupdtd' => 3, 'Dummy' => 4, ],
        self::TYPE_CAMELNAME     => ['artbcommcode' => 0, 'artbcommdesc' => 1, 'dateupdtd' => 2, 'timeupdtd' => 3, 'dummy' => 4, ],
        self::TYPE_COLNAME       => [ArCommissionCodeTableMap::COL_ARTBCOMMCODE => 0, ArCommissionCodeTableMap::COL_ARTBCOMMDESC => 1, ArCommissionCodeTableMap::COL_DATEUPDTD => 2, ArCommissionCodeTableMap::COL_TIMEUPDTD => 3, ArCommissionCodeTableMap::COL_DUMMY => 4, ],
        self::TYPE_FIELDNAME     => ['ArtbCommCode' => 0, 'ArtbCommDesc' => 1, 'DateUpdtd' => 2, 'TimeUpdtd' => 3, 'dummy' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'ArCommissionCode.Artbcommcode' => 'ARTBCOMMCODE',
        'artbcommcode' => 'ARTBCOMMCODE',
        'arCommissionCode.artbcommcode' => 'ARTBCOMMCODE',
        'ArCommissionCodeTableMap::COL_ARTBCOMMCODE' => 'ARTBCOMMCODE',
        'COL_ARTBCOMMCODE' => 'ARTBCOMMCODE',
        'ArtbCommCode' => 'ARTBCOMMCODE',
        'ar_cust_comm.ArtbCommCode' => 'ARTBCOMMCODE',
        'Artbcommdesc' => 'ARTBCOMMDESC',
        'ArCommissionCode.Artbcommdesc' => 'ARTBCOMMDESC',
        'artbcommdesc' => 'ARTBCOMMDESC',
        'arCommissionCode.artbcommdesc' => 'ARTBCOMMDESC',
        'ArCommissionCodeTableMap::COL_ARTBCOMMDESC' => 'ARTBCOMMDESC',
        'COL_ARTBCOMMDESC' => 'ARTBCOMMDESC',
        'ArtbCommDesc' => 'ARTBCOMMDESC',
        'ar_cust_comm.ArtbCommDesc' => 'ARTBCOMMDESC',
        'Dateupdtd' => 'DATEUPDTD',
        'ArCommissionCode.Dateupdtd' => 'DATEUPDTD',
        'dateupdtd' => 'DATEUPDTD',
        'arCommissionCode.dateupdtd' => 'DATEUPDTD',
        'ArCommissionCodeTableMap::COL_DATEUPDTD' => 'DATEUPDTD',
        'COL_DATEUPDTD' => 'DATEUPDTD',
        'DateUpdtd' => 'DATEUPDTD',
        'ar_cust_comm.DateUpdtd' => 'DATEUPDTD',
        'Timeupdtd' => 'TIMEUPDTD',
        'ArCommissionCode.Timeupdtd' => 'TIMEUPDTD',
        'timeupdtd' => 'TIMEUPDTD',
        'arCommissionCode.timeupdtd' => 'TIMEUPDTD',
        'ArCommissionCodeTableMap::COL_TIMEUPDTD' => 'TIMEUPDTD',
        'COL_TIMEUPDTD' => 'TIMEUPDTD',
        'TimeUpdtd' => 'TIMEUPDTD',
        'ar_cust_comm.TimeUpdtd' => 'TIMEUPDTD',
        'Dummy' => 'DUMMY',
        'ArCommissionCode.Dummy' => 'DUMMY',
        'dummy' => 'DUMMY',
        'arCommissionCode.dummy' => 'DUMMY',
        'ArCommissionCodeTableMap::COL_DUMMY' => 'DUMMY',
        'COL_DUMMY' => 'DUMMY',
        'ar_cust_comm.dummy' => 'DUMMY',
    ];
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(ArCommissionCodeTableMap::COL_ARTBCOMMCODE);
            $criteria->removeSelectColumn(ArCommissionCodeTableMap::COL_ARTBCOMMDESC);
            $criteria->removeSelectColumn(ArCommissionCodeTableMap::COL_DATEUPDTD);
            $criteria->removeSelectColumn(ArCommissionCodeTableMap::COL_TIMEUPDTD);
            $criteria->removeSelectColumn(ArCommissionCodeTableMap::COL_DUMMY);
        } else {
            $criteria->removeSelectColumn($alias . '.ArtbCommCode');
            $criteria->removeSelectColumn($alias . '.ArtbCommDesc');
