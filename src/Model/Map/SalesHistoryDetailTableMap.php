...
class SalesHistoryDetailTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('OedhRqstDate', 'Oedhrqstdate', 'CHAR', true, 8, '');
        $this->addColumn('OedhCancDate', 'Oedhcancdate', 'CHAR', true, 8, '');
        ...
        $this->addColumn('OedhAcDisc1', 'Oedhacdisc1', 'CHAR', true, null, '');
        $this->addColumn('OedhAcDisc2', 'Oedhacdisc2', 'CHAR', true, null, '');
        ...
        $this->addColumn('OedhUseCode', 'Oedhusecode', 'CHAR', true, null, '');
        $this->addColumn('OedhNsShipFromId', 'Oedhnsshipfromid', 'VARCHAR', true, 6, '');
        $this->addColumn('OedhAsstOvrd', 'Oedhasstovrd', 'CHAR', true, null, 'N');
        ...
        $this->addColumn('OedhOrigLine', 'Oedhorigline', 'INTEGER', true, 5, 0);
        $this->addColumn('OedhCustCrssRef', 'Oedhcustcrssref', 'VARCHAR', true, 30, '');
        $this->addColumn('OedhUom', 'Oedhuom', 'VARCHAR', true, 4, '');
        ...
        $this->addColumn('OedhOrigItem', 'Oedhorigitem', 'VARCHAR', true, 30, '');
        $this->addColumn('OedhSubFlag', 'Oedhsubflag', 'CHAR', true, null, '');
        $this->addColumn('OedhEdiIncomingSeq', 'Oedhediincomingseq', 'INTEGER', true, 3, 0);
        ...
        $this->addColumn('OedhCoreFlag', 'Oedhcoreflag', 'CHAR', true, null, 'N');
        $this->addColumn('OedhNsSalesAcct', 'Oedhnssalesacct', 'VARCHAR', true, 9, '');
        $this->addColumn('OedhCertReqd', 'Oedhcertreqd', 'CHAR', true, null, 'N');
        $this->addColumn('OedhAddOnSales', 'Oedhaddonsales', 'CHAR', true, null, 'N');
        $this->addColumn('OedhBordFlag', 'Oedhbordflag', 'CHAR', true, null, 'N');
        $this->addColumn('OedhTempGrove', 'Oedhtempgrove', 'CHAR', true, null, '');
        $this->addColumn('OedhGroveDisc', 'Oedhgrovedisc', 'CHAR', true, null, '');
        $this->addColumn('OedhOffInvc', 'Oedhoffinvc', 'CHAR', true, null, '');
        ...
        $this->addColumn('OedhOrigRqstDate', 'Oedhorigrqstdate', 'CHAR', true, 8, '');
        $this->addColumn('OedhFabLock', 'Oedhfablock', 'CHAR', true, null, '');
        $this->addColumn('OedhLabelPrinted', 'Oedhlabelprinted', 'CHAR', true, null, '');
        $this->addColumn('OedhQuoteId', 'Oedhquoteid', 'VARCHAR', true, 8, '');
        $this->addColumn('OedhInvPrinted', 'Oedhinvprinted', 'CHAR', true, null, '');
        $this->addColumn('OedhStockCheck', 'Oedhstockcheck', 'CHAR', true, null, '');
        $this->addColumn('OedhShouldWeSplit', 'Oedhshouldwesplit', 'CHAR', true, null, '');
        $this->addColumn('OedhCofcReqd', 'Oedhcofcreqd', 'CHAR', true, null, 'N');
        $this->addColumn('OedhAckCode', 'Oedhackcode', 'VARCHAR', true, 2, '');
        $this->addColumn('OedhWiBordNbr', 'Oedhwibordnbr', 'VARCHAR', true, 10, '');
        $this->addColumn('OedhCertHistOrdr', 'Oedhcerthistordr', 'VARCHAR', true, 10, '');
        ...
        $this->addColumn('OedhAcPricDate', 'Oedhacpricdate', 'CHAR', true, 8, '');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SalesHistoryDetailTableMap::COL_ARTBCTAXCODE);
            ...
            $criteria->addSelectColumn(SalesHistoryDetailTableMap::COL_OEDHSTOCKCHECK);
            ...
            $criteria->addSelectColumn($alias . '.OedhStockCheck');
