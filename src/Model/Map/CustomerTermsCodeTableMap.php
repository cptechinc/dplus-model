...
use \CustomerTermsCode;
use \CustomerTermsCodeQuery;
 ...
 *
 */
class CustomerTermsCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.CustomerTermsCodeTableMap';
     ...
     */
    const OM_CLASS = '\\CustomerTermsCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CustomerTermsCode';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CustomerTermsCodeTableMap::COL_ARTMTERMCD, CustomerTermsCodeTableMap::COL_ARTMTERMDESC, CustomerTermsCodeTableMap::COL_ARTMMETHOD, CustomerTermsCodeTableMap::COL_ARTMTYPE, CustomerTermsCodeTableMap::COL_ARTMHOLD, CustomerTermsCodeTableMap::COL_ARTMEXPIREDATE, CustomerTermsCodeTableMap::COL_ARTMFRTALLOW, CustomerTermsCodeTableMap::COL_ARTMCCPREFIX, CustomerTermsCodeTableMap::COL_ARTMSPLIT1, CustomerTermsCodeTableMap::COL_ARTMORDERPCT1, CustomerTermsCodeTableMap::COL_ARTMDISCPCT1, CustomerTermsCodeTableMap::COL_ARTMDISCDAYS1, CustomerTermsCodeTableMap::COL_ARTMDISCDAY1, CustomerTermsCodeTableMap::COL_ARTMDISCDATE1, CustomerTermsCodeTableMap::COL_ARTMDUEDAYS1, CustomerTermsCodeTableMap::COL_ARTMDUEDAY1, CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS1, CustomerTermsCodeTableMap::COL_ARTMDUEDATE1, CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR1, CustomerTermsCodeTableMap::COL_ARTMSPLIT2, CustomerTermsCodeTableMap::COL_ARTMORDERPCT2, CustomerTermsCodeTableMap::COL_ARTMDISCPCT2, CustomerTermsCodeTableMap::COL_ARTMDISCDAYS2, CustomerTermsCodeTableMap::COL_ARTMDISCDAY2, CustomerTermsCodeTableMap::COL_ARTMDISCDATE2, CustomerTermsCodeTableMap::COL_ARTMDUEDAYS2, CustomerTermsCodeTableMap::COL_ARTMDUEDAY2, CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS2, CustomerTermsCodeTableMap::COL_ARTMDUEDATE2, CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR2, CustomerTermsCodeTableMap::COL_ARTMSPLIT3, CustomerTermsCodeTableMap::COL_ARTMORDERPCT3, CustomerTermsCodeTableMap::COL_ARTMDISCPCT3, CustomerTermsCodeTableMap::COL_ARTMDISCDAYS3, CustomerTermsCodeTableMap::COL_ARTMDISCDAY3, CustomerTermsCodeTableMap::COL_ARTMDISCDATE3, CustomerTermsCodeTableMap::COL_ARTMDUEDAYS3, CustomerTermsCodeTableMap::COL_ARTMDUEDAY3, CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS3, CustomerTermsCodeTableMap::COL_ARTMDUEDATE3, CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR3, CustomerTermsCodeTableMap::COL_ARTMSPLIT4, CustomerTermsCodeTableMap::COL_ARTMORDERPCT4, CustomerTermsCodeTableMap::COL_ARTMDISCPCT4, CustomerTermsCodeTableMap::COL_ARTMDISCDAYS4, CustomerTermsCodeTableMap::COL_ARTMDISCDAY4, CustomerTermsCodeTableMap::COL_ARTMDISCDATE4, CustomerTermsCodeTableMap::COL_ARTMDUEDAYS4, CustomerTermsCodeTableMap::COL_ARTMDUEDAY4, CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS4, CustomerTermsCodeTableMap::COL_ARTMDUEDATE4, CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR4, CustomerTermsCodeTableMap::COL_ARTMSPLIT5, CustomerTermsCodeTableMap::COL_ARTMORDERPCT5, CustomerTermsCodeTableMap::COL_ARTMDISCPCT5, CustomerTermsCodeTableMap::COL_ARTMDISCDAYS5, CustomerTermsCodeTableMap::COL_ARTMDISCDAY5, CustomerTermsCodeTableMap::COL_ARTMDISCDATE5, CustomerTermsCodeTableMap::COL_ARTMDUEDAYS5, CustomerTermsCodeTableMap::COL_ARTMDUEDAY5, CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS5, CustomerTermsCodeTableMap::COL_ARTMDUEDATE5, CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR5, CustomerTermsCodeTableMap::COL_ARTMSPLIT6, CustomerTermsCodeTableMap::COL_ARTMORDERPCT6, CustomerTermsCodeTableMap::COL_ARTMDISCPCT6, CustomerTermsCodeTableMap::COL_ARTMDISCDAYS6, CustomerTermsCodeTableMap::COL_ARTMDISCDAY6, CustomerTermsCodeTableMap::COL_ARTMDISCDATE6, CustomerTermsCodeTableMap::COL_ARTMDUEDAYS6, CustomerTermsCodeTableMap::COL_ARTMDUEDAY6, CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS6, CustomerTermsCodeTableMap::COL_ARTMDUEDATE6, CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR6, CustomerTermsCodeTableMap::COL_ARTMDAYFROM1, CustomerTermsCodeTableMap::COL_ARTMDAYTHRU1, CustomerTermsCodeTableMap::COL_ARTMEOMDISCPCT1, CustomerTermsCodeTableMap::COL_ARTMEOMDISCDAY1, CustomerTermsCodeTableMap::COL_ARTMEOMDISCMONTHS1, CustomerTermsCodeTableMap::COL_ARTMEOMDUEDAY1, CustomerTermsCodeTableMap::COL_ARTMEOMPLUSMONTHS1, CustomerTermsCodeTableMap::COL_ARTMDAYFROM2, CustomerTermsCodeTableMap::COL_ARTMDAYTHRU2, CustomerTermsCodeTableMap::COL_ARTMEOMDISCPCT2, CustomerTermsCodeTableMap::COL_ARTMEOMDISCDAY2, CustomerTermsCodeTableMap::COL_ARTMEOMDISCMONTHS2, CustomerTermsCodeTableMap::COL_ARTMEOMDUEDAY2, CustomerTermsCodeTableMap::COL_ARTMEOMPLUSMONTHS2, CustomerTermsCodeTableMap::COL_ARTMDAYFROM3, CustomerTermsCodeTableMap::COL_ARTMDAYTHRU3, CustomerTermsCodeTableMap::COL_ARTMEOMDISCPCT3, CustomerTermsCodeTableMap::COL_ARTMEOMDISCDAY3, CustomerTermsCodeTableMap::COL_ARTMEOMDISCMONTHS3, CustomerTermsCodeTableMap::COL_ARTMEOMDUEDAY3, CustomerTermsCodeTableMap::COL_ARTMEOMPLUSMONTHS3, CustomerTermsCodeTableMap::COL_ARTMCTRY, CustomerTermsCodeTableMap::COL_ARTMTERMGRUP, CustomerTermsCodeTableMap::COL_DATEUPDTD, CustomerTermsCodeTableMap::COL_TIMEUPDTD, CustomerTermsCodeTableMap::COL_DUMMY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CustomerTermsCodeTableMap::COL_ARTMTERMCD => 0, CustomerTermsCodeTableMap::COL_ARTMTERMDESC => 1, CustomerTermsCodeTableMap::COL_ARTMMETHOD => 2, CustomerTermsCodeTableMap::COL_ARTMTYPE => 3, CustomerTermsCodeTableMap::COL_ARTMHOLD => 4, CustomerTermsCodeTableMap::COL_ARTMEXPIREDATE => 5, CustomerTermsCodeTableMap::COL_ARTMFRTALLOW => 6, CustomerTermsCodeTableMap::COL_ARTMCCPREFIX => 7, CustomerTermsCodeTableMap::COL_ARTMSPLIT1 => 8, CustomerTermsCodeTableMap::COL_ARTMORDERPCT1 => 9, CustomerTermsCodeTableMap::COL_ARTMDISCPCT1 => 10, CustomerTermsCodeTableMap::COL_ARTMDISCDAYS1 => 11, CustomerTermsCodeTableMap::COL_ARTMDISCDAY1 => 12, CustomerTermsCodeTableMap::COL_ARTMDISCDATE1 => 13, CustomerTermsCodeTableMap::COL_ARTMDUEDAYS1 => 14, CustomerTermsCodeTableMap::COL_ARTMDUEDAY1 => 15, CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS1 => 16, CustomerTermsCodeTableMap::COL_ARTMDUEDATE1 => 17, CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR1 => 18, CustomerTermsCodeTableMap::COL_ARTMSPLIT2 => 19, CustomerTermsCodeTableMap::COL_ARTMORDERPCT2 => 20, CustomerTermsCodeTableMap::COL_ARTMDISCPCT2 => 21, CustomerTermsCodeTableMap::COL_ARTMDISCDAYS2 => 22, CustomerTermsCodeTableMap::COL_ARTMDISCDAY2 => 23, CustomerTermsCodeTableMap::COL_ARTMDISCDATE2 => 24, CustomerTermsCodeTableMap::COL_ARTMDUEDAYS2 => 25, CustomerTermsCodeTableMap::COL_ARTMDUEDAY2 => 26, CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS2 => 27, CustomerTermsCodeTableMap::COL_ARTMDUEDATE2 => 28, CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR2 => 29, CustomerTermsCodeTableMap::COL_ARTMSPLIT3 => 30, CustomerTermsCodeTableMap::COL_ARTMORDERPCT3 => 31, CustomerTermsCodeTableMap::COL_ARTMDISCPCT3 => 32, CustomerTermsCodeTableMap::COL_ARTMDISCDAYS3 => 33, CustomerTermsCodeTableMap::COL_ARTMDISCDAY3 => 34, CustomerTermsCodeTableMap::COL_ARTMDISCDATE3 => 35, CustomerTermsCodeTableMap::COL_ARTMDUEDAYS3 => 36, CustomerTermsCodeTableMap::COL_ARTMDUEDAY3 => 37, CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS3 => 38, CustomerTermsCodeTableMap::COL_ARTMDUEDATE3 => 39, CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR3 => 40, CustomerTermsCodeTableMap::COL_ARTMSPLIT4 => 41, CustomerTermsCodeTableMap::COL_ARTMORDERPCT4 => 42, CustomerTermsCodeTableMap::COL_ARTMDISCPCT4 => 43, CustomerTermsCodeTableMap::COL_ARTMDISCDAYS4 => 44, CustomerTermsCodeTableMap::COL_ARTMDISCDAY4 => 45, CustomerTermsCodeTableMap::COL_ARTMDISCDATE4 => 46, CustomerTermsCodeTableMap::COL_ARTMDUEDAYS4 => 47, CustomerTermsCodeTableMap::COL_ARTMDUEDAY4 => 48, CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS4 => 49, CustomerTermsCodeTableMap::COL_ARTMDUEDATE4 => 50, CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR4 => 51, CustomerTermsCodeTableMap::COL_ARTMSPLIT5 => 52, CustomerTermsCodeTableMap::COL_ARTMORDERPCT5 => 53, CustomerTermsCodeTableMap::COL_ARTMDISCPCT5 => 54, CustomerTermsCodeTableMap::COL_ARTMDISCDAYS5 => 55, CustomerTermsCodeTableMap::COL_ARTMDISCDAY5 => 56, CustomerTermsCodeTableMap::COL_ARTMDISCDATE5 => 57, CustomerTermsCodeTableMap::COL_ARTMDUEDAYS5 => 58, CustomerTermsCodeTableMap::COL_ARTMDUEDAY5 => 59, CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS5 => 60, CustomerTermsCodeTableMap::COL_ARTMDUEDATE5 => 61, CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR5 => 62, CustomerTermsCodeTableMap::COL_ARTMSPLIT6 => 63, CustomerTermsCodeTableMap::COL_ARTMORDERPCT6 => 64, CustomerTermsCodeTableMap::COL_ARTMDISCPCT6 => 65, CustomerTermsCodeTableMap::COL_ARTMDISCDAYS6 => 66, CustomerTermsCodeTableMap::COL_ARTMDISCDAY6 => 67, CustomerTermsCodeTableMap::COL_ARTMDISCDATE6 => 68, CustomerTermsCodeTableMap::COL_ARTMDUEDAYS6 => 69, CustomerTermsCodeTableMap::COL_ARTMDUEDAY6 => 70, CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS6 => 71, CustomerTermsCodeTableMap::COL_ARTMDUEDATE6 => 72, CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR6 => 73, CustomerTermsCodeTableMap::COL_ARTMDAYFROM1 => 74, CustomerTermsCodeTableMap::COL_ARTMDAYTHRU1 => 75, CustomerTermsCodeTableMap::COL_ARTMEOMDISCPCT1 => 76, CustomerTermsCodeTableMap::COL_ARTMEOMDISCDAY1 => 77, CustomerTermsCodeTableMap::COL_ARTMEOMDISCMONTHS1 => 78, CustomerTermsCodeTableMap::COL_ARTMEOMDUEDAY1 => 79, CustomerTermsCodeTableMap::COL_ARTMEOMPLUSMONTHS1 => 80, CustomerTermsCodeTableMap::COL_ARTMDAYFROM2 => 81, CustomerTermsCodeTableMap::COL_ARTMDAYTHRU2 => 82, CustomerTermsCodeTableMap::COL_ARTMEOMDISCPCT2 => 83, CustomerTermsCodeTableMap::COL_ARTMEOMDISCDAY2 => 84, CustomerTermsCodeTableMap::COL_ARTMEOMDISCMONTHS2 => 85, CustomerTermsCodeTableMap::COL_ARTMEOMDUEDAY2 => 86, CustomerTermsCodeTableMap::COL_ARTMEOMPLUSMONTHS2 => 87, CustomerTermsCodeTableMap::COL_ARTMDAYFROM3 => 88, CustomerTermsCodeTableMap::COL_ARTMDAYTHRU3 => 89, CustomerTermsCodeTableMap::COL_ARTMEOMDISCPCT3 => 90, CustomerTermsCodeTableMap::COL_ARTMEOMDISCDAY3 => 91, CustomerTermsCodeTableMap::COL_ARTMEOMDISCMONTHS3 => 92, CustomerTermsCodeTableMap::COL_ARTMEOMDUEDAY3 => 93, CustomerTermsCodeTableMap::COL_ARTMEOMPLUSMONTHS3 => 94, CustomerTermsCodeTableMap::COL_ARTMCTRY => 95, CustomerTermsCodeTableMap::COL_ARTMTERMGRUP => 96, CustomerTermsCodeTableMap::COL_DATEUPDTD => 97, CustomerTermsCodeTableMap::COL_TIMEUPDTD => 98, CustomerTermsCodeTableMap::COL_DUMMY => 99, ),
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('CustomerTermsCode');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\CustomerTermsCode');
        $this->setPackage('');
    ...
    {
        return $withPrefix ? CustomerTermsCodeTableMap::CLASS_DEFAULT : CustomerTermsCodeTableMap::OM_CLASS;
    }
     ...
     * @return array           (CustomerTermsCode object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = CustomerTermsCodeTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = CustomerTermsCodeTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + CustomerTermsCodeTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = CustomerTermsCodeTableMap::OM_CLASS;
            /** @var CustomerTermsCode $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            CustomerTermsCodeTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = CustomerTermsCodeTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = CustomerTermsCodeTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMTERMCD);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMTERMDESC);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMMETHOD);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMTYPE);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMHOLD);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEXPIREDATE);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMFRTALLOW);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMCCPREFIX);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMSPLIT1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMORDERPCT1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCPCT1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDAYS1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDAY1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDATE1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDAYS1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDAY1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDATE1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMSPLIT2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMORDERPCT2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCPCT2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDAYS2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDAY2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDATE2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDAYS2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDAY2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDATE2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMSPLIT3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMORDERPCT3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCPCT3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDAYS3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDAY3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDATE3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDAYS3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDAY3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDATE3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMSPLIT4);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMORDERPCT4);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCPCT4);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDAYS4);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDAY4);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDATE4);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDAYS4);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDAY4);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS4);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDATE4);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR4);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMSPLIT5);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMORDERPCT5);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCPCT5);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDAYS5);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDAY5);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDATE5);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDAYS5);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDAY5);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS5);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDATE5);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR5);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMSPLIT6);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMORDERPCT6);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCPCT6);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDAYS6);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDAY6);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDISCDATE6);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDAYS6);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDAY6);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMPLUSMONTHS6);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDUEDATE6);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMPLUSYEAR6);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDAYFROM1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDAYTHRU1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMDISCPCT1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMDISCDAY1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMDISCMONTHS1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMDUEDAY1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMPLUSMONTHS1);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDAYFROM2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDAYTHRU2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMDISCPCT2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMDISCDAY2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMDISCMONTHS2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMDUEDAY2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMPLUSMONTHS2);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDAYFROM3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMDAYTHRU3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMDISCPCT3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMDISCDAY3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMDISCMONTHS3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMDUEDAY3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMEOMPLUSMONTHS3);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMCTRY);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_ARTMTERMGRUP);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_DATEUPDTD);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_TIMEUPDTD);
            $criteria->addSelectColumn(CustomerTermsCodeTableMap::COL_DUMMY);
        } else {
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(CustomerTermsCodeTableMap::DATABASE_NAME)->getTable(CustomerTermsCodeTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(CustomerTermsCodeTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(CustomerTermsCodeTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new CustomerTermsCodeTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a CustomerTermsCode or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or CustomerTermsCode object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CustomerTermsCode) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(CustomerTermsCodeTableMap::DATABASE_NAME);
            $criteria->add(CustomerTermsCodeTableMap::COL_ARTMTERMCD, (array) $values, Criteria::IN);
        }

        $query = CustomerTermsCodeQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            CustomerTermsCodeTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                CustomerTermsCodeTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return CustomerTermsCodeQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a CustomerTermsCode or Criteria object.
     *
     * @param mixed               $criteria Criteria or CustomerTermsCode object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from CustomerTermsCode object
        }
...
//
CustomerTermsCodeTableMap::buildTableMap();
