...
class SalesOrderTableMap extends TableMap
{
    ...
    /**
     * the column name for the OehdFrtTaxCode6 field
     */
    const COL_OEHDFRTTAXCODE6 = 'so_header.OehdFrtTaxCode6';

    /**
     * the column name for the OehdFrtTaxAmt6 field
     */
    const COL_OEHDFRTTAXAMT6 = 'so_header.OehdFrtTaxAmt6';

    /**
     * the column name for the OehdFrtTaxCode7 field
     */
    const COL_OEHDFRTTAXCODE7 = 'so_header.OehdFrtTaxCode7';

    /**
     * the column name for the OehdFrtTaxAmt7 field
     */
    const COL_OEHDFRTTAXAMT7 = 'so_header.OehdFrtTaxAmt7';

    /**
     * the column name for the OehdFrtTaxCode8 field
     */
    const COL_OEHDFRTTAXCODE8 = 'so_header.OehdFrtTaxCode8';

    /**
     * the column name for the OehdFrtTaxAmt8 field
     */
    const COL_OEHDFRTTAXAMT8 = 'so_header.OehdFrtTaxAmt8';

    /**
     * the column name for the OehdFrtTaxCode9 field
     */
    const COL_OEHDFRTTAXCODE9 = 'so_header.OehdFrtTaxCode9';

    /**
     * the column name for the OehdFrtTaxAmt9 field
     */
    const COL_OEHDFRTTAXAMT9 = 'so_header.OehdFrtTaxAmt9';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('OehdFrtTaxCode6', 'Oehdfrttaxcode6', 'VARCHAR', true, 6, '');
        $this->addColumn('OehdFrtTaxAmt6', 'Oehdfrttaxamt6', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehdFrtTaxCode7', 'Oehdfrttaxcode7', 'VARCHAR', true, 6, '');
        $this->addColumn('OehdFrtTaxAmt7', 'Oehdfrttaxamt7', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehdFrtTaxCode8', 'Oehdfrttaxcode8', 'VARCHAR', true, 6, '');
        $this->addColumn('OehdFrtTaxAmt8', 'Oehdfrttaxamt8', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehdFrtTaxCode9', 'Oehdfrttaxcode9', 'VARCHAR', true, 6, '');
        $this->addColumn('OehdFrtTaxAmt9', 'Oehdfrttaxamt9', 'DECIMAL', true, 20, 0);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SalesOrderTableMap::COL_OEHDFRTTAXCODE6);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_OEHDFRTTAXAMT6);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_OEHDFRTTAXCODE7);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_OEHDFRTTAXAMT7);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_OEHDFRTTAXCODE8);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_OEHDFRTTAXAMT8);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_OEHDFRTTAXCODE9);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_OEHDFRTTAXAMT9);
            ...
            $criteria->addSelectColumn($alias . '.OehdFrtTaxCode6');
            $criteria->addSelectColumn($alias . '.OehdFrtTaxAmt6');
            $criteria->addSelectColumn($alias . '.OehdFrtTaxCode7');
            $criteria->addSelectColumn($alias . '.OehdFrtTaxAmt7');
            $criteria->addSelectColumn($alias . '.OehdFrtTaxCode8');
            $criteria->addSelectColumn($alias . '.OehdFrtTaxAmt8');
            $criteria->addSelectColumn($alias . '.OehdFrtTaxCode9');
            $criteria->addSelectColumn($alias . '.OehdFrtTaxAmt9');
