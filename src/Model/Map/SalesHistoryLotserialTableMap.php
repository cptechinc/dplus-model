  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SalesHistoryLotserialTableMap::COL_OESHORIGBIN);
            $criteria->addSelectColumn(SalesHistoryLotserialTableMap::COL_OESHACTVDATE);
            ...
            $criteria->addSelectColumn($alias . '.OeshOrigBin');
            $criteria->addSelectColumn($alias . '.OeshActvDate');
