...
/**
 * This class defines the structure of the 'inv_bina_code' table.
 *
 *
 *
...
class InvBinAreaCodeTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('InvBinAreaCode');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\InvBinAreaCode');
        $this->setPackage('');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('IntbBinaCode', 'Intbbinacode', 'VARCHAR', true, 2, '');
        $this->addColumn('IntbBinaDesc', 'Intbbinadesc', 'VARCHAR', true, 30, '');
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Intbbinacode', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Intbbinacode', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Intbbinacode', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Intbbinacode', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Intbbinacode', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (string) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('Intbbinacode', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if (null !== ($obj = InvBinAreaCodeTableMap::getInstanceFromPool($key))) {
            ...
            $col = $offset + InvBinAreaCodeTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = InvBinAreaCodeTableMap::OM_CLASS;
            /** @var InvBinAreaCode $obj */
            $obj = new $cls();
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = InvBinAreaCodeTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = InvBinAreaCodeTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(InvBinAreaCodeTableMap::COL_INTBBINADESC);
            $criteria->addSelectColumn(InvBinAreaCodeTableMap::COL_DATEUPDTD);
            $criteria->addSelectColumn(InvBinAreaCodeTableMap::COL_TIMEUPDTD);
            $criteria->addSelectColumn(InvBinAreaCodeTableMap::COL_DUMMY);
        } else {
            $criteria->addSelectColumn($alias . '.IntbBinaCode');
            $criteria->addSelectColumn($alias . '.IntbBinaDesc');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \InvBinAreaCode) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(InvBinAreaCodeTableMap::DATABASE_NAME);
            $criteria->add(InvBinAreaCodeTableMap::COL_INTBBINACODE, (array) $values, Criteria::IN);
        }

        $query = InvBinAreaCodeQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            InvBinAreaCodeTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                InvBinAreaCodeTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from InvBinAreaCode object
        }
