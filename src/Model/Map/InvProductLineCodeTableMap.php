...
class InvProductLineCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.InvProductLineCodeTableMap';
     ...
     */
    const TABLE_NAME = 'inv_plne_code';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\InvProductLineCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'InvProductLineCode';
     ...
     */
    const COL_INTBPLNECODE = 'inv_plne_code.IntbPlneCode';

    /**
     * the column name for the IntbPlneDesc field
     */
    const COL_INTBPLNEDESC = 'inv_plne_code.IntbPlneDesc';

    /**
     * the column name for the DateUpdtd field
     */
    const COL_DATEUPDTD = 'inv_plne_code.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    const COL_TIMEUPDTD = 'inv_plne_code.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    const COL_DUMMY = 'inv_plne_code.dummy';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Intbplnecode', 'Intbplnedesc', 'Dateupdtd', 'Timeupdtd', 'Dummy', ),
        self::TYPE_CAMELNAME     => array('intbplnecode', 'intbplnedesc', 'dateupdtd', 'timeupdtd', 'dummy', ),
        self::TYPE_COLNAME       => array(InvProductLineCodeTableMap::COL_INTBPLNECODE, InvProductLineCodeTableMap::COL_INTBPLNEDESC, InvProductLineCodeTableMap::COL_DATEUPDTD, InvProductLineCodeTableMap::COL_TIMEUPDTD, InvProductLineCodeTableMap::COL_DUMMY, ),
        self::TYPE_FIELDNAME     => array('IntbPlneCode', 'IntbPlneDesc', 'DateUpdtd', 'TimeUpdtd', 'dummy', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Intbplnecode' => 0, 'Intbplnedesc' => 1, 'Dateupdtd' => 2, 'Timeupdtd' => 3, 'Dummy' => 4, ),
        self::TYPE_CAMELNAME     => array('intbplnecode' => 0, 'intbplnedesc' => 1, 'dateupdtd' => 2, 'timeupdtd' => 3, 'dummy' => 4, ),
        self::TYPE_COLNAME       => array(InvProductLineCodeTableMap::COL_INTBPLNECODE => 0, InvProductLineCodeTableMap::COL_INTBPLNEDESC => 1, InvProductLineCodeTableMap::COL_DATEUPDTD => 2, InvProductLineCodeTableMap::COL_TIMEUPDTD => 3, InvProductLineCodeTableMap::COL_DUMMY => 4, ),
        self::TYPE_FIELDNAME     => array('IntbPlneCode' => 0, 'IntbPlneDesc' => 1, 'DateUpdtd' => 2, 'TimeUpdtd' => 3, 'dummy' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(InvProductLineCodeTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(InvProductLineCodeTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new InvProductLineCodeTableMap());
        }
    }
...
} // InvProductLineCodeTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
InvProductLineCodeTableMap::buildTableMap();
