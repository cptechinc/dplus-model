...
class ArCustUserCodeTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.ArCustUserCodeTableMap';
     ...
     */
    public const TABLE_NAME = 'ar_cust_cusr';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'ArCustUserCode';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\ArCustUserCode';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'ArCustUserCode';
     ...
     */
    public const COL_ARTBCUSRCODE = 'ar_cust_cusr.ArtbCusrCode';

    /**
     * the column name for the ArtbCusrDesc field
     */
    public const COL_ARTBCUSRDESC = 'ar_cust_cusr.ArtbCusrDesc';

    /**
     * the column name for the DateUpdtd field
     */
    public const COL_DATEUPDTD = 'ar_cust_cusr.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    public const COL_TIMEUPDTD = 'ar_cust_cusr.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    public const COL_DUMMY = 'ar_cust_cusr.dummy';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Artbcusrcode', 'Artbcusrdesc', 'Dateupdtd', 'Timeupdtd', 'Dummy', ],
        self::TYPE_CAMELNAME     => ['artbcusrcode', 'artbcusrdesc', 'dateupdtd', 'timeupdtd', 'dummy', ],
        self::TYPE_COLNAME       => [ArCustUserCodeTableMap::COL_ARTBCUSRCODE, ArCustUserCodeTableMap::COL_ARTBCUSRDESC, ArCustUserCodeTableMap::COL_DATEUPDTD, ArCustUserCodeTableMap::COL_TIMEUPDTD, ArCustUserCodeTableMap::COL_DUMMY, ],
        self::TYPE_FIELDNAME     => ['ArtbCusrCode', 'ArtbCusrDesc', 'DateUpdtd', 'TimeUpdtd', 'dummy', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Artbcusrcode' => 0, 'Artbcusrdesc' => 1, 'Dateupdtd' => 2, 'Timeupdtd' => 3, 'Dummy' => 4, ],
        self::TYPE_CAMELNAME     => ['artbcusrcode' => 0, 'artbcusrdesc' => 1, 'dateupdtd' => 2, 'timeupdtd' => 3, 'dummy' => 4, ],
        self::TYPE_COLNAME       => [ArCustUserCodeTableMap::COL_ARTBCUSRCODE => 0, ArCustUserCodeTableMap::COL_ARTBCUSRDESC => 1, ArCustUserCodeTableMap::COL_DATEUPDTD => 2, ArCustUserCodeTableMap::COL_TIMEUPDTD => 3, ArCustUserCodeTableMap::COL_DUMMY => 4, ],
        self::TYPE_FIELDNAME     => ['ArtbCusrCode' => 0, 'ArtbCusrDesc' => 1, 'DateUpdtd' => 2, 'TimeUpdtd' => 3, 'dummy' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        'Artbcusrcode' => 'ARTBCUSRCODE',
        'ArCustUserCode.Artbcusrcode' => 'ARTBCUSRCODE',
        'artbcusrcode' => 'ARTBCUSRCODE',
        'arCustUserCode.artbcusrcode' => 'ARTBCUSRCODE',
        'ArCustUserCodeTableMap::COL_ARTBCUSRCODE' => 'ARTBCUSRCODE',
        'COL_ARTBCUSRCODE' => 'ARTBCUSRCODE',
        'ArtbCusrCode' => 'ARTBCUSRCODE',
        'ar_cust_cusr.ArtbCusrCode' => 'ARTBCUSRCODE',
        'Artbcusrdesc' => 'ARTBCUSRDESC',
        'ArCustUserCode.Artbcusrdesc' => 'ARTBCUSRDESC',
        'artbcusrdesc' => 'ARTBCUSRDESC',
        'arCustUserCode.artbcusrdesc' => 'ARTBCUSRDESC',
        'ArCustUserCodeTableMap::COL_ARTBCUSRDESC' => 'ARTBCUSRDESC',
        'COL_ARTBCUSRDESC' => 'ARTBCUSRDESC',
        'ArtbCusrDesc' => 'ARTBCUSRDESC',
        'ar_cust_cusr.ArtbCusrDesc' => 'ARTBCUSRDESC',
        'Dateupdtd' => 'DATEUPDTD',
        'ArCustUserCode.Dateupdtd' => 'DATEUPDTD',
        'dateupdtd' => 'DATEUPDTD',
        'arCustUserCode.dateupdtd' => 'DATEUPDTD',
        'ArCustUserCodeTableMap::COL_DATEUPDTD' => 'DATEUPDTD',
        'COL_DATEUPDTD' => 'DATEUPDTD',
        'DateUpdtd' => 'DATEUPDTD',
        'ar_cust_cusr.DateUpdtd' => 'DATEUPDTD',
        'Timeupdtd' => 'TIMEUPDTD',
        'ArCustUserCode.Timeupdtd' => 'TIMEUPDTD',
        'timeupdtd' => 'TIMEUPDTD',
        'arCustUserCode.timeupdtd' => 'TIMEUPDTD',
        'ArCustUserCodeTableMap::COL_TIMEUPDTD' => 'TIMEUPDTD',
        'COL_TIMEUPDTD' => 'TIMEUPDTD',
        'TimeUpdtd' => 'TIMEUPDTD',
        'ar_cust_cusr.TimeUpdtd' => 'TIMEUPDTD',
        'Dummy' => 'DUMMY',
        'ArCustUserCode.Dummy' => 'DUMMY',
        'dummy' => 'DUMMY',
        'arCustUserCode.dummy' => 'DUMMY',
        'ArCustUserCodeTableMap::COL_DUMMY' => 'DUMMY',
        'COL_DUMMY' => 'DUMMY',
        'ar_cust_cusr.dummy' => 'DUMMY',
    ];
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(ArCustUserCodeTableMap::COL_ARTBCUSRCODE);
            $criteria->removeSelectColumn(ArCustUserCodeTableMap::COL_ARTBCUSRDESC);
            $criteria->removeSelectColumn(ArCustUserCodeTableMap::COL_DATEUPDTD);
            $criteria->removeSelectColumn(ArCustUserCodeTableMap::COL_TIMEUPDTD);
            $criteria->removeSelectColumn(ArCustUserCodeTableMap::COL_DUMMY);
        } else {
            $criteria->removeSelectColumn($alias . '.ArtbCusrCode');
            $criteria->removeSelectColumn($alias . '.ArtbCusrDesc');
