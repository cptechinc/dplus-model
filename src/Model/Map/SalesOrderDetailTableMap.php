...
class SalesOrderDetailTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('OedtWghtTot', 'OedtWghtTot', 'DECIMAL', false, 20, null);
        ...
        $this->addColumn('OedtOrigPric', 'OedtOrigPric', 'DECIMAL', false, 20, null);
        $this->addColumn('OedtRefLineNbr', 'OedtRefLineNbr', 'VARCHAR', false, 4, null);
        $this->addColumn('OedtBinLocn', 'OedtBinLocn', 'VARCHAR', false, 20, null);
        $this->addColumn('OedtAcSuplyWhse', 'OedtAcSuplyWhse', 'VARCHAR', false, 2, null);
        $this->addColumn('OedtAcPricDate', 'OedtAcPricDate', 'VARCHAR', false, 8, null);
