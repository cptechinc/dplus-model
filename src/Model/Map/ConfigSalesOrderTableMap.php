...
class ConfigSalesOrderTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('OetbCon3ShipMoreOrdered', 'Oetbcon3shipmoreordered', 'VARCHAR', false, 1, null);
        $this->addColumn('OetbCon3WarnShipMore', 'Oetbcon3warnshipmore', 'VARCHAR', false, 1, null);
