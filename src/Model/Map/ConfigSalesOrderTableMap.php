...
class ConfigSalesOrderTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('OetbCon3ProformaFromEso', 'Oetbcon3proformafromeso', 'VARCHAR', false, 1, null);
        $this->addColumn('OetbCon3PickPackCode', 'Oetbcon3pickpackcode', 'VARCHAR', false, 1, null);
