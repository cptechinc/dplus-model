...
class ArRouteCodeTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.ArRouteCodeTableMap';
     ...
     */
    public const TABLE_NAME = 'ar_cust_rout';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'ArRouteCode';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\ArRouteCode';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'ArRouteCode';
     ...
     */
    public const COL_ARTBROUTE = 'ar_cust_rout.ArtbRoute';

    /**
     * the column name for the ArtbRouteDesc field
     */
    public const COL_ARTBROUTEDESC = 'ar_cust_rout.ArtbRouteDesc';

    /**
     * the column name for the DateUpdtd field
     */
    public const COL_DATEUPDTD = 'ar_cust_rout.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    public const COL_TIMEUPDTD = 'ar_cust_rout.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    public const COL_DUMMY = 'ar_cust_rout.dummy';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Artbroute', 'Artbroutedesc', 'Dateupdtd', 'Timeupdtd', 'Dummy', ],
        self::TYPE_CAMELNAME     => ['artbroute', 'artbroutedesc', 'dateupdtd', 'timeupdtd', 'dummy', ],
        self::TYPE_COLNAME       => [ArRouteCodeTableMap::COL_ARTBROUTE, ArRouteCodeTableMap::COL_ARTBROUTEDESC, ArRouteCodeTableMap::COL_DATEUPDTD, ArRouteCodeTableMap::COL_TIMEUPDTD, ArRouteCodeTableMap::COL_DUMMY, ],
        self::TYPE_FIELDNAME     => ['ArtbRoute', 'ArtbRouteDesc', 'DateUpdtd', 'TimeUpdtd', 'dummy', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Artbroute' => 0, 'Artbroutedesc' => 1, 'Dateupdtd' => 2, 'Timeupdtd' => 3, 'Dummy' => 4, ],
        self::TYPE_CAMELNAME     => ['artbroute' => 0, 'artbroutedesc' => 1, 'dateupdtd' => 2, 'timeupdtd' => 3, 'dummy' => 4, ],
        self::TYPE_COLNAME       => [ArRouteCodeTableMap::COL_ARTBROUTE => 0, ArRouteCodeTableMap::COL_ARTBROUTEDESC => 1, ArRouteCodeTableMap::COL_DATEUPDTD => 2, ArRouteCodeTableMap::COL_TIMEUPDTD => 3, ArRouteCodeTableMap::COL_DUMMY => 4, ],
        self::TYPE_FIELDNAME     => ['ArtbRoute' => 0, 'ArtbRouteDesc' => 1, 'DateUpdtd' => 2, 'TimeUpdtd' => 3, 'dummy' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        'Artbroute' => 'ARTBROUTE',
        'ArRouteCode.Artbroute' => 'ARTBROUTE',
        'artbroute' => 'ARTBROUTE',
        'arRouteCode.artbroute' => 'ARTBROUTE',
        'ArRouteCodeTableMap::COL_ARTBROUTE' => 'ARTBROUTE',
        'COL_ARTBROUTE' => 'ARTBROUTE',
        'ArtbRoute' => 'ARTBROUTE',
        'ar_cust_rout.ArtbRoute' => 'ARTBROUTE',
        'Artbroutedesc' => 'ARTBROUTEDESC',
        'ArRouteCode.Artbroutedesc' => 'ARTBROUTEDESC',
        'artbroutedesc' => 'ARTBROUTEDESC',
        'arRouteCode.artbroutedesc' => 'ARTBROUTEDESC',
        'ArRouteCodeTableMap::COL_ARTBROUTEDESC' => 'ARTBROUTEDESC',
        'COL_ARTBROUTEDESC' => 'ARTBROUTEDESC',
        'ArtbRouteDesc' => 'ARTBROUTEDESC',
        'ar_cust_rout.ArtbRouteDesc' => 'ARTBROUTEDESC',
        'Dateupdtd' => 'DATEUPDTD',
        'ArRouteCode.Dateupdtd' => 'DATEUPDTD',
        'dateupdtd' => 'DATEUPDTD',
        'arRouteCode.dateupdtd' => 'DATEUPDTD',
        'ArRouteCodeTableMap::COL_DATEUPDTD' => 'DATEUPDTD',
        'COL_DATEUPDTD' => 'DATEUPDTD',
        'DateUpdtd' => 'DATEUPDTD',
        'ar_cust_rout.DateUpdtd' => 'DATEUPDTD',
        'Timeupdtd' => 'TIMEUPDTD',
        'ArRouteCode.Timeupdtd' => 'TIMEUPDTD',
        'timeupdtd' => 'TIMEUPDTD',
        'arRouteCode.timeupdtd' => 'TIMEUPDTD',
        'ArRouteCodeTableMap::COL_TIMEUPDTD' => 'TIMEUPDTD',
        'COL_TIMEUPDTD' => 'TIMEUPDTD',
        'TimeUpdtd' => 'TIMEUPDTD',
        'ar_cust_rout.TimeUpdtd' => 'TIMEUPDTD',
        'Dummy' => 'DUMMY',
        'ArRouteCode.Dummy' => 'DUMMY',
        'dummy' => 'DUMMY',
        'arRouteCode.dummy' => 'DUMMY',
        'ArRouteCodeTableMap::COL_DUMMY' => 'DUMMY',
        'COL_DUMMY' => 'DUMMY',
        'ar_cust_rout.dummy' => 'DUMMY',
    ];
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(ArRouteCodeTableMap::COL_ARTBROUTE);
            $criteria->removeSelectColumn(ArRouteCodeTableMap::COL_ARTBROUTEDESC);
            $criteria->removeSelectColumn(ArRouteCodeTableMap::COL_DATEUPDTD);
            $criteria->removeSelectColumn(ArRouteCodeTableMap::COL_TIMEUPDTD);
            $criteria->removeSelectColumn(ArRouteCodeTableMap::COL_DUMMY);
        } else {
            $criteria->removeSelectColumn($alias . '.ArtbRoute');
            $criteria->removeSelectColumn($alias . '.ArtbRouteDesc');
