...
class PurchaseOrderDetailTableMap extends TableMap
{
    ...
    /**
     * the column name for the PodtCat3 field
     */
    const COL_PODTCAT3 = 'po_detail.PodtCat3';
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addForeignPrimaryKey('PohdNbr', 'Pohdnbr', 'INTEGER' , 'po_head', 'PohdNbr', true, null, 0);
        $this->addPrimaryKey('PodtLine', 'Podtline', 'INTEGER', true, null, 0);
        ...
        $this->addColumn('PodtSoNbr', 'Podtsonbr', 'INTEGER', true, null, 0);
        $this->addColumn('PodtStat', 'Podtstat', 'CHAR', true, null, 'O');
        $this->addColumn('PodtOrigSoLine', 'Podtorigsoline', 'INTEGER', true, null, 0);
        ...
        $this->addColumn('PodtRcptNbr', 'Podtrcptnbr', 'INTEGER', true, null, 0);
        $this->addColumn('PodtWipNbr', 'Podtwipnbr', 'INTEGER', true, null, 0);
        ...
        $this->addColumn('PodtCasesOrd', 'Podtcasesord', 'INTEGER', true, null, 0);
        $this->addColumn('PodtCat3', 'Podtcat3', 'CHAR', true, null, 'N');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PurchaseOrderDetailTableMap::COL_PODTCAT3);
            ...
            $criteria->addSelectColumn($alias . '.PodtCat3');
