...
class CustomerShipBolNotesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.CustomerShipBolNotesTableMap';
     ...
     */
    const TABLE_NAME = 'notes_cust_ship_bol';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\CustomerShipBolNotes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CustomerShipBolNotes';
     ...
     */
    const COL_QNTYPE = 'notes_cust_ship_bol.QnType';

    /**
     * the column name for the QnTypeDesc field
     */
    const COL_QNTYPEDESC = 'notes_cust_ship_bol.QnTypeDesc';

    /**
     * the column name for the ArcuCustId field
     */
    const COL_ARCUCUSTID = 'notes_cust_ship_bol.ArcuCustId';

    /**
     * the column name for the ArstShipId field
     */
    const COL_ARSTSHIPID = 'notes_cust_ship_bol.ArstShipId';

    /**
     * the column name for the QnSeq field
     */
    const COL_QNSEQ = 'notes_cust_ship_bol.QnSeq';

    /**
     * the column name for the QnNote field
     */
    const COL_QNNOTE = 'notes_cust_ship_bol.QnNote';

    /**
     * the column name for the QnKey2 field
     */
    const COL_QNKEY2 = 'notes_cust_ship_bol.QnKey2';

    /**
     * the column name for the QnForm field
     */
    const COL_QNFORM = 'notes_cust_ship_bol.QnForm';

    /**
     * the column name for the DateUpdtd field
     */
    const COL_DATEUPDTD = 'notes_cust_ship_bol.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    const COL_TIMEUPDTD = 'notes_cust_ship_bol.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    const COL_DUMMY = 'notes_cust_ship_bol.dummy';
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(CustomerShipBolNotesTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(CustomerShipBolNotesTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new CustomerShipBolNotesTableMap());
        }
    }
...
//
CustomerShipBolNotesTableMap::buildTableMap();
