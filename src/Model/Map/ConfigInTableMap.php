...
class ConfigInTableMap extends TableMap
{
    ...
    /**
     * the column name for the IntbConfResqItemBin field
     */
    const COL_INTBCONFRESQITEMBIN = 'in_config.IntbConfResqItemBin';
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('IntbConfKey', 'Intbconfkey', 'INTEGER', true, 1, 0);
        $this->addColumn('IntbConfGlIfac', 'Intbconfglifac', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseIw', 'Intbconfuseiw', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfLifoFifo', 'Intbconflifofifo', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfGoNeg', 'Intbconfgoneg', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseLots', 'Intbconfuselots', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfNbrUppr', 'Intbconfnbruppr', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDescUppr', 'Intbconfdescuppr', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseDesc2', 'Intbconfusedesc2', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseUpcCode', 'Intbconfuseupccode', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUpcEanCntrl', 'Intbconfupceancntrl', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUpcGenNbr', 'Intbconfupcgennbr', 'INTEGER', false, 6, null);
        $this->addColumn('IntbCon2AllowDupUpc', 'Intbcon2allowdupupc', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfXrefNoSpace', 'Intbconfxrefnospace', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUsePricGrup', 'Intbconfusepricgrup', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseCommGrup', 'Intbconfusecommgrup', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseWarrDays', 'Intbconfusewarrdays', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfStanBaseDef', 'Intbconfstanbasedef', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfGrupDef', 'Intbconfgrupdef', 'VARCHAR', false, 4, null);
        $this->addColumn('IntbConfPricGrupDef', 'Intbconfpricgrupdef', 'VARCHAR', false, 8, null);
        $this->addColumn('IntbConfCommGrupDef', 'Intbconfcommgrupdef', 'VARCHAR', false, 8, null);
        $this->addColumn('IntbConfTypeDef', 'Intbconftypedef', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfPricUseItem', 'Intbconfpricuseitem', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfCommUseItem', 'Intbconfcommuseitem', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUomSaleDef', 'Intbconfuomsaledef', 'VARCHAR', false, 4, null);
        $this->addColumn('IntbConfUomPurDef', 'Intbconfuompurdef', 'VARCHAR', false, 4, null);
        $this->addColumn('IntbConfSviaDef', 'Intbconfsviadef', 'VARCHAR', false, 4, null);
        $this->addColumn('IntbConfCustxrefOrUse', 'Intbconfcustxreforuse', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfHeadGetDef', 'Intbconfheadgetdef', 'INTEGER', false, 1, null);
        $this->addColumn('IntbConfItemGetDef', 'Intbconfitemgetdef', 'INTEGER', false, 1, null);
        $this->addColumn('IntbConfGetDispOhAval', 'Intbconfgetdispohaval', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUserCode1Labl', 'Intbconfusercode1labl', 'VARCHAR', false, 8, null);
        $this->addColumn('IntbConfUserCode1Ver', 'Intbconfusercode1ver', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUserCode2Labl', 'Intbconfusercode2labl', 'VARCHAR', false, 8, null);
        $this->addColumn('IntbConfUserCode2Ver', 'Intbconfusercode2ver', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfItemLine', 'Intbconfitemline', 'INTEGER', false, 2, null);
        $this->addColumn('IntbConfItemCols', 'Intbconfitemcols', 'INTEGER', false, 2, null);
        $this->addColumn('IntbConfHeadLine', 'Intbconfheadline', 'INTEGER', false, 2, null);
        $this->addColumn('IntbConfHeadCols', 'Intbconfheadcols', 'INTEGER', false, 2, null);
        $this->addColumn('IntbConfDetLine', 'Intbconfdetline', 'INTEGER', false, 2, null);
        $this->addColumn('IntbConfDetCols', 'Intbconfdetcols', 'INTEGER', false, 2, null);
        $this->addColumn('IntbConfMinMaxZero', 'Intbconfminmaxzero', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfMinRec', 'Intbconfminrec', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfAtBelowMin', 'Intbconfatbelowmin', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfOneWhse', 'Intbconfonewhse', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfYtdMth', 'Intbconfytdmth', 'INTEGER', false, 2, null);
        $this->addColumn('IntbConfUseGramsLtr', 'Intbconfusegramsltr', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfAbcByWhse', 'Intbconfabcbywhse', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfAbcNbrMths', 'Intbconfabcnbrmths', 'INTEGER', false, 2, null);
        $this->addColumn('IntbConfAbcBaseCode', 'Intbconfabcbasecode', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfAbcLevlA', 'Intbconfabclevla', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfAbcLevlB', 'Intbconfabclevlb', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfAbcLevlC', 'Intbconfabclevlc', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfAbcLevlD', 'Intbconfabclevld', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfAbcLevlE', 'Intbconfabclevle', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfAbcLevlF', 'Intbconfabclevlf', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfAbcLevlG', 'Intbconfabclevlg', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfAbcLevlH', 'Intbconfabclevlh', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfAbcLevlI', 'Intbconfabclevli', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfAbcLevlJ', 'Intbconfabclevlj', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfUseForeignX', 'Intbconfuseforeignx', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseNafta', 'Intbconfusenafta', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfNaftaPrefCode', 'Intbconfnaftaprefcode', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfNaftaProducer', 'Intbconfnaftaproducer', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfNaftaDocCode', 'Intbconfnaftadoccode', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfPhysCurrWksh', 'Intbconfphyscurrwksh', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConf20Or30', 'Intbconf20or30', 'INTEGER', false, 2, null);
        $this->addColumn('IntbConfDispOrigCnt', 'Intbconfdisporigcnt', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDispGl', 'Intbconfdispgl', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDispRef', 'Intbconfdispref', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDispCost', 'Intbconfdispcost', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfPrtVal', 'Intbconfprtval', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfPrtGl', 'Intbconfprtgl', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfGlAcct', 'Intbconfglacct', 'VARCHAR', false, 9, null);
        $this->addColumn('IntbConfRef', 'Intbconfref', 'VARCHAR', false, 20, null);
        $this->addColumn('IntbConfCostType', 'Intbconfcosttype', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfNormalOnly', 'Intbconfnormalonly', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseWhseDef', 'Intbconfusewhsedef', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbCon2DfltWhse01', 'Intbcon2dfltwhse01', 'VARCHAR', false, 2, null);
        $this->addColumn('IntbCon2DfltWhse02', 'Intbcon2dfltwhse02', 'VARCHAR', false, 2, null);
        $this->addColumn('IntbCon2DfltWhse03', 'Intbcon2dfltwhse03', 'VARCHAR', false, 2, null);
        $this->addColumn('IntbCon2DfltWhse04', 'Intbcon2dfltwhse04', 'VARCHAR', false, 2, null);
        $this->addColumn('IntbCon2DfltWhse05', 'Intbcon2dfltwhse05', 'VARCHAR', false, 2, null);
        $this->addColumn('IntbCon2DfltWhse06', 'Intbcon2dfltwhse06', 'VARCHAR', false, 2, null);
        $this->addColumn('IntbCon2DfltWhse07', 'Intbcon2dfltwhse07', 'VARCHAR', false, 2, null);
        $this->addColumn('IntbCon2DfltWhse08', 'Intbcon2dfltwhse08', 'VARCHAR', false, 2, null);
        $this->addColumn('IntbCon2DfltWhse09', 'Intbcon2dfltwhse09', 'VARCHAR', false, 2, null);
        $this->addColumn('IntbCon2DfltWhse10', 'Intbcon2dfltwhse10', 'VARCHAR', false, 2, null);
        $this->addColumn('IntbConfBinDef', 'Intbconfbindef', 'VARCHAR', false, 8, null);
        $this->addColumn('IntbConfCyclDef', 'Intbconfcycldef', 'VARCHAR', false, 2, null);
        $this->addColumn('IntbConfStatDef', 'Intbconfstatdef', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfAbcDef', 'Intbconfabcdef', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfSpecOrdrDef', 'Intbconfspecordrdef', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfOrdrPntDef', 'Intbconfordrpntdef', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfMaxDef', 'Intbconfmaxdef', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfOrdrQtyDef', 'Intbconfordrqtydef', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfTrcptAllowCmpl', 'Intbconftrcptallowcmpl', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfTreCmmtStock', 'Intbconftrecmmtstock', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseFrtIn', 'Intbconfusefrtin', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfEachOrUom', 'Intbconfeachoruom', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfNegLotCorr', 'Intbconfneglotcorr', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfTrnsGlAcct', 'Intbconftrnsglacct', 'VARCHAR', false, 9, null);
        $this->addColumn('IntbConfTrnsProtStock', 'Intbconftrnsprotstock', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfNumericItem', 'Intbconfnumericitem', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfItemDigits', 'Intbconfitemdigits', 'INTEGER', false, 2, null);
        $this->addColumn('IntbConfSingleWhse', 'Intbconfsinglewhse', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUpdUsePct', 'Intbconfupdusepct', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUpdPric', 'Intbconfupdpric', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUpdStdCost', 'Intbconfupdstdcost', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUpdXrefCost', 'Intbconfupdxrefcost', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfIqpaUpdDate', 'Intbconfiqpaupddate', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUpcXrefOptn', 'Intbconfupcxrefoptn', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfResqYN', 'Intbconfresqyn', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfResqItemBin', 'Intbconfresqitembin', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfResvCost', 'Intbconfresvcost', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbCon2TranZeroRqst', 'Intbcon2tranzerorqst', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfMonEndAdjDate', 'Intbconfmonendadjdate', 'VARCHAR', false, 8, null);
        $this->addColumn('IntbConfMonEndTrnDate', 'Intbconfmonendtrndate', 'VARCHAR', false, 8, null);
        $this->addColumn('IntbConfMonEndLogDate', 'Intbconfmonendlogdate', 'VARCHAR', false, 8, null);
        $this->addColumn('IntbConfDStatProc', 'Intbconfdstatproc', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfStanCostUpd', 'Intbconfstancostupd', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfLastCost', 'Intbconflastcost', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseSOrGPct', 'Intbconfusesorgpct', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfAddOnStan', 'Intbconfaddonstan', 'DECIMAL', false, 20, null);
        $this->addColumn('IntbConfStdCostError', 'Intbconfstdcosterror', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfAvgCurrFive', 'Intbconfavgcurrfive', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseCntrlBin', 'Intbconfusecntrlbin', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfNbrBinAreas', 'Intbconfnbrbinareas', 'INTEGER', false, 1, null);
        $this->addColumn('IntbConfUseMultBin', 'Intbconfusemultbin', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDfltWhseBin', 'Intbconfdfltwhsebin', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDfltBin', 'Intbconfdfltbin', 'VARCHAR', false, 8, null);
        $this->addColumn('IntbConfCtryItemLot', 'Intbconfctryitemlot', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseShipBin', 'Intbconfuseshipbin', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbCon2PrtBinrLabel', 'Intbcon2prtbinrlabel', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbCon2ItemLookup', 'Intbcon2itemlookup', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfIncldCti', 'Intbconfincldcti', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfCertImage', 'Intbconfcertimage', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDrawImage', 'Intbconfdrawimage', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfConfirmImage', 'Intbconfconfirmimage', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbCon2ProductImage', 'Intbcon2productimage', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDefPick', 'Intbconfdefpick', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDefPack', 'Intbconfdefpack', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDefInvc', 'Intbconfdefinvc', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDefAck', 'Intbconfdefack', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDefQuot', 'Intbconfdefquot', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDefPo', 'Intbconfdefpo', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDefTrans', 'Intbconfdeftrans', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfAdjGlCogs', 'Intbconfadjglcogs', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbCon2DfltAdjGlAcct', 'Intbcon2dfltadjglacct', 'VARCHAR', false, 9, null);
        $this->addColumn('IntbConfAdjCostBase', 'Intbconfadjcostbase', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDfltAdjtBin', 'Intbconfdfltadjtbin', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfAdjtBin', 'Intbconfadjtbin', 'VARCHAR', false, 8, null);
        $this->addColumn('IntbConfCStockSeq', 'Intbconfcstockseq', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfCStockHistDay', 'Intbconfcstockhistday', 'INTEGER', false, 6, null);
        $this->addColumn('IntbConfCStockFormat', 'Intbconfcstockformat', 'VARCHAR', false, 8, null);
        $this->addColumn('IntbConfCstkExportItem', 'Intbconfcstkexportitem', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfCstkPdmContract', 'Intbconfcstkpdmcontract', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbCon2ImportSeq', 'Intbcon2importseq', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfStopItemChg', 'Intbconfstopitemchg', 'INTEGER', false, 4, null);
        $this->addColumn('IntbConfAddToMxrfe', 'Intbconfaddtomxrfe', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfMxrfeVendId', 'Intbconfmxrfevendid', 'VARCHAR', false, 6, null);
        $this->addColumn('IntbCon2NewIdLabelList', 'Intbcon2newidlabellist', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfUseFormat', 'Intbconfuseformat', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfDefFormat', 'Intbconfdefformat', 'VARCHAR', false, 2, null);
        $this->addColumn('IntbConfSeqShortItem', 'Intbconfseqshortitem', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfShortItemLen', 'Intbconfshortitemlen', 'INTEGER', false, 2, null);
        $this->addColumn('IntbConfUseScale', 'Intbconfusescale', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfStoreWght', 'Intbconfstorewght', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfValidAsstCode', 'Intbconfvalidasstcode', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbConfWhiteGoods', 'Intbconfwhitegoods', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbCon2TransCustId', 'Intbcon2transcustid', 'VARCHAR', false, 6, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ConfigInTableMap::COL_INTBCONFRESQITEMBIN);
            ...
            $criteria->addSelectColumn($alias . '.IntbConfResqItemBin');
