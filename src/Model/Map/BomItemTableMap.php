...
class BomItemTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.BomItemTableMap';
     ...
     */
    public const TABLE_NAME = 'pr_bmat_head';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'BomItem';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\BomItem';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'BomItem';
     ...
     */
    public const COL_BOMHPRODITEM = 'pr_bmat_head.BomhProdItem';

    /**
     * the column name for the BomhLevel field
     */
    public const COL_BOMHLEVEL = 'pr_bmat_head.BomhLevel';

    /**
     * the column name for the DateUpdtd field
     */
    public const COL_DATEUPDTD = 'pr_bmat_head.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    public const COL_TIMEUPDTD = 'pr_bmat_head.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    public const COL_DUMMY = 'pr_bmat_head.dummy';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Bomhproditem', 'Bomhlevel', 'Dateupdtd', 'Timeupdtd', 'Dummy', ],
        self::TYPE_CAMELNAME     => ['bomhproditem', 'bomhlevel', 'dateupdtd', 'timeupdtd', 'dummy', ],
        self::TYPE_COLNAME       => [BomItemTableMap::COL_BOMHPRODITEM, BomItemTableMap::COL_BOMHLEVEL, BomItemTableMap::COL_DATEUPDTD, BomItemTableMap::COL_TIMEUPDTD, BomItemTableMap::COL_DUMMY, ],
        self::TYPE_FIELDNAME     => ['BomhProdItem', 'BomhLevel', 'DateUpdtd', 'TimeUpdtd', 'dummy', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Bomhproditem' => 0, 'Bomhlevel' => 1, 'Dateupdtd' => 2, 'Timeupdtd' => 3, 'Dummy' => 4, ],
        self::TYPE_CAMELNAME     => ['bomhproditem' => 0, 'bomhlevel' => 1, 'dateupdtd' => 2, 'timeupdtd' => 3, 'dummy' => 4, ],
        self::TYPE_COLNAME       => [BomItemTableMap::COL_BOMHPRODITEM => 0, BomItemTableMap::COL_BOMHLEVEL => 1, BomItemTableMap::COL_DATEUPDTD => 2, BomItemTableMap::COL_TIMEUPDTD => 3, BomItemTableMap::COL_DUMMY => 4, ],
        self::TYPE_FIELDNAME     => ['BomhProdItem' => 0, 'BomhLevel' => 1, 'DateUpdtd' => 2, 'TimeUpdtd' => 3, 'dummy' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'BomItem.Bomhproditem' => 'BOMHPRODITEM',
        'bomhproditem' => 'BOMHPRODITEM',
        'bomItem.bomhproditem' => 'BOMHPRODITEM',
        'BomItemTableMap::COL_BOMHPRODITEM' => 'BOMHPRODITEM',
        'COL_BOMHPRODITEM' => 'BOMHPRODITEM',
        'BomhProdItem' => 'BOMHPRODITEM',
        'pr_bmat_head.BomhProdItem' => 'BOMHPRODITEM',
        'Bomhlevel' => 'BOMHLEVEL',
        'BomItem.Bomhlevel' => 'BOMHLEVEL',
        'bomhlevel' => 'BOMHLEVEL',
        'bomItem.bomhlevel' => 'BOMHLEVEL',
        'BomItemTableMap::COL_BOMHLEVEL' => 'BOMHLEVEL',
        'COL_BOMHLEVEL' => 'BOMHLEVEL',
        'BomhLevel' => 'BOMHLEVEL',
        'pr_bmat_head.BomhLevel' => 'BOMHLEVEL',
        'Dateupdtd' => 'DATEUPDTD',
        'BomItem.Dateupdtd' => 'DATEUPDTD',
        'dateupdtd' => 'DATEUPDTD',
        'bomItem.dateupdtd' => 'DATEUPDTD',
        'BomItemTableMap::COL_DATEUPDTD' => 'DATEUPDTD',
        'COL_DATEUPDTD' => 'DATEUPDTD',
        'DateUpdtd' => 'DATEUPDTD',
        'pr_bmat_head.DateUpdtd' => 'DATEUPDTD',
        'Timeupdtd' => 'TIMEUPDTD',
        'BomItem.Timeupdtd' => 'TIMEUPDTD',
        'timeupdtd' => 'TIMEUPDTD',
        'bomItem.timeupdtd' => 'TIMEUPDTD',
        'BomItemTableMap::COL_TIMEUPDTD' => 'TIMEUPDTD',
        'COL_TIMEUPDTD' => 'TIMEUPDTD',
        'TimeUpdtd' => 'TIMEUPDTD',
        'pr_bmat_head.TimeUpdtd' => 'TIMEUPDTD',
        'Dummy' => 'DUMMY',
        'BomItem.Dummy' => 'DUMMY',
        'dummy' => 'DUMMY',
        'bomItem.dummy' => 'DUMMY',
        'BomItemTableMap::COL_DUMMY' => 'DUMMY',
        'COL_DUMMY' => 'DUMMY',
        'pr_bmat_head.dummy' => 'DUMMY',
    ];
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(BomItemTableMap::COL_BOMHPRODITEM);
            $criteria->removeSelectColumn(BomItemTableMap::COL_BOMHLEVEL);
            $criteria->removeSelectColumn(BomItemTableMap::COL_DATEUPDTD);
            $criteria->removeSelectColumn(BomItemTableMap::COL_TIMEUPDTD);
            $criteria->removeSelectColumn(BomItemTableMap::COL_DUMMY);
        } else {
            $criteria->removeSelectColumn($alias . '.BomhProdItem');
            $criteria->removeSelectColumn($alias . '.BomhLevel');
