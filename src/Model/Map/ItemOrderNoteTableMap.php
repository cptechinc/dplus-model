...
/**
 * This class defines the structure of the 'notes_item_order' table.
 *
 *
 *
...
class ItemOrderNoteTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('ItemOrderNote');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\ItemOrderNote');
        $this->setPackage('');
        ...
        $this->addColumn('QnOrdrFabPo', 'Qnordrfabpo', 'VARCHAR', false, 1, null);
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \ItemOrderNote) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \ItemOrderNote object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if (null !== ($obj = ItemOrderNoteTableMap::getInstanceFromPool($key))) {
            ...
            $col = $offset + ItemOrderNoteTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = ItemOrderNoteTableMap::OM_CLASS;
            /** @var ItemOrderNote $obj */
            $obj = new $cls();
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = ItemOrderNoteTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = ItemOrderNoteTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNTYPEDESC);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_INITITEMNBR);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNORDRPICKTICKET);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNORDRPACKTICKET);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNORDRINVOICE);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNORDRACKNOW);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNORDRQUOTE);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNORDRPURCHORDR);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNORDRTRANSFER);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNORDRFABPO);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNSEQ);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNNOTE);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNKEY2);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_QNFORM);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_DATEUPDTD);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_TIMEUPDTD);
            $criteria->addSelectColumn(ItemOrderNoteTableMap::COL_DUMMY);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.QnOrdrFabPo');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ItemOrderNote) { // it's a model object
            ...
            foreach ($values as $value) {
                ...
                $criterion->addAnd($criteria->getNewCriterion(ItemOrderNoteTableMap::COL_QNSEQ, $value[1]));
                $criterion->addAnd($criteria->getNewCriterion(ItemOrderNoteTableMap::COL_QNKEY2, $value[2]));
                $criterion->addAnd($criteria->getNewCriterion(ItemOrderNoteTableMap::COL_QNFORM, $value[3]));
                $criteria->addOr($criterion);
            }
        }

        $query = ItemOrderNoteQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            ItemOrderNoteTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                ItemOrderNoteTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from ItemOrderNote object
        }
