...
class TaxCodeStateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.TaxCodeStateTableMap';
     ...
     */
    const TABLE_NAME = 'ar_cust_txst';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\TaxCodeState';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TaxCodeState';
     ...
     */
    const COL_ARTBSTATE = 'ar_cust_txst.ArtbState';

    /**
     * the column name for the ArtbTxstTaxCode field
     */
    const COL_ARTBTXSTTAXCODE = 'ar_cust_txst.ArtbTxstTaxCode';

    /**
     * the column name for the DateUpdtd field
     */
    const COL_DATEUPDTD = 'ar_cust_txst.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    const COL_TIMEUPDTD = 'ar_cust_txst.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    const COL_DUMMY = 'ar_cust_txst.dummy';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Artbstate', 'Artbtxsttaxcode', 'Dateupdtd', 'Timeupdtd', 'Dummy', ),
        self::TYPE_CAMELNAME     => array('artbstate', 'artbtxsttaxcode', 'dateupdtd', 'timeupdtd', 'dummy', ),
        self::TYPE_COLNAME       => array(TaxCodeStateTableMap::COL_ARTBSTATE, TaxCodeStateTableMap::COL_ARTBTXSTTAXCODE, TaxCodeStateTableMap::COL_DATEUPDTD, TaxCodeStateTableMap::COL_TIMEUPDTD, TaxCodeStateTableMap::COL_DUMMY, ),
        self::TYPE_FIELDNAME     => array('ArtbState', 'ArtbTxstTaxCode', 'DateUpdtd', 'TimeUpdtd', 'dummy', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Artbstate' => 0, 'Artbtxsttaxcode' => 1, 'Dateupdtd' => 2, 'Timeupdtd' => 3, 'Dummy' => 4, ),
        self::TYPE_CAMELNAME     => array('artbstate' => 0, 'artbtxsttaxcode' => 1, 'dateupdtd' => 2, 'timeupdtd' => 3, 'dummy' => 4, ),
        self::TYPE_COLNAME       => array(TaxCodeStateTableMap::COL_ARTBSTATE => 0, TaxCodeStateTableMap::COL_ARTBTXSTTAXCODE => 1, TaxCodeStateTableMap::COL_DATEUPDTD => 2, TaxCodeStateTableMap::COL_TIMEUPDTD => 3, TaxCodeStateTableMap::COL_DUMMY => 4, ),
        self::TYPE_FIELDNAME     => array('ArtbState' => 0, 'ArtbTxstTaxCode' => 1, 'DateUpdtd' => 2, 'TimeUpdtd' => 3, 'dummy' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(TaxCodeStateTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(TaxCodeStateTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new TaxCodeStateTableMap());
        }
    }
...
} // TaxCodeStateTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
TaxCodeStateTableMap::buildTableMap();
