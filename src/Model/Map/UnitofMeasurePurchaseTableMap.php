...
class UnitofMeasurePurchaseTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.UnitofMeasurePurchaseTableMap';
     ...
     */
    public const TABLE_NAME = 'inv_uom_pur';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'UnitofMeasurePurchase';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\UnitofMeasurePurchase';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'UnitofMeasurePurchase';
     ...
     */
    public const COL_INTBUOMPUR = 'inv_uom_pur.IntbUomPur';

    /**
     * the column name for the IntbUomDesc field
     */
    public const COL_INTBUOMDESC = 'inv_uom_pur.IntbUomDesc';

    /**
     * the column name for the IntbUomConv field
     */
    public const COL_INTBUOMCONV = 'inv_uom_pur.IntbUomConv';

    /**
     * the column name for the IntbUomPricByWght field
     */
    public const COL_INTBUOMPRICBYWGHT = 'inv_uom_pur.IntbUomPricByWght';

    /**
     * the column name for the IntbUomStockByCase field
     */
    public const COL_INTBUOMSTOCKBYCASE = 'inv_uom_pur.IntbUomStockByCase';

    /**
     * the column name for the DateUpdtd field
     */
    public const COL_DATEUPDTD = 'inv_uom_pur.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    public const COL_TIMEUPDTD = 'inv_uom_pur.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    public const COL_DUMMY = 'inv_uom_pur.dummy';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Intbuompur', 'Intbuomdesc', 'Intbuomconv', 'Intbuompricbywght', 'IntbUomStockByCase', 'Dateupdtd', 'Timeupdtd', 'Dummy', ],
        self::TYPE_CAMELNAME     => ['intbuompur', 'intbuomdesc', 'intbuomconv', 'intbuompricbywght', 'intbUomStockByCase', 'dateupdtd', 'timeupdtd', 'dummy', ],
        self::TYPE_COLNAME       => [UnitofMeasurePurchaseTableMap::COL_INTBUOMPUR, UnitofMeasurePurchaseTableMap::COL_INTBUOMDESC, UnitofMeasurePurchaseTableMap::COL_INTBUOMCONV, UnitofMeasurePurchaseTableMap::COL_INTBUOMPRICBYWGHT, UnitofMeasurePurchaseTableMap::COL_INTBUOMSTOCKBYCASE, UnitofMeasurePurchaseTableMap::COL_DATEUPDTD, UnitofMeasurePurchaseTableMap::COL_TIMEUPDTD, UnitofMeasurePurchaseTableMap::COL_DUMMY, ],
        self::TYPE_FIELDNAME     => ['IntbUomPur', 'IntbUomDesc', 'IntbUomConv', 'IntbUomPricByWght', 'IntbUomStockByCase', 'DateUpdtd', 'TimeUpdtd', 'dummy', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Intbuompur' => 0, 'Intbuomdesc' => 1, 'Intbuomconv' => 2, 'Intbuompricbywght' => 3, 'IntbUomStockByCase' => 4, 'Dateupdtd' => 5, 'Timeupdtd' => 6, 'Dummy' => 7, ],
        self::TYPE_CAMELNAME     => ['intbuompur' => 0, 'intbuomdesc' => 1, 'intbuomconv' => 2, 'intbuompricbywght' => 3, 'intbUomStockByCase' => 4, 'dateupdtd' => 5, 'timeupdtd' => 6, 'dummy' => 7, ],
        self::TYPE_COLNAME       => [UnitofMeasurePurchaseTableMap::COL_INTBUOMPUR => 0, UnitofMeasurePurchaseTableMap::COL_INTBUOMDESC => 1, UnitofMeasurePurchaseTableMap::COL_INTBUOMCONV => 2, UnitofMeasurePurchaseTableMap::COL_INTBUOMPRICBYWGHT => 3, UnitofMeasurePurchaseTableMap::COL_INTBUOMSTOCKBYCASE => 4, UnitofMeasurePurchaseTableMap::COL_DATEUPDTD => 5, UnitofMeasurePurchaseTableMap::COL_TIMEUPDTD => 6, UnitofMeasurePurchaseTableMap::COL_DUMMY => 7, ],
        self::TYPE_FIELDNAME     => ['IntbUomPur' => 0, 'IntbUomDesc' => 1, 'IntbUomConv' => 2, 'IntbUomPricByWght' => 3, 'IntbUomStockByCase' => 4, 'DateUpdtd' => 5, 'TimeUpdtd' => 6, 'dummy' => 7, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'UnitofMeasurePurchase.Intbuompur' => 'INTBUOMPUR',
        'intbuompur' => 'INTBUOMPUR',
        'unitofMeasurePurchase.intbuompur' => 'INTBUOMPUR',
        'UnitofMeasurePurchaseTableMap::COL_INTBUOMPUR' => 'INTBUOMPUR',
        'COL_INTBUOMPUR' => 'INTBUOMPUR',
        'IntbUomPur' => 'INTBUOMPUR',
        'inv_uom_pur.IntbUomPur' => 'INTBUOMPUR',
        'Intbuomdesc' => 'INTBUOMDESC',
        'UnitofMeasurePurchase.Intbuomdesc' => 'INTBUOMDESC',
        'intbuomdesc' => 'INTBUOMDESC',
        'unitofMeasurePurchase.intbuomdesc' => 'INTBUOMDESC',
        'UnitofMeasurePurchaseTableMap::COL_INTBUOMDESC' => 'INTBUOMDESC',
        'COL_INTBUOMDESC' => 'INTBUOMDESC',
        'IntbUomDesc' => 'INTBUOMDESC',
        'inv_uom_pur.IntbUomDesc' => 'INTBUOMDESC',
        'Intbuomconv' => 'INTBUOMCONV',
        'UnitofMeasurePurchase.Intbuomconv' => 'INTBUOMCONV',
        'intbuomconv' => 'INTBUOMCONV',
        'unitofMeasurePurchase.intbuomconv' => 'INTBUOMCONV',
        'UnitofMeasurePurchaseTableMap::COL_INTBUOMCONV' => 'INTBUOMCONV',
        'COL_INTBUOMCONV' => 'INTBUOMCONV',
        'IntbUomConv' => 'INTBUOMCONV',
        'inv_uom_pur.IntbUomConv' => 'INTBUOMCONV',
        'Intbuompricbywght' => 'INTBUOMPRICBYWGHT',
        'UnitofMeasurePurchase.Intbuompricbywght' => 'INTBUOMPRICBYWGHT',
        'intbuompricbywght' => 'INTBUOMPRICBYWGHT',
        'unitofMeasurePurchase.intbuompricbywght' => 'INTBUOMPRICBYWGHT',
        'UnitofMeasurePurchaseTableMap::COL_INTBUOMPRICBYWGHT' => 'INTBUOMPRICBYWGHT',
        'COL_INTBUOMPRICBYWGHT' => 'INTBUOMPRICBYWGHT',
        'IntbUomPricByWght' => 'INTBUOMPRICBYWGHT',
        'inv_uom_pur.IntbUomPricByWght' => 'INTBUOMPRICBYWGHT',
        'IntbUomStockByCase' => 'INTBUOMSTOCKBYCASE',
        'UnitofMeasurePurchase.IntbUomStockByCase' => 'INTBUOMSTOCKBYCASE',
        'intbUomStockByCase' => 'INTBUOMSTOCKBYCASE',
        'unitofMeasurePurchase.intbUomStockByCase' => 'INTBUOMSTOCKBYCASE',
        'UnitofMeasurePurchaseTableMap::COL_INTBUOMSTOCKBYCASE' => 'INTBUOMSTOCKBYCASE',
        'COL_INTBUOMSTOCKBYCASE' => 'INTBUOMSTOCKBYCASE',
        'inv_uom_pur.IntbUomStockByCase' => 'INTBUOMSTOCKBYCASE',
        'Dateupdtd' => 'DATEUPDTD',
        'UnitofMeasurePurchase.Dateupdtd' => 'DATEUPDTD',
        'dateupdtd' => 'DATEUPDTD',
        'unitofMeasurePurchase.dateupdtd' => 'DATEUPDTD',
        'UnitofMeasurePurchaseTableMap::COL_DATEUPDTD' => 'DATEUPDTD',
        'COL_DATEUPDTD' => 'DATEUPDTD',
        'DateUpdtd' => 'DATEUPDTD',
        'inv_uom_pur.DateUpdtd' => 'DATEUPDTD',
        'Timeupdtd' => 'TIMEUPDTD',
        'UnitofMeasurePurchase.Timeupdtd' => 'TIMEUPDTD',
        'timeupdtd' => 'TIMEUPDTD',
        'unitofMeasurePurchase.timeupdtd' => 'TIMEUPDTD',
        'UnitofMeasurePurchaseTableMap::COL_TIMEUPDTD' => 'TIMEUPDTD',
        'COL_TIMEUPDTD' => 'TIMEUPDTD',
        'TimeUpdtd' => 'TIMEUPDTD',
        'inv_uom_pur.TimeUpdtd' => 'TIMEUPDTD',
        'Dummy' => 'DUMMY',
        'UnitofMeasurePurchase.Dummy' => 'DUMMY',
        'dummy' => 'DUMMY',
        'unitofMeasurePurchase.dummy' => 'DUMMY',
        'UnitofMeasurePurchaseTableMap::COL_DUMMY' => 'DUMMY',
        'COL_DUMMY' => 'DUMMY',
        'inv_uom_pur.dummy' => 'DUMMY',
    ];
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(UnitofMeasurePurchaseTableMap::COL_INTBUOMPUR);
            $criteria->removeSelectColumn(UnitofMeasurePurchaseTableMap::COL_INTBUOMDESC);
            $criteria->removeSelectColumn(UnitofMeasurePurchaseTableMap::COL_INTBUOMCONV);
            $criteria->removeSelectColumn(UnitofMeasurePurchaseTableMap::COL_INTBUOMPRICBYWGHT);
            $criteria->removeSelectColumn(UnitofMeasurePurchaseTableMap::COL_INTBUOMSTOCKBYCASE);
            $criteria->removeSelectColumn(UnitofMeasurePurchaseTableMap::COL_DATEUPDTD);
            $criteria->removeSelectColumn(UnitofMeasurePurchaseTableMap::COL_TIMEUPDTD);
            $criteria->removeSelectColumn(UnitofMeasurePurchaseTableMap::COL_DUMMY);
        } else {
