...
class SalesHistoryTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('OehhStAdr1', 'Oehhstadr1', 'VARCHAR', false, 30, null);
        $this->addColumn('OehhStAdr2', 'Oehhstadr2', 'VARCHAR', false, 30, null);
        $this->addColumn('OehhStAdr3', 'Oehhstadr3', 'VARCHAR', false, 30, null);
        $this->addColumn('OehhStCtry', 'Oehhstctry', 'VARCHAR', false, 4, null);
        $this->addColumn('OehhStCity', 'Oehhstcity', 'VARCHAR', false, 16, null);
        $this->addColumn('OehhStStat', 'Oehhststat', 'VARCHAR', false, 2, null);
        $this->addColumn('OehhStZipCode', 'Oehhstzipcode', 'VARCHAR', false, 10, null);
        $this->addColumn('OehhCustPo', 'Oehhcustpo', 'VARCHAR', false, 20, null);
        $this->addColumn('OehhOrdrDate', 'Oehhordrdate', 'VARCHAR', false, 8, null);
        ...
        $this->addColumn('OehhInvDate', 'Oehhinvdate', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhGLPd', 'Oehhglpd', 'INTEGER', false, 2, null);
        $this->addColumn('ArspSalePer1', 'Arspsaleper1', 'VARCHAR', false, 6, null);
        $this->addColumn('OehhSp1Pct', 'Oehhsp1pct', 'DECIMAL', false, 20, null);
        $this->addColumn('ArspSalePer2', 'Arspsaleper2', 'VARCHAR', false, 6, null);
        $this->addColumn('OehhSp2Pct', 'Oehhsp2pct', 'DECIMAL', false, 20, null);
        $this->addColumn('ArspSalePer3', 'Arspsaleper3', 'VARCHAR', false, 6, null);
        $this->addColumn('OehhSp3Pct', 'Oehhsp3pct', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhCntrNbr', 'Oehhcntrnbr', 'INTEGER', false, 8, null);
        $this->addColumn('OehhWiBatch', 'Oehhwibatch', 'INTEGER', false, 8, null);
        $this->addColumn('OehhDropRelHold', 'Oehhdroprelhold', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhTaxSub', 'Oehhtaxsub', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhNonTaxSub', 'Oehhnontaxsub', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhTaxTot', 'Oehhtaxtot', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhFrtTot', 'Oehhfrttot', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhMiscTot', 'Oehhmisctot', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhOrdrTot', 'Oehhordrtot', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhCostTot', 'Oehhcosttot', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhSpCommLock', 'Oehhspcommlock', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhTakenDate', 'Oehhtakendate', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhTakenTime', 'Oehhtakentime', 'VARCHAR', false, 4, null);
        $this->addColumn('OehhPickDate', 'Oehhpickdate', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhPickTime', 'Oehhpicktime', 'VARCHAR', false, 4, null);
        $this->addColumn('OehhPackDate', 'Oehhpackdate', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhPackTime', 'Oehhpacktime', 'VARCHAR', false, 4, null);
        $this->addColumn('OehhVerifyDate', 'Oehhverifydate', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhVerifyTime', 'Oehhverifytime', 'VARCHAR', false, 4, null);
        $this->addColumn('OehhCreditMemo', 'Oehhcreditmemo', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhBookedYn', 'Oehhbookedyn', 'VARCHAR', false, 1, null);
        $this->addColumn('IntbWhseOrig', 'Intbwhseorig', 'VARCHAR', false, 2, null);
        $this->addColumn('OehhBtStat', 'Oehhbtstat', 'VARCHAR', false, 2, null);
        $this->addColumn('OehhShipComp', 'Oehhshipcomp', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhCwoFlag', 'Oehhcwoflag', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhDivision', 'Oehhdivision', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhTakenCode', 'Oehhtakencode', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhPickCode', 'Oehhpickcode', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhPackCode', 'Oehhpackcode', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhVerifyCode', 'Oehhverifycode', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhTotDisc', 'Oehhtotdisc', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhEdiRefNbrQual', 'Oehhedirefnbrqual', 'VARCHAR', false, 3, null);
        $this->addColumn('OehhUserCode1', 'Oehhusercode1', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhUserCode2', 'Oehhusercode2', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhUserCode3', 'Oehhusercode3', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhUserCode4', 'Oehhusercode4', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhExchCtry', 'Oehhexchctry', 'VARCHAR', false, 4, null);
        $this->addColumn('OehhExchRate', 'Oehhexchrate', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhWghtTot', 'Oehhwghttot', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhWghtOride', 'Oehhwghtoride', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhCcInfo', 'Oehhccinfo', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhBoxCount', 'Oehhboxcount', 'INTEGER', false, 5, null);
        $this->addColumn('OehhRqstDate', 'Oehhrqstdate', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhCancDate', 'Oehhcancdate', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhCrntUser', 'Oehhcrntuser', 'VARCHAR', false, 12, null);
        $this->addColumn('OehhReleaseNbr', 'Oehhreleasenbr', 'VARCHAR', false, 20, null);
        $this->addColumn('IntbWhse', 'Intbwhse', 'VARCHAR', false, 2, null);
        $this->addColumn('OehhBordBuildDate', 'Oehhbordbuilddate', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDeptCode', 'Oehhdeptcode', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhFrtInEntered', 'Oehhfrtinentered', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhDropShipEntered', 'Oehhdropshipentered', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhErFlag', 'Oehherflag', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhFrtIn', 'Oehhfrtin', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDropShip', 'Oehhdropship', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhMinOrder', 'Oehhminorder', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhContractTerms', 'Oehhcontractterms', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhDropShipBilled', 'Oehhdropshipbilled', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhOrdTyp', 'Oehhordtyp', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhTrackNbr', 'Oehhtracknbr', 'VARCHAR', false, 15, null);
        $this->addColumn('OehhSource', 'Oehhsource', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhCcAprv', 'Oehhccaprv', 'VARCHAR', false, 6, null);
        $this->addColumn('OehhPickFmatType', 'Oehhpickfmattype', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhInvcFmatType', 'Oehhinvcfmattype', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhCashAmt', 'Oehhcashamt', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhCheckAmt', 'Oehhcheckamt', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhCheckNbr', 'Oehhchecknbr', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDepositAmt', 'Oehhdepositamt', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDepositNbr', 'Oehhdepositnbr', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhCcAmt', 'Oehhccamt', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhOTaxSub', 'Oehhotaxsub', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhONonTaxSub', 'Oehhonontaxsub', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhOTaxTot', 'Oehhotaxtot', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhOOrdrTot', 'Oehhoordrtot', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhPickPrintDate', 'Oehhpickprintdate', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhPickPrintTime', 'Oehhpickprinttime', 'VARCHAR', false, 4, null);
        $this->addColumn('OehhCont', 'Oehhcont', 'VARCHAR', false, 20, null);
        $this->addColumn('OehhContTeleIntl', 'Oehhcontteleintl', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhContTeleNbr', 'Oehhconttelenbr', 'VARCHAR', false, 22, null);
        $this->addColumn('OehhContTeleExt', 'Oehhcontteleext', 'VARCHAR', false, 7, null);
        $this->addColumn('OehhContFaxIntl', 'Oehhcontfaxintl', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhContFaxNbr', 'Oehhcontfaxnbr', 'VARCHAR', false, 22, null);
        $this->addColumn('OehhShipAcct', 'Oehhshipacct', 'VARCHAR', false, 10, null);
        $this->addColumn('OehhChgDue', 'Oehhchgdue', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhAddlPricDisc', 'Oehhaddlpricdisc', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhAllShip', 'Oehhallship', 'VARCHAR', false, 2, null);
        $this->addColumn('OehhQtyOrderAmt', 'Oehhqtyorderamt', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhCreditApplied', 'Oehhcreditapplied', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhInvcPrintDate', 'Oehhinvcprintdate', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhInvcPrintTime', 'Oehhinvcprinttime', 'VARCHAR', false, 4, null);
        $this->addColumn('OehhDiscFrt', 'Oehhdiscfrt', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhOrideShipComp', 'Oehhorideshipcomp', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhContEmail', 'Oehhcontemail', 'VARCHAR', false, 50, null);
        $this->addColumn('OehhManualFrt', 'Oehhmanualfrt', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhInternalFrt', 'Oehhinternalfrt', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhFrtCost', 'Oehhfrtcost', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhRoute', 'Oehhroute', 'VARCHAR', false, 4, null);
        $this->addColumn('OehhRouteSeq', 'Oehhrouteseq', 'INTEGER', false, 4, null);
        $this->addColumn('OehhFrtTaxCode1', 'Oehhfrttaxcode1', 'VARCHAR', false, 6, null);
        $this->addColumn('OehhFrtTaxAmt1', 'Oehhfrttaxamt1', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhFrtTaxCode2', 'Oehhfrttaxcode2', 'VARCHAR', false, 6, null);
        $this->addColumn('OehhFrtTaxAmt2', 'Oehhfrttaxamt2', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhFrtTaxCode3', 'Oehhfrttaxcode3', 'VARCHAR', false, 6, null);
        $this->addColumn('OehhFrtTaxAmt3', 'Oehhfrttaxamt3', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhFrtTaxCode4', 'Oehhfrttaxcode4', 'VARCHAR', false, 6, null);
        $this->addColumn('OehhFrtTaxAmt4', 'Oehhfrttaxamt4', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhFrtTaxCode5', 'Oehhfrttaxcode5', 'VARCHAR', false, 6, null);
        $this->addColumn('OehhFrtTaxAmt5', 'Oehhfrttaxamt5', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhEdi855Sent', 'Oehhedi855sent', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhFrt3rdParty', 'Oehhfrt3rdparty', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhFob', 'Oehhfob', 'VARCHAR', false, 15, null);
        $this->addColumn('OehhConfirmImagYn', 'Oehhconfirmimagyn', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhIndustConform', 'Oehhindustconform', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhCstkConsign', 'Oehhcstkconsign', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhLmDelayCapSent', 'Oehhlmdelaycapsent', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhMfgId', 'Oehhmfgid', 'VARCHAR', false, 6, null);
        $this->addColumn('OehhStoreId', 'Oehhstoreid', 'VARCHAR', false, 6, null);
        $this->addColumn('OehhPickQueue', 'Oehhpickqueue', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhArrvDate', 'Oehharrvdate', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhSurchgStat', 'Oehhsurchgstat', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhFrtGrup', 'Oehhfrtgrup', 'VARCHAR', false, 2, null);
        $this->addColumn('OehhCommOride', 'Oehhcommoride', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhChrgSplt', 'Oehhchrgsplt', 'VARCHAR', false, 1, null);
        $this->addColumn('OehhAcCcAprv', 'Oehhacccaprv', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhOrigOrdrNbr', 'Oehhorigordrnbr', 'VARCHAR', false, 10, null);
        $this->addColumn('OehhPostDate', 'Oehhpostdate', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDiscDate1', 'Oehhdiscdate1', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDiscPct1', 'Oehhdiscpct1', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDueDate1', 'Oehhduedate1', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDueAmt1', 'Oehhdueamt1', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDuePct1', 'Oehhduepct1', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDiscDate2', 'Oehhdiscdate2', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDiscPct2', 'Oehhdiscpct2', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDueDate2', 'Oehhduedate2', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDueAmt2', 'Oehhdueamt2', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDuePct2', 'Oehhduepct2', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDiscDate3', 'Oehhdiscdate3', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDiscPct3', 'Oehhdiscpct3', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDueDate3', 'Oehhduedate3', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDueAmt3', 'Oehhdueamt3', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDuePct3', 'Oehhduepct3', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDiscDate4', 'Oehhdiscdate4', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDiscPct4', 'Oehhdiscpct4', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDueDate4', 'Oehhduedate4', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDueAmt4', 'Oehhdueamt4', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDuePct4', 'Oehhduepct4', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDiscDate5', 'Oehhdiscdate5', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDiscPct5', 'Oehhdiscpct5', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDueDate5', 'Oehhduedate5', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDueAmt5', 'Oehhdueamt5', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDuePct5', 'Oehhduepct5', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDiscDate6', 'Oehhdiscdate6', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDiscPct6', 'Oehhdiscpct6', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDueDate6', 'Oehhduedate6', 'VARCHAR', false, 8, null);
        $this->addColumn('OehhDueAmt6', 'Oehhdueamt6', 'DECIMAL', false, 20, null);
        $this->addColumn('OehhDuePct6', 'Oehhduepct6', 'DECIMAL', false, 20, null);
