...
class SalesHistoryTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('OehhNbr', 'Oehhnbr', 'VARCHAR', true, 10, '');
        $this->addColumn('OehhYear', 'Oehhyear', 'VARCHAR', true, 4, '');
        $this->addColumn('OehhStat', 'Oehhstat', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhHold', 'Oehhhold', 'VARCHAR', true, 1, 'N');
        ...
        $this->addColumn('OehhInvDate', 'Oehhinvdate', 'VARCHAR', true, 8, '');
        ...
        $this->addColumn('OehhDropRelHold', 'Oehhdroprelhold', 'VARCHAR', true, 1, '');
        ...
        $this->addColumn('OehhSpCommLock', 'Oehhspcommlock', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhTakenDate', 'Oehhtakendate', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhTakenTime', 'Oehhtakentime', 'VARCHAR', true, 4, '');
        $this->addColumn('OehhPickDate', 'Oehhpickdate', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhPickTime', 'Oehhpicktime', 'VARCHAR', true, 4, '');
        $this->addColumn('OehhPackDate', 'Oehhpackdate', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhPackTime', 'Oehhpacktime', 'VARCHAR', true, 4, '');
        $this->addColumn('OehhVerifyDate', 'Oehhverifydate', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhVerifyTime', 'Oehhverifytime', 'VARCHAR', true, 4, '');
        $this->addColumn('OehhCreditMemo', 'Oehhcreditmemo', 'VARCHAR', true, 1, '');
        $this->addColumn('OehhBookedYn', 'Oehhbookedyn', 'VARCHAR', true, 1, '');
        $this->addColumn('IntbWhseOrig', 'Intbwhseorig', 'VARCHAR', true, 2, '');
        $this->addColumn('OehhBtStat', 'Oehhbtstat', 'VARCHAR', true, 2, '');
        $this->addColumn('OehhShipComp', 'Oehhshipcomp', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhCwoFlag', 'Oehhcwoflag', 'VARCHAR', true, 1, '');
        ...
        $this->addColumn('OehhWghtOride', 'Oehhwghtoride', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhCcInfo', 'Oehhccinfo', 'VARCHAR', true, 1, 'B');
        $this->addColumn('OehhBoxCount', 'Oehhboxcount', 'INTEGER', true, 5, 0);
        $this->addColumn('OehhRqstDate', 'Oehhrqstdate', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhCancDate', 'Oehhcancdate', 'VARCHAR', true, 8, '');
        ...
        $this->addColumn('OehhBordBuildDate', 'Oehhbordbuilddate', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDeptCode', 'Oehhdeptcode', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhFrtInEntered', 'Oehhfrtinentered', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhDropShipEntered', 'Oehhdropshipentered', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhErFlag', 'Oehherflag', 'VARCHAR', true, 1, 'N');
        ...
        $this->addColumn('OehhContractTerms', 'Oehhcontractterms', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhDropShipBilled', 'Oehhdropshipbilled', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhOrdTyp', 'Oehhordtyp', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhTrackNbr', 'Oehhtracknbr', 'VARCHAR', true, 15, '');
        $this->addColumn('OehhSource', 'Oehhsource', 'VARCHAR', true, 1, '');
        $this->addColumn('OehhCcAprv', 'Oehhccaprv', 'VARCHAR', true, 6, '');
        $this->addColumn('OehhPickFmatType', 'Oehhpickfmattype', 'VARCHAR', true, 1, '');
        $this->addColumn('OehhInvcFmatType', 'Oehhinvcfmattype', 'VARCHAR', true, 1, '');
        ...
        $this->addColumn('OehhPickPrintDate', 'Oehhpickprintdate', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhPickPrintTime', 'Oehhpickprinttime', 'VARCHAR', true, 4, '');
        $this->addColumn('OehhCont', 'Oehhcont', 'VARCHAR', true, 20, '');
        $this->addColumn('OehhContTeleIntl', 'Oehhcontteleintl', 'VARCHAR', true, 1, 'N');
        ...
        $this->addColumn('OehhContFaxIntl', 'Oehhcontfaxintl', 'VARCHAR', true, 1, 'N');
        ...
        $this->addColumn('OehhInvcPrintDate', 'Oehhinvcprintdate', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhInvcPrintTime', 'Oehhinvcprinttime', 'VARCHAR', true, 4, '');
        $this->addColumn('OehhDiscFrt', 'Oehhdiscfrt', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhOrideShipComp', 'Oehhorideshipcomp', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhContEmail', 'Oehhcontemail', 'VARCHAR', true, 50, '');
        $this->addColumn('OehhManualFrt', 'Oehhmanualfrt', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhInternalFrt', 'Oehhinternalfrt', 'VARCHAR', true, 1, 'N');
        ...
        $this->addColumn('OehhEdi855Sent', 'Oehhedi855sent', 'VARCHAR', true, 1, '');
        $this->addColumn('OehhFrt3rdParty', 'Oehhfrt3rdparty', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhFob', 'Oehhfob', 'VARCHAR', true, 15, '');
        $this->addColumn('OehhConfirmImagYn', 'Oehhconfirmimagyn', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhIndustConform', 'Oehhindustconform', 'VARCHAR', true, 1, '');
        $this->addColumn('OehhCstkConsign', 'Oehhcstkconsign', 'VARCHAR', true, 1, '');
        $this->addColumn('OehhLmDelayCapSent', 'Oehhlmdelaycapsent', 'VARCHAR', true, 1, '');
        $this->addColumn('OehhMfgId', 'Oehhmfgid', 'VARCHAR', true, 6, '');
        $this->addColumn('OehhStoreId', 'Oehhstoreid', 'VARCHAR', true, 6, '');
        $this->addColumn('OehhPickQueue', 'Oehhpickqueue', 'VARCHAR', true, 1, 'N');
        $this->addColumn('OehhArrvDate', 'Oehharrvdate', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhSurchgStat', 'Oehhsurchgstat', 'VARCHAR', true, 1, 'C');
        $this->addColumn('OehhFrtGrup', 'Oehhfrtgrup', 'VARCHAR', true, 2, '');
        $this->addColumn('OehhCommOride', 'Oehhcommoride', 'VARCHAR', true, 1, '');
        $this->addColumn('OehhChrgSplt', 'Oehhchrgsplt', 'VARCHAR', true, 1, '');
        $this->addColumn('OehhAcCcAprv', 'Oehhacccaprv', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhOrigOrdrNbr', 'Oehhorigordrnbr', 'VARCHAR', true, 10, '');
        $this->addColumn('OehhPostDate', 'Oehhpostdate', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDiscDate1', 'Oehhdiscdate1', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDiscPct1', 'Oehhdiscpct1', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDueDate1', 'Oehhduedate1', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDueAmt1', 'Oehhdueamt1', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDuePct1', 'Oehhduepct1', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDiscDate2', 'Oehhdiscdate2', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDiscPct2', 'Oehhdiscpct2', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDueDate2', 'Oehhduedate2', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDueAmt2', 'Oehhdueamt2', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDuePct2', 'Oehhduepct2', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDiscDate3', 'Oehhdiscdate3', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDiscPct3', 'Oehhdiscpct3', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDueDate3', 'Oehhduedate3', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDueAmt3', 'Oehhdueamt3', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDuePct3', 'Oehhduepct3', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDiscDate4', 'Oehhdiscdate4', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDiscPct4', 'Oehhdiscpct4', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDueDate4', 'Oehhduedate4', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDueAmt4', 'Oehhdueamt4', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDuePct4', 'Oehhduepct4', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDiscDate5', 'Oehhdiscdate5', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDiscPct5', 'Oehhdiscpct5', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDueDate5', 'Oehhduedate5', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDueAmt5', 'Oehhdueamt5', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDuePct5', 'Oehhduepct5', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDiscDate6', 'Oehhdiscdate6', 'VARCHAR', true, 8, '');
        $this->addColumn('OehhDiscPct6', 'Oehhdiscpct6', 'DECIMAL', true, 20, 0);
        $this->addColumn('OehhDueDate6', 'Oehhduedate6', 'VARCHAR', true, 8, '');
