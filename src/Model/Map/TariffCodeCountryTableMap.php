...
use \TariffCodeCountry;
use \TariffCodeCountryQuery;
...
/**
 * This class defines the structure of the 'inv_trco_code' table.
 *
 *
 *
...
class TariffCodeCountryTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('TariffCodeCountry');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\TariffCodeCountry');
        $this->setPackage('');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('IntbTariCode', 'Intbtaricode', 'VARCHAR', true, 8, null);
        $this->addPrimaryKey('IntbTrcoCtry', 'Intbtrcoctry', 'VARCHAR', true, 4, '');
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize([(null === $obj->getIntbtaricode() || is_scalar($obj->getIntbtaricode()) || is_callable([$obj->getIntbtaricode(), '__toString']) ? (string) $obj->getIntbtaricode() : $obj->getIntbtaricode()), (null === $obj->getIntbtrcoctry() || is_scalar($obj->getIntbtrcoctry()) || is_callable([$obj->getIntbtrcoctry(), '__toString']) ? (string) $obj->getIntbtrcoctry() : $obj->getIntbtrcoctry())]);
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \TariffCodeCountry) {
                $key = serialize([(null === $value->getIntbtaricode() || is_scalar($value->getIntbtaricode()) || is_callable([$value->getIntbtaricode(), '__toString']) ? (string) $value->getIntbtaricode() : $value->getIntbtaricode()), (null === $value->getIntbtrcoctry() || is_scalar($value->getIntbtrcoctry()) || is_callable([$value->getIntbtrcoctry(), '__toString']) ? (string) $value->getIntbtrcoctry() : $value->getIntbtrcoctry())]);
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \TariffCodeCountry object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return serialize([(null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Intbtaricode', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Intbtaricode', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Intbtaricode', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Intbtaricode', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Intbtaricode', TableMap::TYPE_PHPNAME, $indexType)]), (null === $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Intbtrcoctry', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Intbtrcoctry', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Intbtrcoctry', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Intbtrcoctry', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Intbtrcoctry', TableMap::TYPE_PHPNAME, $indexType)])]);
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        $pks[] = (string) $row[
            $indexType == TableMap::TYPE_NUM
                ? 1 + $offset
                : self::translateFieldName('Intbtrcoctry', TableMap::TYPE_PHPNAME, $indexType)
        ];
    ...
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if (null !== ($obj = TariffCodeCountryTableMap::getInstanceFromPool($key))) {
            ...
            $col = $offset + TariffCodeCountryTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = TariffCodeCountryTableMap::OM_CLASS;
            /** @var TariffCodeCountry $obj */
            $obj = new $cls();
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = TariffCodeCountryTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = TariffCodeCountryTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TariffCodeCountryTableMap::COL_INTBTRCOCTRY);
            $criteria->addSelectColumn(TariffCodeCountryTableMap::COL_DATEUPDTD);
            $criteria->addSelectColumn(TariffCodeCountryTableMap::COL_TIMEUPDTD);
            $criteria->addSelectColumn(TariffCodeCountryTableMap::COL_DUMMY);
        } else {
            $criteria->addSelectColumn($alias . '.IntbTariCode');
            $criteria->addSelectColumn($alias . '.IntbTrcoCtry');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TariffCodeCountry) { // it's a model object
            ...
            foreach ($values as $value) {
                ...
                $criterion->addAnd($criteria->getNewCriterion(TariffCodeCountryTableMap::COL_INTBTRCOCTRY, $value[1]));
                $criteria->addOr($criterion);
            }
        }

        $query = TariffCodeCountryQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            TariffCodeCountryTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                TariffCodeCountryTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from TariffCodeCountry object
        }
