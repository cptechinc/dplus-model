...
class InvPalletLotTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.InvPalletLotTableMap';
     ...
     */
    public const TABLE_NAME = 'pallet_detail';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'InvPalletLot';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\InvPalletLot';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'InvPalletLot';
     ...
     */
    public const COL_PLTHPALLETID = 'pallet_detail.PlthPalletId';

    /**
     * the column name for the PltdLotNbr field
     */
    public const COL_PLTDLOTNBR = 'pallet_detail.PltdLotNbr';

    /**
     * the column name for the DateUpdtd field
     */
    public const COL_DATEUPDTD = 'pallet_detail.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    public const COL_TIMEUPDTD = 'pallet_detail.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    public const COL_DUMMY = 'pallet_detail.dummy';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Plthpalletid', 'Pltdlotnbr', 'Dateupdtd', 'Timeupdtd', 'Dummy', ],
        self::TYPE_CAMELNAME     => ['plthpalletid', 'pltdlotnbr', 'dateupdtd', 'timeupdtd', 'dummy', ],
        self::TYPE_COLNAME       => [InvPalletLotTableMap::COL_PLTHPALLETID, InvPalletLotTableMap::COL_PLTDLOTNBR, InvPalletLotTableMap::COL_DATEUPDTD, InvPalletLotTableMap::COL_TIMEUPDTD, InvPalletLotTableMap::COL_DUMMY, ],
        self::TYPE_FIELDNAME     => ['PlthPalletId', 'PltdLotNbr', 'DateUpdtd', 'TimeUpdtd', 'dummy', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Plthpalletid' => 0, 'Pltdlotnbr' => 1, 'Dateupdtd' => 2, 'Timeupdtd' => 3, 'Dummy' => 4, ],
        self::TYPE_CAMELNAME     => ['plthpalletid' => 0, 'pltdlotnbr' => 1, 'dateupdtd' => 2, 'timeupdtd' => 3, 'dummy' => 4, ],
        self::TYPE_COLNAME       => [InvPalletLotTableMap::COL_PLTHPALLETID => 0, InvPalletLotTableMap::COL_PLTDLOTNBR => 1, InvPalletLotTableMap::COL_DATEUPDTD => 2, InvPalletLotTableMap::COL_TIMEUPDTD => 3, InvPalletLotTableMap::COL_DUMMY => 4, ],
        self::TYPE_FIELDNAME     => ['PlthPalletId' => 0, 'PltdLotNbr' => 1, 'DateUpdtd' => 2, 'TimeUpdtd' => 3, 'dummy' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'InvPalletLot.Plthpalletid' => 'PLTHPALLETID',
        'plthpalletid' => 'PLTHPALLETID',
        'invPalletLot.plthpalletid' => 'PLTHPALLETID',
        'InvPalletLotTableMap::COL_PLTHPALLETID' => 'PLTHPALLETID',
        'COL_PLTHPALLETID' => 'PLTHPALLETID',
        'PlthPalletId' => 'PLTHPALLETID',
        'pallet_detail.PlthPalletId' => 'PLTHPALLETID',
        'Pltdlotnbr' => 'PLTDLOTNBR',
        'InvPalletLot.Pltdlotnbr' => 'PLTDLOTNBR',
        'pltdlotnbr' => 'PLTDLOTNBR',
        'invPalletLot.pltdlotnbr' => 'PLTDLOTNBR',
        'InvPalletLotTableMap::COL_PLTDLOTNBR' => 'PLTDLOTNBR',
        'COL_PLTDLOTNBR' => 'PLTDLOTNBR',
        'PltdLotNbr' => 'PLTDLOTNBR',
        'pallet_detail.PltdLotNbr' => 'PLTDLOTNBR',
        'Dateupdtd' => 'DATEUPDTD',
        'InvPalletLot.Dateupdtd' => 'DATEUPDTD',
        'dateupdtd' => 'DATEUPDTD',
        'invPalletLot.dateupdtd' => 'DATEUPDTD',
        'InvPalletLotTableMap::COL_DATEUPDTD' => 'DATEUPDTD',
        'COL_DATEUPDTD' => 'DATEUPDTD',
        'DateUpdtd' => 'DATEUPDTD',
        'pallet_detail.DateUpdtd' => 'DATEUPDTD',
        'Timeupdtd' => 'TIMEUPDTD',
        'InvPalletLot.Timeupdtd' => 'TIMEUPDTD',
        'timeupdtd' => 'TIMEUPDTD',
        'invPalletLot.timeupdtd' => 'TIMEUPDTD',
        'InvPalletLotTableMap::COL_TIMEUPDTD' => 'TIMEUPDTD',
        'COL_TIMEUPDTD' => 'TIMEUPDTD',
        'TimeUpdtd' => 'TIMEUPDTD',
        'pallet_detail.TimeUpdtd' => 'TIMEUPDTD',
        'Dummy' => 'DUMMY',
        'InvPalletLot.Dummy' => 'DUMMY',
        'dummy' => 'DUMMY',
        'invPalletLot.dummy' => 'DUMMY',
        'InvPalletLotTableMap::COL_DUMMY' => 'DUMMY',
        'COL_DUMMY' => 'DUMMY',
        'pallet_detail.dummy' => 'DUMMY',
    ];
  ...
  array (
     ...
     * @return void
     */
    public static function addInstanceToPool(InvPalletLot $obj, ?string $key = null): void
    {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(InvPalletLotTableMap::COL_PLTHPALLETID);
            $criteria->removeSelectColumn(InvPalletLotTableMap::COL_PLTDLOTNBR);
            $criteria->removeSelectColumn(InvPalletLotTableMap::COL_DATEUPDTD);
            $criteria->removeSelectColumn(InvPalletLotTableMap::COL_TIMEUPDTD);
            $criteria->removeSelectColumn(InvPalletLotTableMap::COL_DUMMY);
        } else {
            $criteria->removeSelectColumn($alias . '.PlthPalletId');
            $criteria->removeSelectColumn($alias . '.PltdLotNbr');
