...
class ApBuyerTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.ApBuyerTableMap';
     ...
     */
    const TABLE_NAME = 'ap_buyr_code';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\ApBuyer';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ApBuyer';
     ...
     */
    const COL_APTBBUYRCODE = 'ap_buyr_code.AptbBuyrCode';

    /**
     * the column name for the AptbBuyrDesc field
     */
    const COL_APTBBUYRDESC = 'ap_buyr_code.AptbBuyrDesc';
     ...
     */
    const COL_DATEUPDTD = 'ap_buyr_code.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    const COL_TIMEUPDTD = 'ap_buyr_code.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    const COL_DUMMY = 'ap_buyr_code.dummy';
  ...
  array (
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(ApBuyerTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(ApBuyerTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new ApBuyerTableMap());
        }
    }
