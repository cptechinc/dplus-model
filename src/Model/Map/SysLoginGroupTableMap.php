...
class SysLoginGroupTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.SysLoginGroupTableMap';
     ...
     */
    public const TABLE_NAME = 'sys_login_group';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SysLoginGroup';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\SysLoginGroup';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'SysLoginGroup';
     ...
     */
    public const COL_QTBLLGRPCODE = 'sys_login_group.QtblLgrpCode';

    /**
     * the column name for the QtblLgrpDesc field
     */
    public const COL_QTBLLGRPDESC = 'sys_login_group.QtblLgrpDesc';

    /**
     * the column name for the DateUpdtd field
     */
    public const COL_DATEUPDTD = 'sys_login_group.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    public const COL_TIMEUPDTD = 'sys_login_group.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    public const COL_DUMMY = 'sys_login_group.dummy';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Qtbllgrpcode', 'Qtbllgrpdesc', 'Dateupdtd', 'Timeupdtd', 'Dummy', ],
        self::TYPE_CAMELNAME     => ['qtbllgrpcode', 'qtbllgrpdesc', 'dateupdtd', 'timeupdtd', 'dummy', ],
        self::TYPE_COLNAME       => [SysLoginGroupTableMap::COL_QTBLLGRPCODE, SysLoginGroupTableMap::COL_QTBLLGRPDESC, SysLoginGroupTableMap::COL_DATEUPDTD, SysLoginGroupTableMap::COL_TIMEUPDTD, SysLoginGroupTableMap::COL_DUMMY, ],
        self::TYPE_FIELDNAME     => ['QtblLgrpCode', 'QtblLgrpDesc', 'DateUpdtd', 'TimeUpdtd', 'dummy', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Qtbllgrpcode' => 0, 'Qtbllgrpdesc' => 1, 'Dateupdtd' => 2, 'Timeupdtd' => 3, 'Dummy' => 4, ],
        self::TYPE_CAMELNAME     => ['qtbllgrpcode' => 0, 'qtbllgrpdesc' => 1, 'dateupdtd' => 2, 'timeupdtd' => 3, 'dummy' => 4, ],
        self::TYPE_COLNAME       => [SysLoginGroupTableMap::COL_QTBLLGRPCODE => 0, SysLoginGroupTableMap::COL_QTBLLGRPDESC => 1, SysLoginGroupTableMap::COL_DATEUPDTD => 2, SysLoginGroupTableMap::COL_TIMEUPDTD => 3, SysLoginGroupTableMap::COL_DUMMY => 4, ],
        self::TYPE_FIELDNAME     => ['QtblLgrpCode' => 0, 'QtblLgrpDesc' => 1, 'DateUpdtd' => 2, 'TimeUpdtd' => 3, 'dummy' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        'Qtbllgrpcode' => 'QTBLLGRPCODE',
        'SysLoginGroup.Qtbllgrpcode' => 'QTBLLGRPCODE',
        'qtbllgrpcode' => 'QTBLLGRPCODE',
        'sysLoginGroup.qtbllgrpcode' => 'QTBLLGRPCODE',
        'SysLoginGroupTableMap::COL_QTBLLGRPCODE' => 'QTBLLGRPCODE',
        'COL_QTBLLGRPCODE' => 'QTBLLGRPCODE',
        'QtblLgrpCode' => 'QTBLLGRPCODE',
        'sys_login_group.QtblLgrpCode' => 'QTBLLGRPCODE',
        'Qtbllgrpdesc' => 'QTBLLGRPDESC',
        'SysLoginGroup.Qtbllgrpdesc' => 'QTBLLGRPDESC',
        'qtbllgrpdesc' => 'QTBLLGRPDESC',
        'sysLoginGroup.qtbllgrpdesc' => 'QTBLLGRPDESC',
        'SysLoginGroupTableMap::COL_QTBLLGRPDESC' => 'QTBLLGRPDESC',
        'COL_QTBLLGRPDESC' => 'QTBLLGRPDESC',
        'QtblLgrpDesc' => 'QTBLLGRPDESC',
        'sys_login_group.QtblLgrpDesc' => 'QTBLLGRPDESC',
        'Dateupdtd' => 'DATEUPDTD',
        'SysLoginGroup.Dateupdtd' => 'DATEUPDTD',
        'dateupdtd' => 'DATEUPDTD',
        'sysLoginGroup.dateupdtd' => 'DATEUPDTD',
        'SysLoginGroupTableMap::COL_DATEUPDTD' => 'DATEUPDTD',
        'COL_DATEUPDTD' => 'DATEUPDTD',
        'DateUpdtd' => 'DATEUPDTD',
        'sys_login_group.DateUpdtd' => 'DATEUPDTD',
        'Timeupdtd' => 'TIMEUPDTD',
        'SysLoginGroup.Timeupdtd' => 'TIMEUPDTD',
        'timeupdtd' => 'TIMEUPDTD',
        'sysLoginGroup.timeupdtd' => 'TIMEUPDTD',
        'SysLoginGroupTableMap::COL_TIMEUPDTD' => 'TIMEUPDTD',
        'COL_TIMEUPDTD' => 'TIMEUPDTD',
        'TimeUpdtd' => 'TIMEUPDTD',
        'sys_login_group.TimeUpdtd' => 'TIMEUPDTD',
        'Dummy' => 'DUMMY',
        'SysLoginGroup.Dummy' => 'DUMMY',
        'dummy' => 'DUMMY',
        'sysLoginGroup.dummy' => 'DUMMY',
        'SysLoginGroupTableMap::COL_DUMMY' => 'DUMMY',
        'COL_DUMMY' => 'DUMMY',
        'sys_login_group.dummy' => 'DUMMY',
    ];
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(SysLoginGroupTableMap::COL_QTBLLGRPCODE);
            $criteria->removeSelectColumn(SysLoginGroupTableMap::COL_QTBLLGRPDESC);
            $criteria->removeSelectColumn(SysLoginGroupTableMap::COL_DATEUPDTD);
            $criteria->removeSelectColumn(SysLoginGroupTableMap::COL_TIMEUPDTD);
            $criteria->removeSelectColumn(SysLoginGroupTableMap::COL_DUMMY);
        } else {
            $criteria->removeSelectColumn($alias . '.QtblLgrpCode');
            $criteria->removeSelectColumn($alias . '.QtblLgrpDesc');
