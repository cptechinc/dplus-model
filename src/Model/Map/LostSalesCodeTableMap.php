...
class LostSalesCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.LostSalesCodeTableMap';
     ...
     */
    const TABLE_NAME = 'so_lssl_code';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\LostSalesCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'LostSalesCode';
     ...
     */
    const COL_OETBLSSLCODE = 'so_lssl_code.OetbLsslCode';

    /**
     * the column name for the OetbLsslReasonDesc field
     */
    const COL_OETBLSSLREASONDESC = 'so_lssl_code.OetbLsslReasonDesc';

    /**
     * the column name for the OetbLsslIwUpdate field
     */
    const COL_OETBLSSLIWUPDATE = 'so_lssl_code.OetbLsslIwUpdate';

    /**
     * the column name for the DateUpdtd field
     */
    const COL_DATEUPDTD = 'so_lssl_code.DateUpdtd';

    /**
     * the column name for the TimeUpdtd field
     */
    const COL_TIMEUPDTD = 'so_lssl_code.TimeUpdtd';

    /**
     * the column name for the dummy field
     */
    const COL_DUMMY = 'so_lssl_code.dummy';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Oetblsslcode', 'Oetblsslreasondesc', 'Oetblssliwupdate', 'Dateupdtd', 'Timeupdtd', 'Dummy', ),
        self::TYPE_CAMELNAME     => array('oetblsslcode', 'oetblsslreasondesc', 'oetblssliwupdate', 'dateupdtd', 'timeupdtd', 'dummy', ),
        self::TYPE_COLNAME       => array(LostSalesCodeTableMap::COL_OETBLSSLCODE, LostSalesCodeTableMap::COL_OETBLSSLREASONDESC, LostSalesCodeTableMap::COL_OETBLSSLIWUPDATE, LostSalesCodeTableMap::COL_DATEUPDTD, LostSalesCodeTableMap::COL_TIMEUPDTD, LostSalesCodeTableMap::COL_DUMMY, ),
        self::TYPE_FIELDNAME     => array('OetbLsslCode', 'OetbLsslReasonDesc', 'OetbLsslIwUpdate', 'DateUpdtd', 'TimeUpdtd', 'dummy', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Oetblsslcode' => 0, 'Oetblsslreasondesc' => 1, 'Oetblssliwupdate' => 2, 'Dateupdtd' => 3, 'Timeupdtd' => 4, 'Dummy' => 5, ),
        self::TYPE_CAMELNAME     => array('oetblsslcode' => 0, 'oetblsslreasondesc' => 1, 'oetblssliwupdate' => 2, 'dateupdtd' => 3, 'timeupdtd' => 4, 'dummy' => 5, ),
        self::TYPE_COLNAME       => array(LostSalesCodeTableMap::COL_OETBLSSLCODE => 0, LostSalesCodeTableMap::COL_OETBLSSLREASONDESC => 1, LostSalesCodeTableMap::COL_OETBLSSLIWUPDATE => 2, LostSalesCodeTableMap::COL_DATEUPDTD => 3, LostSalesCodeTableMap::COL_TIMEUPDTD => 4, LostSalesCodeTableMap::COL_DUMMY => 5, ),
        self::TYPE_FIELDNAME     => array('OetbLsslCode' => 0, 'OetbLsslReasonDesc' => 1, 'OetbLsslIwUpdate' => 2, 'DateUpdtd' => 3, 'TimeUpdtd' => 4, 'dummy' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(LostSalesCodeTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(LostSalesCodeTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new LostSalesCodeTableMap());
        }
    }
...
} // LostSalesCodeTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
LostSalesCodeTableMap::buildTableMap();
